...
exports.RotateTargetTS = void 0;
var __selfType = requireType("./RotateTargetTS");
...
let RotateTargetTS = (() => {
    ...
    var RotateTargetTS = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.rotationInterval = (__runInitializers(this, _instanceExtraInitializers), this.rotationInterval);
            this.minRotationAngle = this.minRotationAngle;
            this.maxRotationAngle = this.maxRotationAngle;
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("RotateTargetTS", this.enableLogging || this.enableLoggingLifecycle, true);
    ...
    __setFunctionName(_classThis, "RotateTargetTS");
    (() => {
        ...
        RotateTargetTS = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RotateTargetTS = _classThis;
})();
exports.RotateTargetTS = RotateTargetTS;
//# sourceMappingURL=RotateTargetTS.js.map