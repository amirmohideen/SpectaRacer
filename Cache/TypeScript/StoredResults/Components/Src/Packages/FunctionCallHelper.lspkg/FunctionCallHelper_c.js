...
var Module = require("../../../../Modules/Src/Packages/FunctionCallHelper.lspkg/FunctionCallHelper");
Object.setPrototypeOf(script, Module.ButtonClickEvent.prototype);
script.__initialize();
let awakeEvent = script.createEvent("OnAwakeEvent");
awakeEvent.bind(() => {
    checkUndefined("triggerableFunctions", []);
    checkUndefined("buttonPrefab", []);
