...
/**
 * Specs Inc. 2026
 * Visual line renderer for connecting two points in 3D space. Provides customizable appearance
 * with gradient colors, variable width, and multiple visual styles for debug visualization.
 */
...
let Line = (() => {
    ...
    var Line = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.startPointObject = (__runInitializers(this, _instanceExtraInitializers), this.startPointObject);
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("Line", this.enableLogging || this.enableLoggingLifecycle, true);
