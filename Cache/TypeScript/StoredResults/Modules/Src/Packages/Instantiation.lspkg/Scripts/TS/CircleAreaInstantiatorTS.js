...
exports.CircleAreaInstantiatorTS = void 0;
var __selfType = requireType("./CircleAreaInstantiatorTS");
...
let CircleAreaInstantiatorTS = (() => {
    ...
    var CircleAreaInstantiatorTS = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        onAwake() {
            // Initialize logger
            this.logger = new Logger_1.Logger("CircleAreaInstantiatorTS", this.enableLogging || this.enableLoggingLifecycle, true);
        ...
        instantiatePrefabs() {
            ...
            for (let i = 0; i < this.numberOfPrefabs; i++) {
                ...
                const randomPosition = new vec3(centerPosition.x + Math.cos(angle) * distance, centerPosition.y + Math.sin(angle) * distance, centerPosition.z);
    ...
    __setFunctionName(_classThis, "CircleAreaInstantiatorTS");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        _onStart_decorators = [decorators_1.bindStartEvent];
        __esDecorate(_classThis, null, _onStart_decorators, { kind: "method", name: "onStart", static: false, private: false, access: { has: obj => "onStart" in obj, get: obj => obj.onStart }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        CircleAreaInstantiatorTS = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CircleAreaInstantiatorTS = _classThis;
})();
exports.CircleAreaInstantiatorTS = CircleAreaInstantiatorTS;
//# sourceMappingURL=CircleAreaInstantiatorTS.js.map