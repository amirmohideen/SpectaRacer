...
exports.SnapToLineTS = void 0;
var __selfType = requireType("./SnapToLineTS");
...
let SnapToLineTS = (() => {
    ...
    var SnapToLineTS = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.lineStart = (__runInitializers(this, _instanceExtraInitializers), this.lineStart);
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("SnapToLineTS", this.enableLogging || this.enableLoggingLifecycle, true);
    ...
    __setFunctionName(_classThis, "SnapToLineTS");
    (() => {
        ...
        SnapToLineTS = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SnapToLineTS = _classThis;
})();
exports.SnapToLineTS = SnapToLineTS;
//# sourceMappingURL=SnapToLineTS.js.map