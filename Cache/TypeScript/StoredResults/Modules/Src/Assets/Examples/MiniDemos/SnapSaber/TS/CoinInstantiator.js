...
exports.CoinInstantiator = void 0;
var __selfType = requireType("./CoinInstantiator");
...
let CoinInstantiator = (() => {
    ...
    var CoinInstantiator = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("CoinInstantiator", this.enableLogging || this.enableLoggingLifecycle, true);
    ...
    __setFunctionName(_classThis, "CoinInstantiator");
    (() => {
        ...
        CoinInstantiator = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CoinInstantiator = _classThis;
})();
exports.CoinInstantiator = CoinInstantiator;
//# sourceMappingURL=CoinInstantiator.js.map