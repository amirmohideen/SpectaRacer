...
exports.UIKitCustomVisualsRoundButton = void 0;
var __selfType = requireType("./UIKitCustomVisualsRoundButton");
...
/**
 * Specs Inc. 2026
 * UIKitCustomVisualsRoundButton – applies a selectable gradient style to a UIKit RoundButton.
 */
...
/**
 * Applies a selectable gradient style to a UIKit RoundButton.
 *
 ...
 *
 * Attach to the same SceneObject as the RoundButton component.
 */
let UIKitCustomVisualsRoundButton = (() => {
    ...
    var UIKitCustomVisualsRoundButton = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("UIKitCustomVisualsRoundButton", this.enableLogging || this.enableLoggingLifecycle, true);
            if (this.enableLoggingLifecycle)
                this.logger.debug("LIFECYCLE: onAwake()");
            this._button = this.sceneObject.getComponent(RoundButton_1.RoundButton.getTypeName());
            if (!this._button) {
                this.logger.error("RoundButton component not found on this SceneObject");
                return;
            }
    ...
    __setFunctionName(_classThis, "UIKitCustomVisualsRoundButton");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        _onStart_decorators = [decorators_1.bindStartEvent];
        __esDecorate(_classThis, null, _onStart_decorators, { kind: "method", name: "onStart", static: false, private: false, access: { has: obj => "onStart" in obj, get: obj => obj.onStart }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        UIKitCustomVisualsRoundButton = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UIKitCustomVisualsRoundButton = _classThis;
})();
exports.UIKitCustomVisualsRoundButton = UIKitCustomVisualsRoundButton;
//# sourceMappingURL=UIKitCustomVisualsRoundButton.js.map