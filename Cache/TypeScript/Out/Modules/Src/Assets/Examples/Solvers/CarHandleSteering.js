...
let CarHandleSteering = (() => {
    ...
    var CarHandleSteering = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.referenceHandleX = 0; // handle X at the time of the last reset
            this.prevHandleX = 0;
            this.smoothedVelocity = 0;
            this.timeSinceStationary = 0;
            this.hasReset = false; // prevents re-triggering reset every frame
        ...
        onUpdate() {
            ...
            if (this.enableLogging) {
                this.logger.debug(`x: ${currentX.toFixed(2)}  ref: ${this.referenceHandleX.toFixed(2)}  delta: ${(currentX - this.referenceHandleX).toFixed(2)}  vel: ${this.smoothedVelocity.toFixed(2)}  idle: ${this.timeSinceStationary.toFixed(2)}s  target: ${this.targetOffsetY.toFixed(1)}°  car: ${this.currentOffsetY.toFixed(1)}°`);
            }
        }
    };
