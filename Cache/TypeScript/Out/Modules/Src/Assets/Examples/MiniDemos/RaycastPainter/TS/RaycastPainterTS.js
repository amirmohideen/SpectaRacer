...
exports.RaycastPainterTS = void 0;
var __selfType = requireType("./RaycastPainterTS");
...
let RaycastPainterTS = (() => {
    ...
    var RaycastPainterTS = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("RaycastPainterTS", this.enableLogging || this.enableLoggingLifecycle, true);
    ...
    __setFunctionName(_classThis, "RaycastPainterTS");
    (() => {
        ...
        RaycastPainterTS = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RaycastPainterTS = _classThis;
})();
exports.RaycastPainterTS = RaycastPainterTS;
//# sourceMappingURL=RaycastPainterTS.js.map