...
exports.SnapToPlaneTS = void 0;
var __selfType = requireType("./SnapToPlaneTS");
...
let SnapToPlaneTS = (() => {
    ...
    var SnapToPlaneTS = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.planeTransform = (__runInitializers(this, _instanceExtraInitializers), this.planeTransform);
            this.snappingObject = this.snappingObject;
            this.distanceObject = this.distanceObject;
        ...
        onAwake() {
            this.logger = new Logger_1.Logger("SnapToPlaneTS", this.enableLogging || this.enableLoggingLifecycle, true);
        ...
        getClosestPointOnPlane(point, planePoint, planeNormal) {
    ...
    __setFunctionName(_classThis, "SnapToPlaneTS");
    (() => {
        ...
        SnapToPlaneTS = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SnapToPlaneTS = _classThis;
})();
exports.SnapToPlaneTS = SnapToPlaneTS;
//# sourceMappingURL=SnapToPlaneTS.js.map