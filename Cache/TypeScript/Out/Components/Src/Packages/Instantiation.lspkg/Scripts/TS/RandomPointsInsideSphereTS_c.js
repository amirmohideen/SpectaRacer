...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Define the sphere center and prefab to instantiate inside the volume</span>"}
...
var Module = require("../../../../../../Modules/Src/Packages/Instantiation.lspkg/Scripts/TS/RandomPointsInsideSphereTS");
Object.setPrototypeOf(script, Module.RandomPointsInsideSphereTS.prototype);
script.__initialize();
