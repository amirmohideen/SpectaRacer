...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Set the fixed distance between each object</span>"}
// @input float fixedDistance = 1 {"hint":"Fixed distance between each instantiated object"}
// @ui {"widget":"separator"}
...
var Module = require("../../../../../../Modules/Src/Packages/Instantiation.lspkg/Scripts/TS/InstantiateAlongLineWithFixedDistanceTS");
Object.setPrototypeOf(script, Module.InstantiateAlongLineWithFixedDistanceTS.prototype);
script.__initialize();
