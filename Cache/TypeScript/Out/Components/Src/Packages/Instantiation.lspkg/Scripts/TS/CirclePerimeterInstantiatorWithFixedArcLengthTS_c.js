...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Define the center point, prefab, and radius for the circular layout</span>"}
...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Configure the number of objects or arc length between them</span>"}
// @input float numberOfPrefabs = 10 {"hint":"Number of prefabs to instantiate around the circle"}
// @input float arcLength = 2 {"hint":"Fixed arc length between instantiated prefabs (used only when numberOfPrefabs is 0)"}
// @input float startAngle {"hint":"Start angle of the arc in degrees (0-360)"}
...
var Module = require("../../../../../../Modules/Src/Packages/Instantiation.lspkg/Scripts/TS/CirclePerimeterInstantiatorWithFixedArcLengthTS");
Object.setPrototypeOf(script, Module.CirclePerimeterInstantiatorWithFixedArcLengthTS.prototype);
script.__initialize();
...
awakeEvent.bind(() => {
    ...
    checkUndefined("arcLength", []);
    checkUndefined("startAngle", []);
    checkUndefined("arcAngleSpan", []);
