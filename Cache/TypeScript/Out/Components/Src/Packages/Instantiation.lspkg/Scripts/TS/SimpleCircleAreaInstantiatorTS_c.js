...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Define the center point and prefab to instantiate within the circular area</span>"}
...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Configure the number of objects and circle radius</span>"}
...
var Module = require("../../../../../../Modules/Src/Packages/Instantiation.lspkg/Scripts/TS/SimpleCircleAreaInstantiatorTS");
Object.setPrototypeOf(script, Module.SimpleCircleAreaInstantiatorTS.prototype);
script.__initialize();
