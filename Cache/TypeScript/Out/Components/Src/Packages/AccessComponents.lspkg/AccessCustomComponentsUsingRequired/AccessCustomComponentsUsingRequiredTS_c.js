...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Specify the scene object that has the custom component you want to access</span>"}
...
var Module = require("../../../../../Modules/Src/Packages/AccessComponents.lspkg/AccessCustomComponentsUsingRequired/AccessCustomComponentsUsingRequiredTS");
Object.setPrototypeOf(script, Module.AccessCustomComponentsUsingRequiredTS.prototype);
script.__initialize();
