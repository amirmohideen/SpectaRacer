...
// @ui {"widget":"label", "label":"<span style=\"color: #FBBF24;\">CoinInstantiator – spawn and animate coin target cubes</span><br/><span style=\"color: #94A3B8; font-size: 11px;\">Instantiates coin prefabs at regular intervals and moves them toward a target. Cubes are destroyed on end-zone collision.</span>"}
// @ui {"widget":"separator"}
...
// @input SceneObject endZone {"hint":"SceneObject with a box collider that destroys coins on contact (e.g. InstantiatorEndPosition1)"}
...
// @input float rotationSpeedY = 90 {"hint":"Rotation speed on Y axis in degrees per second"}
...
var Module = require("../../../../../../../Modules/Src/Assets/Examples/MiniDemos/SnapSaber/TS/CoinInstantiator");
Object.setPrototypeOf(script, Module.CoinInstantiator.prototype);
script.__initialize();
