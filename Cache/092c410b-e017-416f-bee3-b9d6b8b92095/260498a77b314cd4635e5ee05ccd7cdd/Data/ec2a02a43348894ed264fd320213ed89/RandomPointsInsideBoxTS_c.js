...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Define the box center and prefab to instantiate inside the volume</span>"}
...
var Module = require("../../../../../../Modules/Src/Packages/Instantiation.lspkg/Scripts/TS/RandomPointsInsideBoxTS");
Object.setPrototypeOf(script, Module.RandomPointsInsideBoxTS.prototype);
script.__initialize();
