...
//sampler sampler Tweak_N20SmpSC 0:18
//sampler sampler Tweak_N3SmpSC 0:19
//sampler sampler intensityTextureSmpSC 0:20
//sampler sampler sc_ScreenTextureSmpSC 0:25
//texture texture2D Tweak_N20 0:1:0:18
//texture texture2D Tweak_N3 0:2:0:19
...
//float3x3 Tweak_N3Transform 4432
//float4 Tweak_N3UvMinMax 4480
//float4 Tweak_N3BorderColor 4496
//float Tweak_N10 4512
//float Tweak_N9 4516
//float Tweak_N0 4520
//float Tweak_N19 4524
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N20 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N3 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N20 34 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N3 35 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 36 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N20 37 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N3 38 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 39 0
//spec_const bool Tweak_N20HasSwappedViews 40 0
//spec_const bool Tweak_N3HasSwappedViews 41 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N20 [[function_constant(31)]];
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N3 [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N20 [[function_constant(34)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N3 [[function_constant(35)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N20 [[function_constant(37)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N3 [[function_constant(38)]];
...
constant bool Tweak_N20HasSwappedViews [[function_constant(40)]];
...
constant bool Tweak_N3HasSwappedViews [[function_constant(41)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N20 [[function_constant(74)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N20 [[function_constant(77)]];
...
constant int Tweak_N20Layout [[function_constant(80)]];
...
texture2d<float> Tweak_N20 [[id(1)]];
texture2d<float> Tweak_N3 [[id(2)]];
texture2d<float> intensityTexture [[id(3)]];
texture2d<float> sc_ScreenTexture [[id(15)]];
sampler Tweak_N20SmpSC [[id(18)]];
sampler Tweak_N3SmpSC [[id(19)]];
...
int l9_94=l9_89;
int param_11=Tweak_N3Layout_tmp;
int param_12=l9_94;
float2 param_13=Globals.Surface_UVCoord0;
bool param_14=(int(SC_USE_UV_TRANSFORM_Tweak_N3_tmp)!=0);
float3x3 param_15=(*sc_set0.UserUniforms).Tweak_N3Transform;
int2 param_16=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3_tmp);
bool param_17=(int(SC_USE_UV_MIN_MAX_Tweak_N3_tmp)!=0);
float4 param_18=(*sc_set0.UserUniforms).Tweak_N3UvMinMax;
bool param_19=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3_tmp)!=0);
float4 param_20=(*sc_set0.UserUniforms).Tweak_N3BorderColor;
float param_21=0.0;
...
float4 l9_161=sc_set0.Tweak_N3.sample(sc_set0.Tweak_N3SmpSC,l9_160.xy,bias(l9_154));
...
float param_25=(*sc_set0.UserUniforms).Tweak_N10;
Output_N10=param_25;
...
float Output_N9=0.0;
float param_26=(*sc_set0.UserUniforms).Tweak_N9;
Output_N9=param_26;
float Output_N8=0.0;
...
float param_27=(*sc_set0.UserUniforms).Tweak_N0;
Output_N26=param_27;
float Output_N30=0.0;
Output_N30=Output_N1*Output_N26;
float Output_N31=0.0;
float param_28=(*sc_set0.UserUniforms).Tweak_N19;
Output_N31=param_28;
