...
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Slice Configuration</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Define the prefab and center point for the radial slice pattern</span>"}
// @input Asset.ObjectPrefab prefab {"hint":"Prefab to instantiate"}
// @input SceneObject center {"hint":"Center point of the circle"}
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Pattern Settings</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Configure the number of radial slices and elements per slice</span>"}
...
var Module = require("../../../../../../Modules/Src/Packages/Instantiation.lspkg/Scripts/TS/CircleSlicingInstantiatorTS");
Object.setPrototypeOf(script, Module.CircleSlicingInstantiatorTS.prototype);
script.__initialize();
let awakeEvent = script.createEvent("OnAwakeEvent");
awakeEvent.bind(() => {
    checkUndefined("prefab", []);
    checkUndefined("center", []);
    checkUndefined("xSlices", []);
    checkUndefined("yElementsPerSlice", []);
