...
l9_4=param_3.VertexColor;
float l9_5=0.0;
l9_5=l9_4.x;
float l9_6=0.0;
float l9_7=l9_2;
bool l9_8=(l9_7*1.0)!=0.0;
bool l9_9;
if (l9_8)
{
l9_9=(l9_5*1.0)!=0.0;
...
float2 l9_11=(*sc_set0.UserUniforms).trailFadeStartEnd;
l9_10=l9_11;
float2 l9_12=float2(0.0);
float l9_13=(*sc_set0.UserUniforms).Port_Input1_N216;
...
float2 l9_17=(*sc_set0.UserUniforms).trailFadeInOut;
l9_16=l9_17;
l9_14=l9_16;
l9_15=l9_14;
}
...
l9_18=float4(l9_10.x,l9_10.y,l9_18.z,l9_18.w);
l9_18=float4(l9_18.x,l9_18.y,l9_12.x,l9_12.y);
float3 l9_19=float3(0.0);
float3 l9_20=(*sc_set0.UserUniforms).colorStart;
l9_19=l9_20;
float3 l9_21=float3(0.0);
float3 l9_22=(*sc_set0.UserUniforms).colorEnd;
l9_21=l9_22;
float3 l9_23=float3(0.0);
float3 l9_24=(*sc_set0.UserUniforms).colorMinStart;
l9_23=l9_24;
float3 l9_25=float3(0.0);
float3 l9_26=(*sc_set0.UserUniforms).colorMinEnd;
l9_25=l9_26;
float3 l9_27=float3(0.0);
float3 l9_28=(*sc_set0.UserUniforms).colorMaxStart;
l9_27=l9_28;
float3 l9_29=float3(0.0);
float3 l9_30=(*sc_set0.UserUniforms).colorMaxEnd;
l9_29=l9_30;
float l9_31=0.0;
float l9_32=(*sc_set0.UserUniforms).alphaStart;
l9_31=l9_32;
float l9_33=0.0;
float l9_34=(*sc_set0.UserUniforms).alphaEnd;
l9_33=l9_34;
float l9_35=0.0;
float l9_36=(*sc_set0.UserUniforms).alphaMinStart;
l9_35=l9_36;
float l9_37=0.0;
float l9_38=(*sc_set0.UserUniforms).alphaMinEnd;
l9_37=l9_38;
float l9_39=0.0;
float l9_40=(*sc_set0.UserUniforms).alphaMaxStart;
l9_39=l9_40;
float l9_41=0.0;
float l9_42=(*sc_set0.UserUniforms).alphaMaxEnd;
l9_41=l9_42;
float l9_43=0.0;
float l9_44=(*sc_set0.UserUniforms).alphaDissolveMult;
l9_43=l9_44;
float l9_45=0.0;
float l9_46=(*sc_set0.UserUniforms).numValidFrames;
l9_45=l9_46;
float2 l9_47=float2(0.0);
float2 l9_48=(*sc_set0.UserUniforms).gridSize;
l9_47=l9_48;
float l9_49=0.0;
float l9_50=(*sc_set0.UserUniforms).flipBookSpeedMult;
l9_49=l9_50;
float l9_51=0.0;
float l9_52=(*sc_set0.UserUniforms).flipBookRandomStart;
l9_51=l9_52;
float2 l9_53=float2(0.0);
float2 l9_54=(*sc_set0.UserUniforms).colorRampTextureSize.xy;
l9_53=l9_54;
float4 l9_55=float4(0.0);
float4 l9_56=(*sc_set0.UserUniforms).colorRampMult;
l9_55=l9_56;
float l9_57=0.0;
float l9_58=(*sc_set0.UserUniforms).externalSeed;
l9_57=l9_58;
float4 l9_59=float4(0.0);
float4 l9_60;
l9_60.x=in.Interpolator0.x;
l9_60.y=in.Interpolator0.y;
l9_60.z=in.Interpolator0.z;
l9_60.w=in.Interpolator0.w;
l9_59=l9_60;
float4 l9_61=float4(0.0);
float4 l9_62;
l9_62.x=in.Interpolator1.x;
l9_62.y=in.Interpolator1.y;
l9_62.z=in.Interpolator1.z;
l9_62.w=in.Interpolator1.w;
l9_61=l9_62;
...
N2_colorMinStart=l9_68;
N2_colorMinEnd=l9_69;
N2_colorMaxStart=l9_70;
N2_colorMaxEnd=l9_71;
N2_ENABLE_COLORMONOMIN=(int(COLORMONOMIN_tmp)!=0);
N2_alphaStart=l9_72;
N2_alphaEnd=l9_73;
N2_ENABLE_ALPHAMINMAX=(int(ALPHAMINMAX_tmp)!=0);
N2_alphaMinStart=l9_74;
N2_alphaMinEnd=l9_75;
N2_alphaMaxStart=l9_76;
N2_alphaMaxEnd=l9_77;
N2_ENABLE_ALPHADISSOLVE=(int(ALPHADISSOLVE_tmp)!=0);
N2_alphaDissolveMult=l9_78;
...
N2_numValidFrames=l9_79;
N2_gridSize=l9_80;
N2_flipBookSpeedMult=l9_81;
N2_flipBookRandomStart=l9_82;
...
N2_externalSeed=l9_85;
N2_timeValuesIn=l9_86;
N2_cameraFade_trailHeadTime_taper=l9_87;
float l9_90=0.0;
if (N2_ENABLE_WORLDPOSSEED)
{
float4x4 l9_91=(*sc_set0.UserUniforms).sc_ModelMatrix;
l9_90=length(float4(1.0)*l9_91);
}
N2_globalSeed=N2_externalSeed+l9_90;
int l9_92=0;
l9_92=int(tempGlobals.gInstanceID+0.5);
int l9_93=l9_92;
float l9_94=float(l9_93);
int l9_95=int(l9_94);
int l9_96=l9_95^(l9_95*15299);
int l9_97=l9_96;
int l9_98=l9_97;
...
int l9_111=l9_106;
float l9_112=float(l9_111)*4.6566129e-10;
float3 l9_113=float3(l9_108,l9_110,l9_112);
float3 l9_114=l9_113;
N2_particleSeed=l9_114;
float l9_115=N2_timeValuesIn.w;
float l9_116=N2_particleSeed.x;
float l9_117=N2_particleSeed.y;
float l9_118=N2_particleSeed.z;
float3 l9_119=fract((float3(l9_116,l9_117,l9_118)*27.21883)+float3(N2_globalSeed));
if (N2_ENABLE_COLORMONOMIN)
{
l9_119=fract((float3(l9_116,l9_116,l9_116)*27.21883)+float3(N2_globalSeed));
}
float l9_120=fract((N2_particleSeed.x*3121.3333)+N2_globalSeed);
float l9_121=fract((N2_particleSeed.y*13.2234)+N2_globalSeed);
float l9_122=fract((N2_particleSeed.z*3.5358)+N2_globalSeed);
N2_isTrail=0.0;
float l9_123=1.0;
N2_trailHeadTime=N2_cameraFade_trailHeadTime_taper.yz;
float4 l9_124=float4(1.0);
float2 l9_125=tempGlobals.Surface_UVCoord0;
N2_uv=l9_125;
if (N2_ENABLE_TRAILS)
{
...
{
N2_isTrail=1.0;
float l9_126=N2_cameraFade_trailHeadTime_taper.w;
float2 l9_127=float2(0.5-(l9_126/2.0),0.5+(l9_126/2.0));
float l9_128=N2_uv.x;
float l9_129=l9_127.x;
bool l9_130=l9_128<l9_129;
bool l9_131;
if (!l9_130)
{
l9_131=N2_uv.x>l9_127.y;
}
else
{
l9_131=l9_130;
...
N2_uv=float2(0.0+(((N2_uv.x-l9_127.x)*1.0)/((l9_127.y-l9_127.x)+1e-06)),N2_uv.y);
if (N2_ENABLE_TRAILTEXTURE)
{
float2 l9_132=float2(N2_uv.x,1.0-N2_uv.y);
...
int l9_139=l9_134;
int l9_140=trailTexLayout_tmp;
int l9_141=l9_139;
float2 l9_142=l9_132;
bool l9_143=(int(SC_USE_UV_TRANSFORM_trailTex_tmp)!=0);
float3x3 l9_144=(*sc_set0.UserUniforms).trailTexTransform;
int2 l9_145=int2(SC_SOFTWARE_WRAP_MODE_U_trailTex_tmp,SC_SOFTWARE_WRAP_MODE_V_trailTex_tmp);
bool l9_146=(int(SC_USE_UV_MIN_MAX_trailTex_tmp)!=0);
float4 l9_147=(*sc_set0.UserUniforms).trailTexUvMinMax;
bool l9_148=(int(SC_USE_CLAMP_TO_BORDER_trailTex_tmp)!=0);
float4 l9_149=(*sc_set0.UserUniforms).trailTexBorderColor;
float l9_150=0.0;
...
float4 l9_217=sc_set0.trailTex.sample(sc_set0.trailTexSmpSC,l9_216.xy,bias(l9_210));
...
l9_133=l9_219;
float4 l9_220=l9_133;
l9_124=l9_220;
}
float l9_221=fast::max(1e-06,N2_fadeInOut.x);
float l9_222=N2_timeValuesIn.w;
l9_123*=mix(0.0,1.0,fast::clamp(l9_222,0.0,l9_221)/l9_221);
l9_221=fast::max(1e-06,N2_fadeInOut.y);
l9_123*=mix(0.0,1.0,fast::clamp(1.0-l9_222,0.0,l9_221)/l9_221);
if (!N2_ENABLE_INDEPENDENTTRAIL)
{
l9_115=N2_trailHeadTime.y;
l9_221=fast::max(1e-06,N2_fadeInOut.z);
l9_123*=mix(0.0,1.0,fast::clamp(l9_115,0.0,l9_221)/l9_221);
l9_221=fast::max(1e-06,N2_fadeInOut.w);
l9_123*=mix(0.0,1.0,fast::clamp(1.0-l9_115,0.0,l9_221)/l9_221);
}
...
l9_225=(*sc_set0.UserUniforms).trailColorRampTexSize.xy;
float2 l9_226=l9_225;
float l9_227=ceil(l9_115*l9_224.x)/l9_226.x;
float2 l9_228=float2(l9_227,0.5);
...
int l9_235=l9_230;
int l9_236=trailColorRampTexLayout_tmp;
int l9_237=l9_235;
float2 l9_238=l9_228;
bool l9_239=(int(SC_USE_UV_TRANSFORM_trailColorRampTex_tmp)!=0);
float3x3 l9_240=(*sc_set0.UserUniforms).trailColorRampTexTransform;
int2 l9_241=int2(SC_SOFTWARE_WRAP_MODE_U_trailColorRampTex_tmp,SC_SOFTWARE_WRAP_MODE_V_trailColorRampTex_tmp);
bool l9_242=(int(SC_USE_UV_MIN_MAX_trailColorRampTex_tmp)!=0);
float4 l9_243=(*sc_set0.UserUniforms).trailColorRampTexUvMinMax;
bool l9_244=(int(SC_USE_CLAMP_TO_BORDER_trailColorRampTex_tmp)!=0);
float4 l9_245=(*sc_set0.UserUniforms).trailColorRampTexBorderColor;
float l9_246=0.0;
...
float4 l9_313=sc_set0.trailColorRampTex.sample(sc_set0.trailColorRampTexSmpSC,l9_312.xy,bias(l9_306));
float4 l9_314=l9_313;
if (l9_244)
{
l9_314=mix(l9_245,l9_314,float4(l9_248));
}
float4 l9_315=l9_314;
l9_229=l9_315;
float4 l9_316=l9_229;
l9_124*=l9_316;
}
}
}
...
{
l9_318=mix(N2_colorMinStart,N2_colorMaxStart,l9_119);
l9_319=mix(N2_colorMinEnd,N2_colorMaxEnd,l9_119);
}
else
{
l9_318=N2_colorStart;
l9_319=N2_colorEnd;
}
if (N2_ENABLE_ALPHAMINMAX)
{
l9_320=mix(N2_alphaMinStart,N2_alphaMaxStart,l9_120);
l9_321=mix(N2_alphaMinEnd,N2_alphaMaxEnd,l9_120);
}
else
{
l9_320=N2_alphaStart;
l9_321=N2_alphaEnd;
}
l9_318=mix(l9_318,l9_319,float3(l9_115));
l9_320=mix(l9_320,l9_321,l9_115);
l9_317=float4(l9_318,l9_320);
...
l9_323=l9_324;
float2 l9_325=l9_323;
float l9_326=fast::max(N2_timeValuesIn.x,1e-06);
float l9_327=fast::max(N2_timeValuesIn.y,1e-06);
float l9_328=N2_timeValuesIn.z;
if (N2_ENABLE_FLIPBOOKBYLIFE)
{
float l9_329=mix(l9_326,l9_327,l9_122);
l9_328/=l9_329;
}
float l9_330=floor((N2_flipBookRandomStart+1.0)*l9_121);
float2 l9_331=l9_323;
float2 l9_332=N2_gridSize;
float l9_333=N2_numValidFrames;
float l9_334=l9_330;
float l9_335=N2_flipBookSpeedMult;
float l9_336=l9_328;
float l9_337=floor(l9_332.x);
float l9_338=floor(l9_332.y);
float l9_339=1.0/l9_337;
float l9_340=1.0/l9_338;
float l9_341=fast::min(l9_337*l9_338,floor(l9_333));
float l9_342=floor(mod((l9_336*l9_335)+floor(l9_334),l9_341));
float l9_343=floor(l9_342/l9_337);
float l9_344=mod(l9_342,l9_337);
float2 l9_345=float2((l9_339*l9_331.x)+(l9_344*l9_339),((1.0-l9_340)-(l9_343*l9_340))+(l9_340*l9_331.y));
l9_323=l9_345;
float2 l9_346=l9_323;
...
int l9_353=l9_348;
int l9_354=mainTextureLayout_tmp;
int l9_355=l9_353;
float2 l9_356=l9_346;
bool l9_357=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 l9_358=(*sc_set0.UserUniforms).mainTextureTransform;
int2 l9_359=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool l9_360=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 l9_361=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool l9_362=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 l9_363=(*sc_set0.UserUniforms).mainTextureBorderColor;
float l9_364=0.0;
bool l9_365=l9_362&&(!l9_360);
float l9_366=1.0;
float l9_367=l9_356.x;
int l9_368=l9_359.x;
if (l9_368==1)
{
l9_367=fract(l9_367);
...
if (l9_368==2)
{
float l9_369=fract(l9_367);
float l9_370=l9_367-l9_369;
float l9_371=step(0.25,fract(l9_370*0.5));
l9_367=mix(l9_369,1.0-l9_369,fast::clamp(l9_371,0.0,1.0));
}
}
l9_356.x=l9_367;
float l9_372=l9_356.y;
int l9_373=l9_359.y;
if (l9_373==1)
{
l9_372=fract(l9_372);
...
if (l9_373==2)
{
float l9_374=fract(l9_372);
float l9_375=l9_372-l9_374;
float l9_376=step(0.25,fract(l9_375*0.5));
l9_372=mix(l9_374,1.0-l9_374,fast::clamp(l9_376,0.0,1.0));
}
}
l9_356.y=l9_372;
if (l9_360)
...
float l9_379=l9_356.x;
float l9_380=l9_361.x;
float l9_381=l9_361.z;
bool l9_382=l9_378;
float l9_383=l9_366;
...
float l9_388=l9_356.y;
float l9_389=l9_361.y;
float l9_390=l9_361.w;
bool l9_391=l9_387;
float l9_392=l9_366;
...
float2 l9_395=l9_356;
bool l9_396=l9_357;
float3x3 l9_397=l9_358;
if (l9_396)
{
l9_395=float2((l9_397*float3(l9_395,1.0)).xy);
}
float2 l9_398=l9_395;
l9_356=l9_398;
float l9_399=l9_356.x;
int l9_400=l9_359.x;
bool l9_401=l9_365;
float l9_402=l9_366;
...
float4 l9_431=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_430.xy,bias(l9_424));
float4 l9_432=l9_431;
if (l9_362)
{
l9_432=mix(l9_363,l9_432,float4(l9_366));
}
float4 l9_433=l9_432;
l9_347=l9_433;
float4 l9_434=l9_347;
l9_322=l9_434;
if (N2_ENABLE_FLIPBOOKBLEND)
{
float2 l9_435=l9_325;
float2 l9_436=N2_gridSize;
float l9_437=N2_numValidFrames;
float l9_438=floor(mod(l9_330+1.0,N2_numValidFrames));
float l9_439=N2_flipBookSpeedMult;
float l9_440=l9_328;
float l9_441=floor(l9_436.x);
float l9_442=floor(l9_436.y);
float l9_443=1.0/l9_441;
float l9_444=1.0/l9_442;
float l9_445=fast::min(l9_441*l9_442,floor(l9_437));
float l9_446=floor(mod((l9_440*l9_439)+floor(l9_438),l9_445));
float l9_447=floor(l9_446/l9_441);
float l9_448=mod(l9_446,l9_441);
float2 l9_449=float2((l9_443*l9_435.x)+(l9_448*l9_443),((1.0-l9_444)-(l9_447*l9_444))+(l9_444*l9_435.y));
l9_325=l9_449;
float4 l9_450=l9_322;
float2 l9_451=l9_325;
...
int l9_458=l9_453;
int l9_459=mainTextureLayout_tmp;
int l9_460=l9_458;
float2 l9_461=l9_451;
bool l9_462=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 l9_463=(*sc_set0.UserUniforms).mainTextureTransform;
int2 l9_464=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool l9_465=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 l9_466=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool l9_467=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 l9_468=(*sc_set0.UserUniforms).mainTextureBorderColor;
float l9_469=0.0;
bool l9_470=l9_467&&(!l9_465);
float l9_471=1.0;
float l9_472=l9_461.x;
int l9_473=l9_464.x;
if (l9_473==1)
{
l9_472=fract(l9_472);
...
if (l9_473==2)
{
float l9_474=fract(l9_472);
float l9_475=l9_472-l9_474;
float l9_476=step(0.25,fract(l9_475*0.5));
l9_472=mix(l9_474,1.0-l9_474,fast::clamp(l9_476,0.0,1.0));
}
}
l9_461.x=l9_472;
float l9_477=l9_461.y;
int l9_478=l9_464.y;
if (l9_478==1)
{
l9_477=fract(l9_477);
...
float l9_484=l9_461.x;
float l9_485=l9_466.x;
float l9_486=l9_466.z;
bool l9_487=l9_483;
float l9_488=l9_471;
...
float l9_493=l9_461.y;
float l9_494=l9_466.y;
float l9_495=l9_466.w;
bool l9_496=l9_492;
float l9_497=l9_471;
...
float2 l9_500=l9_461;
bool l9_501=l9_462;
float3x3 l9_502=l9_463;
if (l9_501)
{
l9_500=float2((l9_502*float3(l9_500,1.0)).xy);
}
float2 l9_503=l9_500;
l9_461=l9_503;
float l9_504=l9_461.x;
int l9_505=l9_464.x;
bool l9_506=l9_470;
float l9_507=l9_471;
if ((l9_505==0)||(l9_505==3))
{
float l9_508=l9_504;
float l9_509=0.0;
float l9_510=1.0;
...
int l9_531=l9_527;
int l9_532=l9_528;
float3 l9_533=float3(0.0);
if (l9_531==0)
{
l9_533=float3(l9_530,0.0);
}
else
{
if (l9_531==1)
{
l9_533=float3(l9_530.x,(l9_530.y*0.5)+(0.5-(float(l9_532)*0.5)),0.0);
}
else
{
l9_533=float3(l9_530,float(l9_532));
}
}
float3 l9_534=l9_533;
float3 l9_535=l9_534;
float4 l9_536=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_535.xy,bias(l9_529));
float4 l9_537=l9_536;
if (l9_467)
{
l9_537=mix(l9_468,l9_537,float4(l9_471));
}
float4 l9_538=l9_537;
l9_452=l9_538;
float4 l9_539=l9_452;
l9_322=mix(l9_450,l9_539,float4(fract((l9_328*N2_flipBookSpeedMult)+l9_330)));
}
}
}
float4 l9_540=float4(1.0);
if (N2_ENABLE_COLORRAMP)
{
float l9_541=ceil(l9_115*N2_texSize.x)/N2_texSize.x;
float l9_542=l9_541;
if (N2_ENABLE_NORANDOFFSET)
{
float2 l9_543=tempGlobals.Surface_UVCoord0;
l9_542+=(l9_543.x/N2_texSize.x);
}
float2 l9_544=float2(l9_542,0.5);
...
{
l9_549=in.varStereoViewID;
}
int l9_550=l9_549;
l9_546=l9_550;
}
int l9_551=l9_546;
int l9_552=colorRampTextureLayout_tmp;
int l9_553=l9_551;
float2 l9_554=l9_544;
bool l9_555=(int(SC_USE_UV_TRANSFORM_colorRampTexture_tmp)!=0);
float3x3 l9_556=(*sc_set0.UserUniforms).colorRampTextureTransform;
int2 l9_557=int2(SC_SOFTWARE_WRAP_MODE_U_colorRampTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_colorRampTexture_tmp);
bool l9_558=(int(SC_USE_UV_MIN_MAX_colorRampTexture_tmp)!=0);
float4 l9_559=(*sc_set0.UserUniforms).colorRampTextureUvMinMax;
bool l9_560=(int(SC_USE_CLAMP_TO_BORDER_colorRampTexture_tmp)!=0);
float4 l9_561=(*sc_set0.UserUniforms).colorRampTextureBorderColor;
float l9_562=0.0;
bool l9_563=l9_560&&(!l9_558);
float l9_564=1.0;
float l9_565=l9_554.x;
int l9_566=l9_557.x;
if (l9_566==1)
{
l9_565=fract(l9_565);
...
if (l9_566==2)
{
float l9_567=fract(l9_565);
float l9_568=l9_565-l9_567;
float l9_569=step(0.25,fract(l9_568*0.5));
l9_565=mix(l9_567,1.0-l9_567,fast::clamp(l9_569,0.0,1.0));
}
}
l9_554.x=l9_565;
float l9_570=l9_554.y;
int l9_571=l9_557.y;
if (l9_571==1)
{
l9_570=fract(l9_570);
...
float l9_577=l9_554.x;
float l9_578=l9_559.x;
float l9_579=l9_559.z;
bool l9_580=l9_576;
float l9_581=l9_564;
...
float l9_586=l9_554.y;
float l9_587=l9_559.y;
float l9_588=l9_559.w;
bool l9_589=l9_585;
float l9_590=l9_564;
float l9_591=fast::clamp(l9_586,l9_587,l9_588);
float l9_592=step(abs(l9_586-l9_591),9.9999997e-06);
l9_590*=(l9_592+((1.0-float(l9_589))*(1.0-l9_592)));
l9_586=l9_591;
l9_554.y=l9_586;
l9_564=l9_590;
}
float2 l9_593=l9_554;
bool l9_594=l9_555;
float3x3 l9_595=l9_556;
if (l9_594)
{
l9_593=float2((l9_595*float3(l9_593,1.0)).xy);
}
float2 l9_596=l9_593;
l9_554=l9_596;
float l9_597=l9_554.x;
int l9_598=l9_557.x;
bool l9_599=l9_563;
float l9_600=l9_564;
if ((l9_598==0)||(l9_598==3))
...
l9_554.x=l9_597;
l9_564=l9_600;
float l9_608=l9_554.y;
int l9_609=l9_557.y;
bool l9_610=l9_563;
float l9_611=l9_564;
if ((l9_609==0)||(l9_609==3))
{
float l9_612=l9_608;
float l9_613=0.0;
float l9_614=1.0;
...
if (l9_624==0)
{
l9_626=float3(l9_623,0.0);
}
else
{
if (l9_624==1)
{
l9_626=float3(l9_623.x,(l9_623.y*0.5)+(0.5-(float(l9_625)*0.5)),0.0);
}
else
{
l9_626=float3(l9_623,float(l9_625));
}
}
float3 l9_627=l9_626;
float3 l9_628=l9_627;
float4 l9_629=sc_set0.colorRampTexture.sample(sc_set0.colorRampTextureSmpSC,l9_628.xy,bias(l9_622));
float4 l9_630=l9_629;
if (l9_560)
{
l9_630=mix(l9_561,l9_630,float4(l9_564));
}
float4 l9_631=l9_630;
l9_545=l9_631;
float4 l9_632=l9_545;
l9_540=l9_632*N2_colorRampMult;
}
float4 l9_633=float4(1.0);
float4 l9_634=float4(1.0);
if (N2_ENABLE_BASETEXTURE)
{
if (N2_ENABLE_FLIPBOOK)
{
...
int l9_642=l9_637;
int l9_643=mainTextureLayout_tmp;
int l9_644=l9_642;
float2 l9_645=l9_635;
bool l9_646=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 l9_647=(*sc_set0.UserUniforms).mainTextureTransform;
int2 l9_648=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool l9_649=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 l9_650=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool l9_651=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 l9_652=(*sc_set0.UserUniforms).mainTextureBorderColor;
float l9_653=0.0;
bool l9_654=l9_651&&(!l9_649);
float l9_655=1.0;
float l9_656=l9_645.x;
int l9_657=l9_648.x;
if (l9_657==1)
{
l9_656=fract(l9_656);
...
float l9_668=l9_645.x;
float l9_669=l9_650.x;
float l9_670=l9_650.z;
bool l9_671=l9_667;
float l9_672=l9_655;
...
float l9_677=l9_645.y;
float l9_678=l9_650.y;
float l9_679=l9_650.w;
bool l9_680=l9_676;
float l9_681=l9_655;
...
float2 l9_684=l9_645;
bool l9_685=l9_646;
float3x3 l9_686=l9_647;
if (l9_685)
{
l9_684=float2((l9_686*float3(l9_684,1.0)).xy);
}
float2 l9_687=l9_684;
l9_645=l9_687;
float l9_688=l9_645.x;
int l9_689=l9_648.x;
bool l9_690=l9_654;
float l9_691=l9_655;
...
float l9_698=step(abs(l9_692-l9_697),9.9999997e-06);
...
l9_645.y=l9_699;
l9_655=l9_702;
float2 l9_710=l9_645;
int l9_711=l9_643;
int l9_712=l9_644;
float l9_713=l9_653;
float2 l9_714=l9_710;
int l9_715=l9_711;
int l9_716=l9_712;
float3 l9_717=float3(0.0);
if (l9_715==0)
{
l9_717=float3(l9_714,0.0);
}
else
{
if (l9_715==1)
{
l9_717=float3(l9_714.x,(l9_714.y*0.5)+(0.5-(float(l9_716)*0.5)),0.0);
}
else
{
l9_717=float3(l9_714,float(l9_716));
}
}
float3 l9_718=l9_717;
float3 l9_719=l9_718;
float4 l9_720=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_719.xy,bias(l9_713));
float4 l9_721=l9_720;
if (l9_651)
{
l9_721=mix(l9_652,l9_721,float4(l9_655));
}
float4 l9_722=l9_721;
l9_636=l9_722;
float4 l9_723=l9_636;
l9_633=l9_723;
}
}
if (N2_ENABLE_COLORRAMP)
...
N2_result=(l9_633*l9_317)*l9_634;
if (N2_ENABLE_TRAILS)
{
if (N2_isTrail>0.0)
{
N2_result=(l9_124*l9_317)*l9_634;
N2_result.w*=l9_123;
}
}
...
{
float l9_724=l9_115*N2_alphaDissolveMult;
N2_result.w=fast::clamp(N2_result.w-l9_724,0.0,1.0);
}
if (N2_ENABLE_BLACKASALPHA)
{
float l9_725=length(N2_result.xyz);
N2_result.w=l9_725;
if (N2_ENABLE_TRAILS)
{
N2_result.w*=l9_123;
...
{
float3 l9_726=N2_result.xyz*N2_result.w;
N2_result=float4(l9_726.x,l9_726.y,l9_726.z,N2_result.w);
}
l9_89=N2_result;
l9_63=l9_89;
float4 l9_727=float4(0.0);
l9_727=float4(l9_1)*l9_63;
float4 l9_728=float4(0.0);
l9_728=param_3.VertexColor;
float l9_729=0.0;
l9_729=1.0-l9_1;
float4 l9_730=float4(0.0);
l9_730=l9_728*float4(l9_729);
float4 l9_731=float4(0.0);
float4 l9_732=l9_727;
float4 l9_733=l9_730;
float4 l9_734=l9_732;
float4 l9_735=l9_733;
float3 l9_736=l9_734.xyz*l9_734.w;
l9_734=float4(l9_736.x,l9_736.y,l9_736.z,l9_734.w);
float4 l9_737=fast::min(l9_734+l9_735,float4(1.0));
l9_731=l9_737;
float l9_738=0.0;
float4 l9_739=l9_63;
float l9_740=l9_739.w;
l9_738=l9_740;
float3 l9_741=float3(0.0);
float3 l9_742=float3(0.0);
float3 l9_743=(*sc_set0.UserUniforms).Port_Default_N182;
...
l9_750=float(l9_753);
float2 l9_754=float2(0.0);
float2 l9_755=(*sc_set0.UserUniforms).trailFadeStartEnd;
l9_754=l9_755;
float2 l9_756=float2(0.0);
float l9_757=(*sc_set0.UserUniforms).Port_Input1_N216;
float2 l9_758=float2(0.0);
float2 l9_759;
if (TRAILBEHAVIOR_tmp!=0)
{
l9_759=float2(l9_757);
}
else
{
float2 l9_760=float2(0.0);
float2 l9_761=(*sc_set0.UserUniforms).trailFadeInOut;
l9_760=l9_761;
l9_758=l9_760;
l9_759=l9_758;
}
...
l9_762=float4(l9_754.x,l9_754.y,l9_762.z,l9_762.w);
l9_762=float4(l9_762.x,l9_762.y,l9_756.x,l9_756.y);
float3 l9_763=float3(0.0);
float3 l9_764=(*sc_set0.UserUniforms).colorStart;
l9_763=l9_764;
float3 l9_765=float3(0.0);
float3 l9_766=(*sc_set0.UserUniforms).colorEnd;
l9_765=l9_766;
float3 l9_767=float3(0.0);
float3 l9_768=(*sc_set0.UserUniforms).colorMinStart;
l9_767=l9_768;
float3 l9_769=float3(0.0);
float3 l9_770=(*sc_set0.UserUniforms).colorMinEnd;
l9_769=l9_770;
float3 l9_771=float3(0.0);
float3 l9_772=(*sc_set0.UserUniforms).colorMaxStart;
l9_771=l9_772;
float3 l9_773=float3(0.0);
float3 l9_774=(*sc_set0.UserUniforms).colorMaxEnd;
l9_773=l9_774;
float l9_775=0.0;
float l9_776=(*sc_set0.UserUniforms).alphaStart;
l9_775=l9_776;
float l9_777=0.0;
float l9_778=(*sc_set0.UserUniforms).alphaEnd;
l9_777=l9_778;
float l9_779=0.0;
float l9_780=(*sc_set0.UserUniforms).alphaMinStart;
l9_779=l9_780;
float l9_781=0.0;
float l9_782=(*sc_set0.UserUniforms).alphaMinEnd;
l9_781=l9_782;
float l9_783=0.0;
float l9_784=(*sc_set0.UserUniforms).alphaMaxStart;
l9_783=l9_784;
float l9_785=0.0;
float l9_786=(*sc_set0.UserUniforms).alphaMaxEnd;
l9_785=l9_786;
float l9_787=0.0;
float l9_788=(*sc_set0.UserUniforms).alphaDissolveMult;
l9_787=l9_788;
float l9_789=0.0;
float l9_790=(*sc_set0.UserUniforms).numValidFrames;
l9_789=l9_790;
float2 l9_791=float2(0.0);
float2 l9_792=(*sc_set0.UserUniforms).gridSize;
l9_791=l9_792;
float l9_793=0.0;
float l9_794=(*sc_set0.UserUniforms).flipBookSpeedMult;
l9_793=l9_794;
float l9_795=0.0;
float l9_796=(*sc_set0.UserUniforms).flipBookRandomStart;
l9_795=l9_796;
float2 l9_797=float2(0.0);
float2 l9_798=(*sc_set0.UserUniforms).colorRampTextureSize.xy;
l9_797=l9_798;
float4 l9_799=float4(0.0);
float4 l9_800=(*sc_set0.UserUniforms).colorRampMult;
l9_799=l9_800;
float l9_801=0.0;
float l9_802=(*sc_set0.UserUniforms).externalSeed;
l9_801=l9_802;
float4 l9_803=float4(0.0);
float4 l9_804;
l9_804.x=in.Interpolator0.x;
l9_804.y=in.Interpolator0.y;
l9_804.z=in.Interpolator0.z;
l9_804.w=in.Interpolator0.w;
l9_803=l9_804;
float4 l9_805=float4(0.0);
float4 l9_806;
l9_806.x=in.Interpolator1.x;
l9_806.y=in.Interpolator1.y;
l9_806.z=in.Interpolator1.z;
l9_806.w=in.Interpolator1.w;
l9_805=l9_806;
float2 l9_807=float2(0.0);
float l9_808=l9_750;
float4 l9_809=l9_762;
float3 l9_810=l9_763;
float3 l9_811=l9_765;
float3 l9_812=l9_767;
float3 l9_813=l9_769;
float3 l9_814=l9_771;
float3 l9_815=l9_773;
float l9_816=l9_775;
float l9_817=l9_777;
float l9_818=l9_779;
float l9_819=l9_781;
...
float l9_822=l9_787;
float l9_823=l9_789;
float2 l9_824=l9_791;
float l9_825=l9_793;
float l9_826=l9_795;
float2 l9_827=l9_797;
float4 l9_828=l9_799;
float l9_829=l9_801;
float4 l9_830=l9_803;
float4 l9_831=l9_805;
ssGlobals l9_832=l9_744;
tempGlobals=l9_832;
float2 l9_833=float2(0.0);
N2_ENABLE_TRAILS=(int(TRAILS_tmp)!=0);
N2_ENABLE_INDEPENDENTTRAIL=TRAILBEHAVIOR_tmp!=0;
N2_isTrailCondition=l9_808!=0.0;
N2_ENABLE_TRAILTEXTURE=(int(TRAILTEXTURE_tmp)!=0);
N2_ENABLE_TRAILCOLORRAMP=(int(TRAILCOLORRAMP_tmp)!=0);
N2_fadeInOut=l9_809;
N2_colorStart=l9_810;
N2_colorEnd=l9_811;
N2_ENABLE_COLORMINMAX=(int(COLORMINMAX_tmp)!=0);
N2_colorMinStart=l9_812;
N2_colorMinEnd=l9_813;
N2_colorMaxStart=l9_814;
N2_colorMaxEnd=l9_815;
N2_ENABLE_COLORMONOMIN=(int(COLORMONOMIN_tmp)!=0);
N2_alphaStart=l9_816;
N2_alphaEnd=l9_817;
N2_ENABLE_ALPHAMINMAX=(int(ALPHAMINMAX_tmp)!=0);
N2_alphaMinStart=l9_818;
N2_alphaMinEnd=l9_819;
N2_alphaMaxStart=l9_820;
N2_alphaMaxEnd=l9_821;
N2_ENABLE_ALPHADISSOLVE=(int(ALPHADISSOLVE_tmp)!=0);
N2_alphaDissolveMult=l9_822;
N2_ENABLE_PREMULTIPLIEDCOLOR=(int(PREMULTIPLIEDCOLOR_tmp)!=0);
N2_ENABLE_BLACKASALPHA=(int(BLACKASALPHA_tmp)!=0);
N2_ENABLE_SCREENFADE=(int(SCREENFADE_tmp)!=0);
N2_ENABLE_FLIPBOOK=(int(FLIPBOOK_tmp)!=0);
N2_numValidFrames=l9_823;
N2_gridSize=l9_824;
N2_flipBookSpeedMult=l9_825;
N2_flipBookRandomStart=l9_826;
N2_ENABLE_FLIPBOOKBLEND=(int(FLIPBOOKBLEND_tmp)!=0);
N2_ENABLE_FLIPBOOKBYLIFE=(int(FLIPBOOKBYLIFE_tmp)!=0);
N2_ENABLE_COLORRAMP=(int(COLORRAMP_tmp)!=0);
N2_texSize=l9_827;
N2_colorRampMult=l9_828;
N2_ENABLE_NORANDOFFSET=(int(NORANDOFFSET_tmp)!=0);
N2_ENABLE_BASETEXTURE=(int(BASETEXTURE_tmp)!=0);
N2_ENABLE_WORLDPOSSEED=(int(WORLDPOSSEED_tmp)!=0);
N2_externalSeed=l9_829;
N2_timeValuesIn=l9_830;
N2_cameraFade_trailHeadTime_taper=l9_831;
float l9_834=0.0;
if (N2_ENABLE_WORLDPOSSEED)
{
float4x4 l9_835=(*sc_set0.UserUniforms).sc_ModelMatrix;
l9_834=length(float4(1.0)*l9_835);
}
N2_globalSeed=N2_externalSeed+l9_834;
int l9_836=0;
l9_836=int(tempGlobals.gInstanceID+0.5);
int l9_837=l9_836;
float l9_838=float(l9_837);
int l9_839=int(l9_838);
int l9_840=l9_839^(l9_839*15299);
int l9_841=l9_840;
int l9_842=l9_841;
...
int l9_850=l9_849;
int l9_851=l9_844;
float l9_852=float(l9_851)*4.6566129e-10;
int l9_853=l9_847;
float l9_854=float(l9_853)*4.6566129e-10;
int l9_855=l9_850;
float l9_856=float(l9_855)*4.6566129e-10;
float3 l9_857=float3(l9_852,l9_854,l9_856);
float3 l9_858=l9_857;
N2_particleSeed=l9_858;
float l9_859=N2_timeValuesIn.w;
float l9_860=N2_particleSeed.x;
float l9_861=N2_particleSeed.y;
float l9_862=N2_particleSeed.z;
float3 l9_863=fract((float3(l9_860,l9_861,l9_862)*27.21883)+float3(N2_globalSeed));
if (N2_ENABLE_COLORMONOMIN)
{
l9_863=fract((float3(l9_860,l9_860,l9_860)*27.21883)+float3(N2_globalSeed));
}
float l9_864=fract((N2_particleSeed.x*3121.3333)+N2_globalSeed);
float l9_865=fract((N2_particleSeed.y*13.2234)+N2_globalSeed);
float l9_866=fract((N2_particleSeed.z*3.5358)+N2_globalSeed);
N2_isTrail=0.0;
float l9_867=1.0;
N2_trailHeadTime=N2_cameraFade_trailHeadTime_taper.yz;
float4 l9_868=float4(1.0);
float2 l9_869=tempGlobals.Surface_UVCoord0;
N2_uv=l9_869;
if (N2_ENABLE_TRAILS)
{
if (N2_isTrailCondition)
{
N2_isTrail=1.0;
float l9_870=N2_cameraFade_trailHeadTime_taper.w;
float2 l9_871=float2(0.5-(l9_870/2.0),0.5+(l9_870/2.0));
float l9_872=N2_uv.x;
float l9_873=l9_871.x;
bool l9_874=l9_872<l9_873;
bool l9_875;
if (!l9_874)
{
l9_875=N2_uv.x>l9_871.y;
}
else
{
l9_875=l9_874;
...
N2_uv=float2(0.0+(((N2_uv.x-l9_871.x)*1.0)/((l9_871.y-l9_871.x)+1e-06)),N2_uv.y);
if (N2_ENABLE_TRAILTEXTURE)
{
float2 l9_876=float2(N2_uv.x,1.0-N2_uv.y);
...
{
l9_881=in.varStereoViewID;
}
int l9_882=l9_881;
l9_878=l9_882;
}
int l9_883=l9_878;
int l9_884=trailTexLayout_tmp;
int l9_885=l9_883;
float2 l9_886=l9_876;
bool l9_887=(int(SC_USE_UV_TRANSFORM_trailTex_tmp)!=0);
float3x3 l9_888=(*sc_set0.UserUniforms).trailTexTransform;
int2 l9_889=int2(SC_SOFTWARE_WRAP_MODE_U_trailTex_tmp,SC_SOFTWARE_WRAP_MODE_V_trailTex_tmp);
bool l9_890=(int(SC_USE_UV_MIN_MAX_trailTex_tmp)!=0);
float4 l9_891=(*sc_set0.UserUniforms).trailTexUvMinMax;
bool l9_892=(int(SC_USE_CLAMP_TO_BORDER_trailTex_tmp)!=0);
float4 l9_893=(*sc_set0.UserUniforms).trailTexBorderColor;
float l9_894=0.0;
bool l9_895=l9_892&&(!l9_890);
float l9_896=1.0;
float l9_897=l9_886.x;
int l9_898=l9_889.x;
if (l9_898==1)
{
l9_897=fract(l9_897);
...
float l9_909=l9_886.x;
float l9_910=l9_891.x;
float l9_911=l9_891.z;
bool l9_912=l9_908;
float l9_913=l9_896;
...
float l9_918=l9_886.y;
float l9_919=l9_891.y;
float l9_920=l9_891.w;
bool l9_921=l9_917;
float l9_922=l9_896;
...
float2 l9_925=l9_886;
bool l9_926=l9_887;
float3x3 l9_927=l9_888;
if (l9_926)
{
l9_925=float2((l9_927*float3(l9_925,1.0)).xy);
}
float2 l9_928=l9_925;
l9_886=l9_928;
float l9_929=l9_886.x;
int l9_930=l9_889.x;
bool l9_931=l9_895;
float l9_932=l9_896;
...
l9_886.y=l9_940;
l9_896=l9_943;
float2 l9_951=l9_886;
int l9_952=l9_884;
int l9_953=l9_885;
float l9_954=l9_894;
float2 l9_955=l9_951;
int l9_956=l9_952;
int l9_957=l9_953;
float3 l9_958=float3(0.0);
if (l9_956==0)
{
l9_958=float3(l9_955,0.0);
}
else
{
if (l9_956==1)
{
l9_958=float3(l9_955.x,(l9_955.y*0.5)+(0.5-(float(l9_957)*0.5)),0.0);
}
else
{
l9_958=float3(l9_955,float(l9_957));
}
}
float3 l9_959=l9_958;
float3 l9_960=l9_959;
float4 l9_961=sc_set0.trailTex.sample(sc_set0.trailTexSmpSC,l9_960.xy,bias(l9_954));
float4 l9_962=l9_961;
if (l9_892)
{
l9_962=mix(l9_893,l9_962,float4(l9_896));
}
float4 l9_963=l9_962;
l9_877=l9_963;
float4 l9_964=l9_877;
l9_868=l9_964;
}
float l9_965=fast::max(1e-06,N2_fadeInOut.x);
float l9_966=N2_timeValuesIn.w;
l9_867*=mix(0.0,1.0,fast::clamp(l9_966,0.0,l9_965)/l9_965);
l9_965=fast::max(1e-06,N2_fadeInOut.y);
l9_867*=mix(0.0,1.0,fast::clamp(1.0-l9_966,0.0,l9_965)/l9_965);
if (!N2_ENABLE_INDEPENDENTTRAIL)
{
l9_859=N2_trailHeadTime.y;
l9_965=fast::max(1e-06,N2_fadeInOut.z);
l9_867*=mix(0.0,1.0,fast::clamp(l9_859,0.0,l9_965)/l9_965);
l9_965=fast::max(1e-06,N2_fadeInOut.w);
l9_867*=mix(0.0,1.0,fast::clamp(1.0-l9_859,0.0,l9_965)/l9_965);
}
if (N2_ENABLE_TRAILCOLORRAMP)
{
float2 l9_967=float2(0.0);
l9_967=(*sc_set0.UserUniforms).trailColorRampTexSize.xy;
float2 l9_968=l9_967;
float2 l9_969=float2(0.0);
l9_969=(*sc_set0.UserUniforms).trailColorRampTexSize.xy;
float2 l9_970=l9_969;
float l9_971=ceil(l9_859*l9_968.x)/l9_970.x;
float2 l9_972=float2(l9_971,0.5);
...
int l9_979=l9_974;
int l9_980=trailColorRampTexLayout_tmp;
int l9_981=l9_979;
float2 l9_982=l9_972;
bool l9_983=(int(SC_USE_UV_TRANSFORM_trailColorRampTex_tmp)!=0);
float3x3 l9_984=(*sc_set0.UserUniforms).trailColorRampTexTransform;
int2 l9_985=int2(SC_SOFTWARE_WRAP_MODE_U_trailColorRampTex_tmp,SC_SOFTWARE_WRAP_MODE_V_trailColorRampTex_tmp);
bool l9_986=(int(SC_USE_UV_MIN_MAX_trailColorRampTex_tmp)!=0);
float4 l9_987=(*sc_set0.UserUniforms).trailColorRampTexUvMinMax;
bool l9_988=(int(SC_USE_CLAMP_TO_BORDER_trailColorRampTex_tmp)!=0);
float4 l9_989=(*sc_set0.UserUniforms).trailColorRampTexBorderColor;
float l9_990=0.0;
...
float4 l9_1057=sc_set0.trailColorRampTex.sample(sc_set0.trailColorRampTexSmpSC,l9_1056.xy,bias(l9_1050));
...
if (N2_ENABLE_COLORMINMAX)
{
l9_1062=mix(N2_colorMinStart,N2_colorMaxStart,l9_863);
l9_1063=mix(N2_colorMinEnd,N2_colorMaxEnd,l9_863);
}
else
{
l9_1062=N2_colorStart;
l9_1063=N2_colorEnd;
}
if (N2_ENABLE_ALPHAMINMAX)
{
l9_1064=mix(N2_alphaMinStart,N2_alphaMaxStart,l9_864);
l9_1065=mix(N2_alphaMinEnd,N2_alphaMaxEnd,l9_864);
}
else
{
l9_1064=N2_alphaStart;
l9_1065=N2_alphaEnd;
}
l9_1062=mix(l9_1062,l9_1063,float3(l9_859));
l9_1064=mix(l9_1064,l9_1065,l9_859);
l9_1061=float4(l9_1062,l9_1064);
...
if (N2_ENABLE_FLIPBOOK)
{
float2 l9_1068=tempGlobals.Surface_UVCoord0;
l9_1067=l9_1068;
float2 l9_1069=l9_1067;
float l9_1070=fast::max(N2_timeValuesIn.x,1e-06);
float l9_1071=fast::max(N2_timeValuesIn.y,1e-06);
float l9_1072=N2_timeValuesIn.z;
if (N2_ENABLE_FLIPBOOKBYLIFE)
{
float l9_1073=mix(l9_1070,l9_1071,l9_866);
l9_1072/=l9_1073;
}
float l9_1074=floor((N2_flipBookRandomStart+1.0)*l9_865);
float2 l9_1075=l9_1067;
float2 l9_1076=N2_gridSize;
float l9_1077=N2_numValidFrames;
float l9_1078=l9_1074;
float l9_1079=N2_flipBookSpeedMult;
float l9_1080=l9_1072;
float l9_1081=floor(l9_1076.x);
float l9_1082=floor(l9_1076.y);
float l9_1083=1.0/l9_1081;
float l9_1084=1.0/l9_1082;
float l9_1085=fast::min(l9_1081*l9_1082,floor(l9_1077));
float l9_1086=floor(mod((l9_1080*l9_1079)+floor(l9_1078),l9_1085));
float l9_1087=floor(l9_1086/l9_1081);
float l9_1088=mod(l9_1086,l9_1081);
float2 l9_1089=float2((l9_1083*l9_1075.x)+(l9_1088*l9_1083),((1.0-l9_1084)-(l9_1087*l9_1084))+(l9_1084*l9_1075.y));
l9_1067=l9_1089;
float2 l9_1090=l9_1067;
...
int l9_1097=l9_1092;
int l9_1098=mainTextureLayout_tmp;
int l9_1099=l9_1097;
float2 l9_1100=l9_1090;
bool l9_1101=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 l9_1102=(*sc_set0.UserUniforms).mainTextureTransform;
int2 l9_1103=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool l9_1104=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 l9_1105=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool l9_1106=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 l9_1107=(*sc_set0.UserUniforms).mainTextureBorderColor;
float l9_1108=0.0;
bool l9_1109=l9_1106&&(!l9_1104);
float l9_1110=1.0;
float l9_1111=l9_1100.x;
int l9_1112=l9_1103.x;
if (l9_1112==1)
{
l9_1111=fract(l9_1111);
}
else
{
if (l9_1112==2)
{
float l9_1113=fract(l9_1111);
float l9_1114=l9_1111-l9_1113;
float l9_1115=step(0.25,fract(l9_1114*0.5));
l9_1111=mix(l9_1113,1.0-l9_1113,fast::clamp(l9_1115,0.0,1.0));
}
}
l9_1100.x=l9_1111;
float l9_1116=l9_1100.y;
int l9_1117=l9_1103.y;
if (l9_1117==1)
{
l9_1116=fract(l9_1116);
}
else
{
if (l9_1117==2)
{
float l9_1118=fract(l9_1116);
float l9_1119=l9_1116-l9_1118;
float l9_1120=step(0.25,fract(l9_1119*0.5));
l9_1116=mix(l9_1118,1.0-l9_1118,fast::clamp(l9_1120,0.0,1.0));
}
}
l9_1100.y=l9_1116;
if (l9_1104)
{
bool l9_1121=l9_1106;
bool l9_1122;
if (l9_1121)
{
l9_1122=l9_1103.x==3;
...
float l9_1123=l9_1100.x;
float l9_1124=l9_1105.x;
float l9_1125=l9_1105.z;
bool l9_1126=l9_1122;
float l9_1127=l9_1110;
...
float l9_1132=l9_1100.y;
float l9_1133=l9_1105.y;
float l9_1134=l9_1105.w;
bool l9_1135=l9_1131;
float l9_1136=l9_1110;
float l9_1137=fast::clamp(l9_1132,l9_1133,l9_1134);
float l9_1138=step(abs(l9_1132-l9_1137),9.9999997e-06);
l9_1136*=(l9_1138+((1.0-float(l9_1135))*(1.0-l9_1138)));
l9_1132=l9_1137;
l9_1100.y=l9_1132;
l9_1110=l9_1136;
}
float2 l9_1139=l9_1100;
bool l9_1140=l9_1101;
float3x3 l9_1141=l9_1102;
if (l9_1140)
{
l9_1139=float2((l9_1141*float3(l9_1139,1.0)).xy);
}
float2 l9_1142=l9_1139;
l9_1100=l9_1142;
float l9_1143=l9_1100.x;
int l9_1144=l9_1103.x;
bool l9_1145=l9_1109;
float l9_1146=l9_1110;
...
l9_1100.x=l9_1143;
l9_1110=l9_1146;
float l9_1154=l9_1100.y;
int l9_1155=l9_1103.y;
bool l9_1156=l9_1109;
float l9_1157=l9_1110;
if ((l9_1155==0)||(l9_1155==3))
{
float l9_1158=l9_1154;
float l9_1159=0.0;
float l9_1160=1.0;
bool l9_1161=l9_1156;
...
l9_1100.y=l9_1154;
l9_1110=l9_1157;
float2 l9_1165=l9_1100;
int l9_1166=l9_1098;
int l9_1167=l9_1099;
float l9_1168=l9_1108;
float2 l9_1169=l9_1165;
int l9_1170=l9_1166;
int l9_1171=l9_1167;
float3 l9_1172=float3(0.0);
if (l9_1170==0)
{
l9_1172=float3(l9_1169,0.0);
}
else
{
if (l9_1170==1)
{
l9_1172=float3(l9_1169.x,(l9_1169.y*0.5)+(0.5-(float(l9_1171)*0.5)),0.0);
}
else
{
l9_1172=float3(l9_1169,float(l9_1171));
}
}
float3 l9_1173=l9_1172;
float3 l9_1174=l9_1173;
float4 l9_1175=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_1174.xy,bias(l9_1168));
float4 l9_1176=l9_1175;
if (l9_1106)
{
l9_1176=mix(l9_1107,l9_1176,float4(l9_1110));
}
float4 l9_1177=l9_1176;
l9_1091=l9_1177;
float4 l9_1178=l9_1091;
l9_1066=l9_1178;
if (N2_ENABLE_FLIPBOOKBLEND)
{
float2 l9_1179=l9_1069;
float2 l9_1180=N2_gridSize;
float l9_1181=N2_numValidFrames;
float l9_1182=floor(mod(l9_1074+1.0,N2_numValidFrames));
float l9_1183=N2_flipBookSpeedMult;
float l9_1184=l9_1072;
float l9_1185=floor(l9_1180.x);
float l9_1186=floor(l9_1180.y);
float l9_1187=1.0/l9_1185;
float l9_1188=1.0/l9_1186;
float l9_1189=fast::min(l9_1185*l9_1186,floor(l9_1181));
float l9_1190=floor(mod((l9_1184*l9_1183)+floor(l9_1182),l9_1189));
float l9_1191=floor(l9_1190/l9_1185);
float l9_1192=mod(l9_1190,l9_1185);
float2 l9_1193=float2((l9_1187*l9_1179.x)+(l9_1192*l9_1187),((1.0-l9_1188)-(l9_1191*l9_1188))+(l9_1188*l9_1179.y));
l9_1069=l9_1193;
float4 l9_1194=l9_1066;
float2 l9_1195=l9_1069;
float4 l9_1196=float4(0.0);
int l9_1197;
if ((int(mainTextureHasSwappedViews_tmp)!=0))
{
int l9_1198=0;
...
int l9_1202=l9_1197;
int l9_1203=mainTextureLayout_tmp;
int l9_1204=l9_1202;
float2 l9_1205=l9_1195;
bool l9_1206=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 l9_1207=(*sc_set0.UserUniforms).mainTextureTransform;
int2 l9_1208=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool l9_1209=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 l9_1210=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool l9_1211=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 l9_1212=(*sc_set0.UserUniforms).mainTextureBorderColor;
float l9_1213=0.0;
bool l9_1214=l9_1211&&(!l9_1209);
float l9_1215=1.0;
float l9_1216=l9_1205.x;
int l9_1217=l9_1208.x;
if (l9_1217==1)
{
l9_1216=fract(l9_1216);
}
else
{
if (l9_1217==2)
{
float l9_1218=fract(l9_1216);
float l9_1219=l9_1216-l9_1218;
float l9_1220=step(0.25,fract(l9_1219*0.5));
l9_1216=mix(l9_1218,1.0-l9_1218,fast::clamp(l9_1220,0.0,1.0));
}
}
l9_1205.x=l9_1216;
float l9_1221=l9_1205.y;
int l9_1222=l9_1208.y;
if (l9_1222==1)
{
l9_1221=fract(l9_1221);
}
else
{
if (l9_1222==2)
{
float l9_1223=fract(l9_1221);
float l9_1224=l9_1221-l9_1223;
float l9_1225=step(0.25,fract(l9_1224*0.5));
l9_1221=mix(l9_1223,1.0-l9_1223,fast::clamp(l9_1225,0.0,1.0));
}
}
l9_1205.y=l9_1221;
if (l9_1209)
{
bool l9_1226=l9_1211;
bool l9_1227;
if (l9_1226)
{
l9_1227=l9_1208.x==3;
...
float l9_1228=l9_1205.x;
float l9_1229=l9_1210.x;
float l9_1230=l9_1210.z;
bool l9_1231=l9_1227;
float l9_1232=l9_1215;
...
float l9_1237=l9_1205.y;
float l9_1238=l9_1210.y;
float l9_1239=l9_1210.w;
bool l9_1240=l9_1236;
float l9_1241=l9_1215;
...
float2 l9_1244=l9_1205;
bool l9_1245=l9_1206;
float3x3 l9_1246=l9_1207;
if (l9_1245)
{
l9_1244=float2((l9_1246*float3(l9_1244,1.0)).xy);
}
float2 l9_1247=l9_1244;
l9_1205=l9_1247;
float l9_1248=l9_1205.x;
int l9_1249=l9_1208.x;
bool l9_1250=l9_1214;
float l9_1251=l9_1215;
...
l9_1205.x=l9_1248;
l9_1215=l9_1251;
float l9_1259=l9_1205.y;
int l9_1260=l9_1208.y;
bool l9_1261=l9_1214;
float l9_1262=l9_1215;
...
l9_1205.y=l9_1259;
l9_1215=l9_1262;
float2 l9_1270=l9_1205;
int l9_1271=l9_1203;
int l9_1272=l9_1204;
float l9_1273=l9_1213;
float2 l9_1274=l9_1270;
int l9_1275=l9_1271;
int l9_1276=l9_1272;
float3 l9_1277=float3(0.0);
if (l9_1275==0)
{
l9_1277=float3(l9_1274,0.0);
}
else
{
if (l9_1275==1)
{
l9_1277=float3(l9_1274.x,(l9_1274.y*0.5)+(0.5-(float(l9_1276)*0.5)),0.0);
}
else
{
l9_1277=float3(l9_1274,float(l9_1276));
}
}
float3 l9_1278=l9_1277;
float3 l9_1279=l9_1278;
float4 l9_1280=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_1279.xy,bias(l9_1273));
float4 l9_1281=l9_1280;
if (l9_1211)
{
l9_1281=mix(l9_1212,l9_1281,float4(l9_1215));
}
float4 l9_1282=l9_1281;
l9_1196=l9_1282;
float4 l9_1283=l9_1196;
l9_1066=mix(l9_1194,l9_1283,float4(fract((l9_1072*N2_flipBookSpeedMult)+l9_1074)));
}
}
}
float4 l9_1284=float4(1.0);
if (N2_ENABLE_COLORRAMP)
{
float l9_1285=ceil(l9_859*N2_texSize.x)/N2_texSize.x;
float l9_1286=l9_1285;
if (N2_ENABLE_NORANDOFFSET)
{
float2 l9_1287=tempGlobals.Surface_UVCoord0;
l9_1286+=(l9_1287.x/N2_texSize.x);
}
float2 l9_1288=float2(l9_1286,0.5);
...
int l9_1295=l9_1290;
int l9_1296=colorRampTextureLayout_tmp;
int l9_1297=l9_1295;
float2 l9_1298=l9_1288;
bool l9_1299=(int(SC_USE_UV_TRANSFORM_colorRampTexture_tmp)!=0);
float3x3 l9_1300=(*sc_set0.UserUniforms).colorRampTextureTransform;
int2 l9_1301=int2(SC_SOFTWARE_WRAP_MODE_U_colorRampTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_colorRampTexture_tmp);
bool l9_1302=(int(SC_USE_UV_MIN_MAX_colorRampTexture_tmp)!=0);
float4 l9_1303=(*sc_set0.UserUniforms).colorRampTextureUvMinMax;
bool l9_1304=(int(SC_USE_CLAMP_TO_BORDER_colorRampTexture_tmp)!=0);
float4 l9_1305=(*sc_set0.UserUniforms).colorRampTextureBorderColor;
float l9_1306=0.0;
...
float4 l9_1373=sc_set0.colorRampTexture.sample(sc_set0.colorRampTextureSmpSC,l9_1372.xy,bias(l9_1366));
...
l9_1289=l9_1375;
float4 l9_1376=l9_1289;
l9_1284=l9_1376*N2_colorRampMult;
}
float4 l9_1377=float4(1.0);
float4 l9_1378=float4(1.0);
if (N2_ENABLE_BASETEXTURE)
{
if (N2_ENABLE_FLIPBOOK)
{
...
{
float2 l9_1379=N2_uv;
float4 l9_1380=float4(0.0);
int l9_1381;
if ((int(mainTextureHasSwappedViews_tmp)!=0))
{
int l9_1382=0;
...
int l9_1386=l9_1381;
int l9_1387=mainTextureLayout_tmp;
int l9_1388=l9_1386;
float2 l9_1389=l9_1379;
bool l9_1390=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 l9_1391=(*sc_set0.UserUniforms).mainTextureTransform;
int2 l9_1392=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool l9_1393=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 l9_1394=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool l9_1395=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 l9_1396=(*sc_set0.UserUniforms).mainTextureBorderColor;
float l9_1397=0.0;
bool l9_1398=l9_1395&&(!l9_1393);
float l9_1399=1.0;
float l9_1400=l9_1389.x;
int l9_1401=l9_1392.x;
if (l9_1401==1)
{
l9_1400=fract(l9_1400);
}
else
{
if (l9_1401==2)
{
float l9_1402=fract(l9_1400);
float l9_1403=l9_1400-l9_1402;
float l9_1404=step(0.25,fract(l9_1403*0.5));
l9_1400=mix(l9_1402,1.0-l9_1402,fast::clamp(l9_1404,0.0,1.0));
}
}
l9_1389.x=l9_1400;
float l9_1405=l9_1389.y;
int l9_1406=l9_1392.y;
if (l9_1406==1)
{
l9_1405=fract(l9_1405);
}
else
{
if (l9_1406==2)
{
float l9_1407=fract(l9_1405);
float l9_1408=l9_1405-l9_1407;
float l9_1409=step(0.25,fract(l9_1408*0.5));
l9_1405=mix(l9_1407,1.0-l9_1407,fast::clamp(l9_1409,0.0,1.0));
}
}
l9_1389.y=l9_1405;
if (l9_1393)
{
bool l9_1410=l9_1395;
bool l9_1411;
if (l9_1410)
{
l9_1411=l9_1392.x==3;
...
float l9_1412=l9_1389.x;
float l9_1413=l9_1394.x;
float l9_1414=l9_1394.z;
bool l9_1415=l9_1411;
float l9_1416=l9_1399;
...
float l9_1421=l9_1389.y;
float l9_1422=l9_1394.y;
float l9_1423=l9_1394.w;
bool l9_1424=l9_1420;
float l9_1425=l9_1399;
...
float2 l9_1428=l9_1389;
bool l9_1429=l9_1390;
float3x3 l9_1430=l9_1391;
if (l9_1429)
{
l9_1428=float2((l9_1430*float3(l9_1428,1.0)).xy);
}
float2 l9_1431=l9_1428;
l9_1389=l9_1431;
float l9_1432=l9_1389.x;
int l9_1433=l9_1392.x;
bool l9_1434=l9_1398;
float l9_1435=l9_1399;
...
l9_1389.x=l9_1432;
l9_1399=l9_1435;
float l9_1443=l9_1389.y;
int l9_1444=l9_1392.y;
bool l9_1445=l9_1398;
float l9_1446=l9_1399;
if ((l9_1444==0)||(l9_1444==3))
{
float l9_1447=l9_1443;
float l9_1448=0.0;
float l9_1449=1.0;
bool l9_1450=l9_1445;
float l9_1451=l9_1446;
...
l9_1389.y=l9_1443;
l9_1399=l9_1446;
float2 l9_1454=l9_1389;
int l9_1455=l9_1387;
int l9_1456=l9_1388;
float l9_1457=l9_1397;
float2 l9_1458=l9_1454;
int l9_1459=l9_1455;
int l9_1460=l9_1456;
float3 l9_1461=float3(0.0);
if (l9_1459==0)
{
l9_1461=float3(l9_1458,0.0);
}
else
{
if (l9_1459==1)
{
l9_1461=float3(l9_1458.x,(l9_1458.y*0.5)+(0.5-(float(l9_1460)*0.5)),0.0);
}
else
{
l9_1461=float3(l9_1458,float(l9_1460));
}
}
float3 l9_1462=l9_1461;
float3 l9_1463=l9_1462;
float4 l9_1464=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_1463.xy,bias(l9_1457));
float4 l9_1465=l9_1464;
if (l9_1395)
{
l9_1465=mix(l9_1396,l9_1465,float4(l9_1399));
}
float4 l9_1466=l9_1465;
l9_1380=l9_1466;
float4 l9_1467=l9_1380;
l9_1377=l9_1467;
}
}
if (N2_ENABLE_COLORRAMP)
...
N2_result=(l9_1377*l9_1061)*l9_1378;
if (N2_ENABLE_TRAILS)
{
if (N2_isTrail>0.0)
{
N2_result=(l9_868*l9_1061)*l9_1378;
N2_result.w*=l9_867;
}
}
if (N2_ENABLE_SCREENFADE)
...
if (N2_ENABLE_ALPHADISSOLVE)
{
float l9_1468=l9_859*N2_alphaDissolveMult;
N2_result.w=fast::clamp(N2_result.w-l9_1468,0.0,1.0);
}
if (N2_ENABLE_BLACKASALPHA)
{
float l9_1469=length(N2_result.xyz);
N2_result.w=l9_1469;
if (N2_ENABLE_TRAILS)
{
N2_result.w*=l9_867;
...
if (N2_ENABLE_PREMULTIPLIEDCOLOR)
{
float3 l9_1470=N2_result.xyz*N2_result.w;
N2_result=float4(l9_1470.x,l9_1470.y,l9_1470.z,N2_result.w);
}
l9_833=N2_uv;
l9_807=l9_833;
float4 l9_1471=float4(0.0);
float2 l9_1472=l9_807;
int l9_1473;
...
{
l9_1476=in.varStereoViewID;
}
int l9_1477=l9_1476;
l9_1473=l9_1477;
}
int l9_1478=l9_1473;
int l9_1479=normalTexLayout_tmp;
int l9_1480=l9_1478;
float2 l9_1481=l9_1472;
bool l9_1482=(int(SC_USE_UV_TRANSFORM_normalTex_tmp)!=0);
float3x3 l9_1483=(*sc_set0.UserUniforms).normalTexTransform;
int2 l9_1484=int2(SC_SOFTWARE_WRAP_MODE_U_normalTex_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTex_tmp);
bool l9_1485=(int(SC_USE_UV_MIN_MAX_normalTex_tmp)!=0);
float4 l9_1486=(*sc_set0.UserUniforms).normalTexUvMinMax;
bool l9_1487=(int(SC_USE_CLAMP_TO_BORDER_normalTex_tmp)!=0);
float4 l9_1488=(*sc_set0.UserUniforms).normalTexBorderColor;
float l9_1489=0.0;
bool l9_1490=l9_1487&&(!l9_1485);
float l9_1491=1.0;
float l9_1492=l9_1481.x;
int l9_1493=l9_1484.x;
if (l9_1493==1)
{
...
l9_1481.x=l9_1492;
float l9_1497=l9_1481.y;
int l9_1498=l9_1484.y;
if (l9_1498==1)
{
...
float l9_1504=l9_1481.x;
float l9_1505=l9_1486.x;
float l9_1506=l9_1486.z;
...
float l9_1513=l9_1481.y;
float l9_1514=l9_1486.y;
float l9_1515=l9_1486.w;
...
float2 l9_1520=l9_1481;
bool l9_1521=l9_1482;
float3x3 l9_1522=l9_1483;
if (l9_1521)
{
...
l9_1481=l9_1523;
float l9_1524=l9_1481.x;
int l9_1525=l9_1484.x;
bool l9_1526=l9_1490;
float l9_1527=l9_1491;
...
l9_1481.x=l9_1524;
l9_1491=l9_1527;
float l9_1535=l9_1481.y;
int l9_1536=l9_1484.y;
bool l9_1537=l9_1490;
float l9_1538=l9_1491;
...
l9_1481.y=l9_1535;
l9_1491=l9_1538;
float2 l9_1546=l9_1481;
int l9_1547=l9_1479;
int l9_1548=l9_1480;
float l9_1549=l9_1489;
...
float4 l9_1556=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_1555.xy,bias(l9_1549));
float4 l9_1557=l9_1556;
if (l9_1487)
{
l9_1557=mix(l9_1488,l9_1557,float4(l9_1491));
}
float4 l9_1558=l9_1557;
float4 l9_1559=l9_1558;
float3 l9_1560=(l9_1559.xyz*1.9921875)-float3(1.0);
l9_1559=float4(l9_1560.x,l9_1560.y,l9_1560.z,l9_1559.w);
l9_1471=l9_1559;
l9_742=l9_1471.xyz;
l9_745=l9_742;
}
...
l9_741=l9_745;
float l9_1561=0.0;
float l9_1562=(*sc_set0.UserUniforms).metallic;
l9_1561=l9_1562;
float l9_1563=0.0;
float l9_1564=(*sc_set0.UserUniforms).roughness;
l9_1563=l9_1564;
float4 l9_1565=float4(0.0);
float3 l9_1566=l9_731.xyz;
float l9_1567=l9_738;
float3 l9_1568=l9_741;
float3 l9_1569=(*sc_set0.UserUniforms).Port_Emissive_N014;
float l9_1570=l9_1561;
float l9_1571=l9_1563;
float3 l9_1572=(*sc_set0.UserUniforms).Port_AO_N014;
float3 l9_1573=(*sc_set0.UserUniforms).Port_SpecularAO_N014;
ssGlobals l9_1574=param_3;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1574.BumpedNormal=float3x3(float3(l9_1574.VertexTangent_WorldSpace),float3(l9_1574.VertexBinormal_WorldSpace),float3(l9_1574.VertexNormal_WorldSpace))*l9_1568;
}
l9_1567=fast::clamp(l9_1567,0.0,1.0);
float l9_1575=l9_1567;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_1575<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_1576=gl_FragCoord;
float2 l9_1577=floor(mod(l9_1576.xy,float2(4.0)));
float l9_1578=(mod(dot(l9_1577,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_1575<l9_1578)
{
discard_fragment();
}
}
l9_1566=fast::max(l9_1566,float3(0.0));
float4 l9_1579;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
l9_1579=float4(l9_1566,l9_1567);
}
else
{
l9_1570=fast::clamp(l9_1570,0.0,1.0);
l9_1571=fast::clamp(l9_1571,0.0,1.0);
float3 l9_1580=l9_1566;
float l9_1581=l9_1567;
float3 l9_1582=l9_1574.BumpedNormal;
float3 l9_1583=l9_1574.PositionWS;
float3 l9_1584=l9_1574.ViewDirWS;
float3 l9_1585=l9_1569;
float l9_1586=l9_1570;
float l9_1587=l9_1571;
float3 l9_1588=l9_1572;
float3 l9_1589=l9_1573;
SurfaceProperties l9_1590;
l9_1590.albedo=float3(0.0);
l9_1590.opacity=1.0;
l9_1590.normal=float3(0.0);
l9_1590.positionWS=float3(0.0);
l9_1590.viewDirWS=float3(0.0);
l9_1590.metallic=0.0;
l9_1590.roughness=0.0;
l9_1590.emissive=float3(0.0);
l9_1590.ao=float3(1.0);
l9_1590.specularAo=float3(1.0);
l9_1590.bakedShadows=float3(1.0);
SurfaceProperties l9_1591=l9_1590;
SurfaceProperties l9_1592=l9_1591;
l9_1592.opacity=l9_1581;
float3 l9_1593=l9_1580;
float3 l9_1594;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1594=float3(pow(l9_1593.x,2.2),pow(l9_1593.y,2.2),pow(l9_1593.z,2.2));
}
else
{
l9_1594=l9_1593*l9_1593;
}
float3 l9_1595=l9_1594;
l9_1592.albedo=l9_1595;
l9_1592.normal=normalize(l9_1582);
l9_1592.positionWS=l9_1583;
l9_1592.viewDirWS=l9_1584;
float3 l9_1596=l9_1585;
float3 l9_1597;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_1597=float3(pow(l9_1596.x,2.2),pow(l9_1596.y,2.2),pow(l9_1596.z,2.2));
}
else
{
l9_1597=l9_1596*l9_1596;
}
float3 l9_1598=l9_1597;
l9_1592.emissive=l9_1598;
l9_1592.metallic=l9_1586;
l9_1592.roughness=l9_1587;
l9_1592.ao=l9_1588;
l9_1592.specularAo=l9_1589;
if ((int(sc_SSAOEnabled_tmp)!=0))
{
float3 l9_1599=l9_1592.positionWS;
l9_1592.ao=evaluateSSAO(l9_1599,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.sc_SSAOTexture,sc_set0.sc_SSAOTextureSmpSC);
}
SurfaceProperties l9_1600=l9_1592;
SurfaceProperties l9_1601=l9_1600;
float3 l9_1602=mix(float3(0.039999999),l9_1601.albedo*l9_1601.metallic,float3(l9_1601.metallic));
float3 l9_1603=mix(l9_1601.albedo*(1.0-l9_1601.metallic),float3(0.0),float3(l9_1601.metallic));
l9_1600.albedo=l9_1603;
l9_1600.specColor=l9_1602;
SurfaceProperties l9_1604=l9_1600;
l9_1592=l9_1604;
SurfaceProperties l9_1605=l9_1592;
LightingComponents l9_1606;
l9_1606.directDiffuse=float3(0.0);
l9_1606.directSpecular=float3(0.0);
l9_1606.indirectDiffuse=float3(1.0);
l9_1606.indirectSpecular=float3(0.0);
l9_1606.emitted=float3(0.0);
l9_1606.transmitted=float3(0.0);
LightingComponents l9_1607=l9_1606;
LightingComponents l9_1608=l9_1607;
float3 l9_1609=l9_1605.viewDirWS;
int l9_1610=0;
float4 l9_1611=float4(l9_1605.bakedShadows,1.0);
if (sc_DirectionalLightsCount_tmp>0)
{
sc_DirectionalLight_t l9_1612;
LightProperties l9_1613;
int l9_1614=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_1614<sc_DirectionalLightsCount_tmp)
{
l9_1612.direction=(*sc_set0.UserUniforms).sc_DirectionalLights[l9_1614].direction;
l9_1612.color=(*sc_set0.UserUniforms).sc_DirectionalLights[l9_1614].color;
l9_1613.direction=l9_1612.direction;
l9_1613.color=l9_1612.color.xyz;
l9_1613.attenuation=l9_1612.color.w;
l9_1613.attenuation*=l9_1611[(l9_1610<3) ? l9_1610 : 3];
l9_1610++;
LightingComponents l9_1615=l9_1608;
LightProperties l9_1616=l9_1613;
SurfaceProperties l9_1617=l9_1605;
float3 l9_1618=l9_1609;
SurfaceProperties l9_1619=l9_1617;
float3 l9_1620=l9_1616.direction;
float l9_1621=dot(l9_1619.normal,l9_1620);
float l9_1622=fast::clamp(l9_1621,0.0,1.0);
float3 l9_1623=float3(l9_1622);
l9_1615.directDiffuse+=((l9_1623*l9_1616.color)*l9_1616.attenuation);
SurfaceProperties l9_1624=l9_1617;
float3 l9_1625=l9_1616.direction;
float3 l9_1626=l9_1618;
l9_1615.directSpecular+=((calculateDirectSpecular(l9_1624,l9_1625,l9_1626)*l9_1616.color)*l9_1616.attenuation);
LightingComponents l9_1627=l9_1615;
l9_1608=l9_1627;
l9_1614++;
continue;
}
...
{
sc_PointLight_t_1 l9_1628;
LightProperties l9_1629;
int l9_1630=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_1630<sc_PointLightsCount_tmp)
{
l9_1628.falloffEnabled=(*sc_set0.UserUniforms).sc_PointLights[l9_1630].falloffEnabled!=0;
l9_1628.falloffEndDistance=(*sc_set0.UserUniforms).sc_PointLights[l9_1630].falloffEndDistance;
l9_1628.negRcpFalloffEndDistance4=(*sc_set0.UserUniforms).sc_PointLights[l9_1630].negRcpFalloffEndDistance4;
l9_1628.angleScale=(*sc_set0.UserUniforms).sc_PointLights[l9_1630].angleScale;
l9_1628.angleOffset=(*sc_set0.UserUniforms).sc_PointLights[l9_1630].angleOffset;
l9_1628.direction=(*sc_set0.UserUniforms).sc_PointLights[l9_1630].direction;
l9_1628.position=(*sc_set0.UserUniforms).sc_PointLights[l9_1630].position;
l9_1628.color=(*sc_set0.UserUniforms).sc_PointLights[l9_1630].color;
float3 l9_1631=l9_1628.position-l9_1605.positionWS;
l9_1629.direction=normalize(l9_1631);
l9_1629.color=l9_1628.color.xyz;
l9_1629.attenuation=l9_1628.color.w;
l9_1629.attenuation*=l9_1611[(l9_1610<3) ? l9_1610 : 3];
float3 l9_1632=l9_1629.direction;
float3 l9_1633=l9_1628.direction;
float l9_1634=l9_1628.angleScale;
float l9_1635=l9_1628.angleOffset;
float l9_1636=dot(l9_1632,l9_1633);
float l9_1637=fast::clamp((l9_1636*l9_1634)+l9_1635,0.0,1.0);
float l9_1638=l9_1637*l9_1637;
l9_1629.attenuation*=l9_1638;
if (l9_1628.falloffEnabled)
{
float l9_1639=length(l9_1631);
float l9_1640=l9_1628.falloffEndDistance;
l9_1629.attenuation*=computeDistanceAttenuation(l9_1639,l9_1640);
}
l9_1610++;
LightingComponents l9_1641=l9_1608;
LightProperties l9_1642=l9_1629;
SurfaceProperties l9_1643=l9_1605;
float3 l9_1644=l9_1609;
SurfaceProperties l9_1645=l9_1643;
float3 l9_1646=l9_1642.direction;
float l9_1647=dot(l9_1645.normal,l9_1646);
float l9_1648=fast::clamp(l9_1647,0.0,1.0);
float3 l9_1649=float3(l9_1648);
l9_1641.directDiffuse+=((l9_1649*l9_1642.color)*l9_1642.attenuation);
SurfaceProperties l9_1650=l9_1643;
float3 l9_1651=l9_1642.direction;
float3 l9_1652=l9_1644;
l9_1641.directSpecular+=((calculateDirectSpecular(l9_1650,l9_1651,l9_1652)*l9_1642.color)*l9_1642.attenuation);
LightingComponents l9_1653=l9_1641;
l9_1608=l9_1653;
l9_1630++;
continue;
}
...
if ((int(sc_ProjectiveShadowsReceiver_tmp)!=0))
{
float2 l9_1655=abs(in.varShadowTex-float2(0.5));
float l9_1656=fast::max(l9_1655.x,l9_1655.y);
float l9_1657=step(l9_1656,0.5);
float4 l9_1658=sc_set0.sc_ShadowTexture.sample(sc_set0.sc_ShadowTextureSmpSC,in.varShadowTex)*l9_1657;
float3 l9_1659=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_1658.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float l9_1660=l9_1658.w*(*sc_set0.UserUniforms).sc_ShadowDensity;
l9_1654=mix(float3(1.0),l9_1659,float3(l9_1660));
}
else
{
l9_1654=float3(1.0);
}
float3 l9_1661=l9_1654;
float3 l9_1662=l9_1661;
l9_1608.directDiffuse*=l9_1662;
l9_1608.directSpecular*=l9_1662;
}
if (((*sc_set0.UserUniforms).sc_RayTracingReceiverEffectsMask&4)!=0)
{
float4 l9_1663=gl_FragCoord;
float2 l9_1664=l9_1663.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
{
l9_1671=in.varStereoViewID;
}
int l9_1672=l9_1671;
l9_1668=l9_1672;
}
int l9_1673=l9_1668;
float2 l9_1674=l9_1666;
int l9_1675=sc_RayTracingShadowsLayout_tmp;
int l9_1676=l9_1673;
float l9_1677=l9_1667;
float2 l9_1678=l9_1674;
int l9_1679=l9_1675;
int l9_1680=l9_1676;
float3 l9_1681=float3(0.0);
if (l9_1679==0)
{
l9_1681=float3(l9_1678,0.0);
}
else
{
if (l9_1679==1)
{
l9_1681=float3(l9_1678.x,(l9_1678.y*0.5)+(0.5-(float(l9_1680)*0.5)),0.0);
}
else
{
l9_1681=float3(l9_1678,float(l9_1680));
}
}
float3 l9_1682=l9_1681;
float3 l9_1683=l9_1682;
float4 l9_1684=sc_set0.sc_RayTracingShadows.sample(sc_set0.sc_RayTracingShadowsSmpSC,l9_1683.xy,bias(l9_1677));
float4 l9_1685=l9_1684;
float4 l9_1686=l9_1685;
float l9_1687=l9_1686.x;
float l9_1688=1.0-l9_1687;
l9_1608.directDiffuse*=l9_1688;
l9_1608.directSpecular*=l9_1688;
}
SurfaceProperties l9_1689=l9_1605;
float3 l9_1690=l9_1689.normal;
float3 l9_1691=float3(0.0);
if ((sc_EnvLightMode_tmp==sc_AmbientLightMode_EnvironmentMap_tmp)||(sc_EnvLightMode_tmp==sc_AmbientLightMode_FromCamera_tmp))
{
float3 l9_1692=l9_1690;
float3 l9_1693=l9_1692;
float l9_1694=(*sc_set0.UserUniforms).sc_EnvmapRotation.y;
float2 l9_1695=float2(0.0);
float l9_1696=l9_1693.x;
float l9_1697=-l9_1693.z;
float l9_1698=(l9_1696<0.0) ? (-1.0) : 1.0;
float l9_1699=l9_1698*acos(fast::clamp(l9_1697/length(float2(l9_1696,l9_1697)),-1.0,1.0));
l9_1695.x=l9_1699-1.5707964;
l9_1695.y=acos(l9_1693.y);
l9_1695/=float2(6.2831855,3.1415927);
l9_1695.y=1.0-l9_1695.y;
l9_1695.x+=(l9_1694/360.0);
l9_1695.x=fract((l9_1695.x+floor(l9_1695.x))+1.0);
float2 l9_1700=l9_1695;
float2 l9_1701=l9_1700;
float4 l9_1702=float4(0.0);
if (sc_EnvLightMode_tmp==sc_AmbientLightMode_FromCamera_tmp)
{
if (SC_DEVICE_CLASS_tmp>=2)
{
float2 l9_1703=l9_1701;
float2 l9_1704=(*sc_set0.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_1705=5.0;
l9_1701=calcSeamlessPanoramicUvsForSampling(l9_1703,l9_1704,l9_1705);
}
float2 l9_1706=l9_1701;
float l9_1707=13.0;
int l9_1708;
...
int l9_1715=sc_EnvmapSpecularLayout_tmp;
int l9_1716=l9_1713;
...
float4 l9_1724=sc_set0.sc_EnvmapSpecular.sample(sc_set0.sc_EnvmapSpecularSmpSC,l9_1723.xy,bias(l9_1717));
...
{
float2 l9_1726=l9_1701;
float2 l9_1727=(*sc_set0.UserUniforms).sc_EnvmapDiffuseSize.xy;
float l9_1728=0.0;
l9_1701=calcSeamlessPanoramicUvsForSampling(l9_1726,l9_1727,l9_1728);
float2 l9_1729=l9_1701;
float l9_1730=-13.0;
int l9_1731;
...
{
l9_1734=in.varStereoViewID;
}
int l9_1735=l9_1734;
l9_1731=l9_1735;
}
int l9_1736=l9_1731;
float2 l9_1737=l9_1729;
int l9_1738=sc_EnvmapDiffuseLayout_tmp;
int l9_1739=l9_1736;
float l9_1740=l9_1730;
float2 l9_1741=l9_1737;
int l9_1742=l9_1738;
int l9_1743=l9_1739;
float3 l9_1744=float3(0.0);
if (l9_1742==0)
{
l9_1744=float3(l9_1741,0.0);
}
else
{
if (l9_1742==1)
{
l9_1744=float3(l9_1741.x,(l9_1741.y*0.5)+(0.5-(float(l9_1743)*0.5)),0.0);
}
else
{
l9_1744=float3(l9_1741,float(l9_1743));
}
}
float3 l9_1745=l9_1744;
float3 l9_1746=l9_1745;
float4 l9_1747=sc_set0.sc_EnvmapDiffuse.sample(sc_set0.sc_EnvmapDiffuseSmpSC,l9_1746.xy,bias(l9_1740));
float4 l9_1748=l9_1747;
l9_1702=l9_1748;
}
else
{
float2 l9_1749=l9_1701;
float l9_1750=13.0;
int l9_1751;
if ((int(sc_EnvmapSpecularHasSwappedViews_tmp)!=0))
{
...
int l9_1756=l9_1751;
float2 l9_1757=l9_1749;
int l9_1758=sc_EnvmapSpecularLayout_tmp;
int l9_1759=l9_1756;
float l9_1760=l9_1750;
...
float4 l9_1767=sc_set0.sc_EnvmapSpecular.sample(sc_set0.sc_EnvmapSpecularSmpSC,l9_1766.xy,bias(l9_1760));
float4 l9_1768=l9_1767;
l9_1702=l9_1768;
}
}
float4 l9_1769=l9_1702;
float3 l9_1770=l9_1769.xyz*(1.0/l9_1769.w);
float3 l9_1771=l9_1770*(*sc_set0.UserUniforms).sc_EnvmapExposure;
l9_1691=l9_1771;
}
else
{
...
{
float3 l9_1772=(*sc_set0.UserUniforms).sc_Sh[0];
float3 l9_1773=(*sc_set0.UserUniforms).sc_Sh[1];
float3 l9_1774=(*sc_set0.UserUniforms).sc_Sh[2];
float3 l9_1775=(*sc_set0.UserUniforms).sc_Sh[3];
float3 l9_1776=(*sc_set0.UserUniforms).sc_Sh[4];
float3 l9_1777=(*sc_set0.UserUniforms).sc_Sh[5];
float3 l9_1778=(*sc_set0.UserUniforms).sc_Sh[6];
float3 l9_1779=(*sc_set0.UserUniforms).sc_Sh[7];
float3 l9_1780=(*sc_set0.UserUniforms).sc_Sh[8];
float3 l9_1781=-l9_1690;
float l9_1782=0.0;
l9_1782=l9_1781.x;
float l9_1783=l9_1781.y;
float l9_1784=l9_1781.z;
float l9_1785=l9_1782*l9_1782;
float l9_1786=l9_1783*l9_1783;
float l9_1787=l9_1784*l9_1784;
float l9_1788=l9_1782*l9_1783;
float l9_1789=l9_1783*l9_1784;
float l9_1790=l9_1782*l9_1784;
float3 l9_1791=((((((l9_1780*0.42904299)*(l9_1785-l9_1786))+((l9_1778*0.74312502)*l9_1787))+(l9_1772*0.88622701))-(l9_1778*0.24770799))+((((l9_1776*l9_1788)+(l9_1779*l9_1790))+(l9_1777*l9_1789))*0.85808599))+((((l9_1775*l9_1782)+(l9_1773*l9_1783))+(l9_1774*l9_1784))*1.0233279);
l9_1691=l9_1791*(*sc_set0.UserUniforms).sc_ShIntensity;
}
}
if (((*sc_set0.UserUniforms).sc_RayTracingReceiverEffectsMask&2)!=0)
{
float4 l9_1792=gl_FragCoord;
float2 l9_1793=l9_1792.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_1794=l9_1793;
...
int l9_1802=l9_1797;
float2 l9_1803=l9_1795;
int l9_1804=sc_RayTracingGlobalIlluminationLayout_tmp;
int l9_1805=l9_1802;
float l9_1806=l9_1796;
float2 l9_1807=l9_1803;
int l9_1808=l9_1804;
int l9_1809=l9_1805;
float3 l9_1810=float3(0.0);
if (l9_1808==0)
{
l9_1810=float3(l9_1807,0.0);
}
else
{
if (l9_1808==1)
{
l9_1810=float3(l9_1807.x,(l9_1807.y*0.5)+(0.5-(float(l9_1809)*0.5)),0.0);
}
else
{
l9_1810=float3(l9_1807,float(l9_1809));
}
}
float3 l9_1811=l9_1810;
float3 l9_1812=l9_1811;
float4 l9_1813=sc_set0.sc_RayTracingGlobalIllumination.sample(sc_set0.sc_RayTracingGlobalIlluminationSmpSC,l9_1812.xy,bias(l9_1806));
float4 l9_1814=l9_1813;
float4 l9_1815=l9_1814;
float4 l9_1816=l9_1815;
l9_1691=mix(l9_1691,l9_1816.xyz,float3(l9_1816.w));
}
if (sc_AmbientLightsCount_tmp>0)
{
if (sc_AmbientLightMode0_tmp==sc_AmbientLightMode_Constant_tmp)
{
l9_1691+=((*sc_set0.UserUniforms).sc_AmbientLights[0].color*(*sc_set0.UserUniforms).sc_AmbientLights[0].intensity);
}
else
{
l9_1691.x+=(1e-06*(*sc_set0.UserUniforms).sc_AmbientLights[0].color.x);
}
}
...
{
l9_1691+=((*sc_set0.UserUniforms).sc_AmbientLights[1].color*(*sc_set0.UserUniforms).sc_AmbientLights[1].intensity);
}
else
{
l9_1691.x+=(1e-06*(*sc_set0.UserUniforms).sc_AmbientLights[1].color.x);
}
}
...
{
l9_1691+=((*sc_set0.UserUniforms).sc_AmbientLights[2].color*(*sc_set0.UserUniforms).sc_AmbientLights[2].intensity);
}
else
{
l9_1691.x+=(1e-06*(*sc_set0.UserUniforms).sc_AmbientLights[2].color.x);
}
}
if ((int(sc_LightEstimation_tmp)!=0))
{
float3 l9_1817=l9_1690;
float3 l9_1818=(*sc_set0.UserUniforms).sc_LightEstimationData.ambientLight;
sc_SphericalGaussianLight_t l9_1819;
float l9_1820;
int l9_1821=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_1821<sc_LightEstimationSGCount_tmp)
{
l9_1819.color=(*sc_set0.UserUniforms).sc_LightEstimationData.sg[l9_1821].color;
l9_1819.sharpness=(*sc_set0.UserUniforms).sc_LightEstimationData.sg[l9_1821].sharpness;
l9_1819.axis=(*sc_set0.UserUniforms).sc_LightEstimationData.sg[l9_1821].axis;
float3 l9_1822=l9_1817;
float l9_1823=dot(l9_1819.axis,l9_1822);
float l9_1824=l9_1819.sharpness;
float l9_1825=0.36000001;
float l9_1826=1.0/(4.0*l9_1825);
float l9_1827=exp(-l9_1824);
float l9_1828=l9_1827*l9_1827;
float l9_1829=1.0/l9_1824;
float l9_1830=(1.0+(2.0*l9_1828))-l9_1829;
float l9_1831=((l9_1827-l9_1828)*l9_1829)-l9_1828;
float l9_1832=sqrt(1.0-l9_1830);
float l9_1833=l9_1825*l9_1823;
float l9_1834=l9_1826*l9_1832;
float l9_1835=l9_1833+l9_1834;
float l9_1836=l9_1823;
float l9_1837=fast::clamp(l9_1836,0.0,1.0);
float l9_1838=l9_1837;
if (step(abs(l9_1833),l9_1834)>0.5)
{
l9_1820=(l9_1835*l9_1835)/l9_1832;
}
else
{
l9_1820=l9_1838;
...
l9_1838=l9_1820;
float l9_1839=(l9_1830*l9_1838)+l9_1831;
sc_SphericalGaussianLight_t l9_1840=l9_1819;
float3 l9_1841=(l9_1840.color/float3(l9_1840.sharpness))*6.2831855;
float3 l9_1842=(l9_1841*l9_1839)/float3(3.1415927);
l9_1818+=l9_1842;
l9_1821++;
continue;
}
...
float3 l9_1843=l9_1818;
l9_1691+=l9_1843;
}
float3 l9_1844=l9_1691;
float3 l9_1845=l9_1844;
l9_1608.indirectDiffuse=l9_1845;
SurfaceProperties l9_1846=l9_1605;
float3 l9_1847=l9_1609;
float3 l9_1848=float3(0.0);
if ((sc_EnvLightMode_tmp==sc_AmbientLightMode_EnvironmentMap_tmp)||(sc_EnvLightMode_tmp==sc_AmbientLightMode_FromCamera_tmp))
{
SurfaceProperties l9_1849=l9_1846;
float3 l9_1850=l9_1847;
float3 l9_1851=l9_1849.normal;
float3 l9_1852=reflect(-l9_1850,l9_1851);
float3 l9_1853=l9_1851;
float3 l9_1854=l9_1852;
float l9_1855=l9_1849.roughness;
l9_1852=getSpecularDominantDir(l9_1853,l9_1854,l9_1855);
float l9_1856=l9_1849.roughness;
float l9_1857=pow(l9_1856,0.66666669);
float l9_1858=fast::clamp(l9_1857,0.0,1.0);
float l9_1859=l9_1858*5.0;
float l9_1860=l9_1859;
float l9_1861=l9_1860;
float3 l9_1862=l9_1852;
float l9_1863=l9_1861;
float3 l9_1864=l9_1862;
float l9_1865=l9_1863;
float4 l9_1866=float4(0.0);
float3 l9_1867=l9_1864;
float l9_1868=(*sc_set0.UserUniforms).sc_EnvmapRotation.y;
float2 l9_1869=float2(0.0);
float l9_1870=l9_1867.x;
float l9_1871=-l9_1867.z;
float l9_1872=(l9_1870<0.0) ? (-1.0) : 1.0;
float l9_1873=l9_1872*acos(fast::clamp(l9_1871/length(float2(l9_1870,l9_1871)),-1.0,1.0));
l9_1869.x=l9_1873-1.5707964;
l9_1869.y=acos(l9_1867.y);
l9_1869/=float2(6.2831855,3.1415927);
l9_1869.y=1.0-l9_1869.y;
l9_1869.x+=(l9_1868/360.0);
l9_1869.x=fract((l9_1869.x+floor(l9_1869.x))+1.0);
float2 l9_1874=l9_1869;
float2 l9_1875=l9_1874;
if (SC_DEVICE_CLASS_tmp>=2)
{
float l9_1876=floor(l9_1865);
float l9_1877=ceil(l9_1865);
float l9_1878=l9_1865-l9_1876;
float2 l9_1879=l9_1875;
float2 l9_1880=(*sc_set0.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_1881=l9_1876;
float2 l9_1882=calcSeamlessPanoramicUvsForSampling(l9_1879,l9_1880,l9_1881);
float2 l9_1883=l9_1882;
float l9_1884=l9_1876;
float2 l9_1885=l9_1883;
float l9_1886=l9_1884;
int l9_1887;
if ((int(sc_EnvmapSpecularHasSwappedViews_tmp)!=0))
{
int l9_1888=0;
...
int l9_1892=l9_1887;
float2 l9_1893=l9_1885;
int l9_1894=sc_EnvmapSpecularLayout_tmp;
int l9_1895=l9_1892;
float l9_1896=l9_1886;
float2 l9_1897=l9_1893;
int l9_1898=l9_1894;
int l9_1899=l9_1895;
float3 l9_1900=float3(0.0);
if (l9_1898==0)
{
l9_1900=float3(l9_1897,0.0);
}
else
{
if (l9_1898==1)
{
l9_1900=float3(l9_1897.x,(l9_1897.y*0.5)+(0.5-(float(l9_1899)*0.5)),0.0);
}
else
{
l9_1900=float3(l9_1897,float(l9_1899));
}
}
float3 l9_1901=l9_1900;
float3 l9_1902=l9_1901;
float4 l9_1903=sc_set0.sc_EnvmapSpecular.sample(sc_set0.sc_EnvmapSpecularSmpSC,l9_1902.xy,level(l9_1896));
float4 l9_1904=l9_1903;
float4 l9_1905=l9_1904;
float4 l9_1906=l9_1905;
float2 l9_1907=l9_1875;
float2 l9_1908=(*sc_set0.UserUniforms).sc_EnvmapSpecularSize.xy;
float l9_1909=l9_1877;
float2 l9_1910=calcSeamlessPanoramicUvsForSampling(l9_1907,l9_1908,l9_1909);
float2 l9_1911=l9_1910;
float l9_1912=l9_1877;
float2 l9_1913=l9_1911;
float l9_1914=l9_1912;
int l9_1915;
if ((int(sc_EnvmapSpecularHasSwappedViews_tmp)!=0))
{
int l9_1916=0;
...
int l9_1920=l9_1915;
float2 l9_1921=l9_1913;
int l9_1922=sc_EnvmapSpecularLayout_tmp;
int l9_1923=l9_1920;
float l9_1924=l9_1914;
float2 l9_1925=l9_1921;
int l9_1926=l9_1922;
int l9_1927=l9_1923;
float3 l9_1928=float3(0.0);
if (l9_1926==0)
{
l9_1928=float3(l9_1925,0.0);
}
else
{
if (l9_1926==1)
{
l9_1928=float3(l9_1925.x,(l9_1925.y*0.5)+(0.5-(float(l9_1927)*0.5)),0.0);
}
else
{
l9_1928=float3(l9_1925,float(l9_1927));
}
}
float3 l9_1929=l9_1928;
float3 l9_1930=l9_1929;
float4 l9_1931=sc_set0.sc_EnvmapSpecular.sample(sc_set0.sc_EnvmapSpecularSmpSC,l9_1930.xy,level(l9_1924));
float4 l9_1932=l9_1931;
float4 l9_1933=l9_1932;
float4 l9_1934=l9_1933;
l9_1866=mix(l9_1906,l9_1934,float4(l9_1878));
}
else
{
float2 l9_1935=l9_1875;
float l9_1936=l9_1865;
float2 l9_1937=l9_1935;
float l9_1938=l9_1936;
int l9_1939;
if ((int(sc_EnvmapSpecularHasSwappedViews_tmp)!=0))
{
int l9_1940=0;
...
int l9_1944=l9_1939;
float2 l9_1945=l9_1937;
int l9_1946=sc_EnvmapSpecularLayout_tmp;
int l9_1947=l9_1944;
float l9_1948=l9_1938;
float2 l9_1949=l9_1945;
int l9_1950=l9_1946;
int l9_1951=l9_1947;
float3 l9_1952=float3(0.0);
if (l9_1950==0)
{
l9_1952=float3(l9_1949,0.0);
}
else
{
if (l9_1950==1)
{
l9_1952=float3(l9_1949.x,(l9_1949.y*0.5)+(0.5-(float(l9_1951)*0.5)),0.0);
}
else
{
l9_1952=float3(l9_1949,float(l9_1951));
}
}
float3 l9_1953=l9_1952;
float3 l9_1954=l9_1953;
float4 l9_1955=sc_set0.sc_EnvmapSpecular.sample(sc_set0.sc_EnvmapSpecularSmpSC,l9_1954.xy,level(l9_1948));
float4 l9_1956=l9_1955;
float4 l9_1957=l9_1956;
l9_1866=l9_1957;
}
float4 l9_1958=l9_1866;
float3 l9_1959=l9_1958.xyz*(1.0/l9_1958.w);
float3 l9_1960=l9_1959;
float3 l9_1961=l9_1960*(*sc_set0.UserUniforms).sc_EnvmapExposure;
l9_1961+=float3(1e-06);
float3 l9_1962=l9_1961;
float3 l9_1963=l9_1962;
if (((*sc_set0.UserUniforms).sc_RayTracingReceiverEffectsMask&1)!=0)
{
float4 l9_1964=gl_FragCoord;
float2 l9_1965=l9_1964.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_1966=l9_1965;
float2 l9_1967=l9_1966;
float l9_1968=0.0;
int l9_1969;
...
{
l9_1972=in.varStereoViewID;
}
int l9_1973=l9_1972;
l9_1969=l9_1973;
}
int l9_1974=l9_1969;
float2 l9_1975=l9_1967;
int l9_1976=sc_RayTracingReflectionsLayout_tmp;
int l9_1977=l9_1974;
float l9_1978=l9_1968;
...
float4 l9_1985=sc_set0.sc_RayTracingReflections.sample(sc_set0.sc_RayTracingReflectionsSmpSC,l9_1984.xy,bias(l9_1978));
float4 l9_1986=l9_1985;
float4 l9_1987=l9_1986;
float4 l9_1988=l9_1987;
l9_1963=mix(l9_1963,l9_1988.xyz,float3(l9_1988.w));
}
float l9_1989=abs(dot(l9_1851,l9_1850));
SurfaceProperties l9_1990=l9_1849;
float l9_1991=l9_1989;
float3 l9_1992=l9_1963*envBRDFApprox(l9_1990,l9_1991);
l9_1848+=l9_1992;
}
if ((int(sc_LightEstimation_tmp)!=0))
{
SurfaceProperties l9_1993=l9_1846;
float3 l9_1994=l9_1847;
float l9_1995=fast::clamp(l9_1993.roughness*l9_1993.roughness,0.0099999998,1.0);
float3 l9_1996=(*sc_set0.UserUniforms).sc_LightEstimationData.ambientLight*l9_1993.specColor;
sc_SphericalGaussianLight_t l9_1997;
sc_SphericalGaussianLight_t l9_1998;
sc_SphericalGaussianLight_t l9_1999;
int l9_2000=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_2000<sc_LightEstimationSGCount_tmp)
{
l9_1997.color=(*sc_set0.UserUniforms).sc_LightEstimationData.sg[l9_2000].color;
l9_1997.sharpness=(*sc_set0.UserUniforms).sc_LightEstimationData.sg[l9_2000].sharpness;
l9_1997.axis=(*sc_set0.UserUniforms).sc_LightEstimationData.sg[l9_2000].axis;
float3 l9_2001=l9_1993.normal;
float l9_2002=l9_1995;
float3 l9_2003=l9_1994;
float3 l9_2004=l9_1993.specColor;
float3 l9_2005=l9_2001;
float l9_2006=l9_2002;
l9_1998.axis=l9_2005;
float l9_2007=l9_2006*l9_2006;
l9_1998.sharpness=2.0/l9_2007;
l9_1998.color=float3(1.0/(3.1415927*l9_2007));
sc_SphericalGaussianLight_t l9_2008=l9_1998;
sc_SphericalGaussianLight_t l9_2009=l9_2008;
sc_SphericalGaussianLight_t l9_2010=l9_2009;
float3 l9_2011=l9_2003;
l9_1999.axis=reflect(-l9_2011,l9_2010.axis);
l9_1999.color=l9_2010.color;
l9_1999.sharpness=l9_2010.sharpness;
l9_1999.sharpness/=(4.0*fast::max(dot(l9_2010.axis,l9_2011),9.9999997e-05));
sc_SphericalGaussianLight_t l9_2012=l9_1999;
sc_SphericalGaussianLight_t l9_2013=l9_2012;
sc_SphericalGaussianLight_t l9_2014=l9_2013;
sc_SphericalGaussianLight_t l9_2015=l9_1997;
float l9_2016=length((l9_2014.axis*l9_2014.sharpness)+(l9_2015.axis*l9_2015.sharpness));
float3 l9_2017=(l9_2014.color*exp((l9_2016-l9_2014.sharpness)-l9_2015.sharpness))*l9_2015.color;
float l9_2018=1.0-exp((-2.0)*l9_2016);
float3 l9_2019=((l9_2017*6.2831855)*l9_2018)/float3(l9_2016);
float3 l9_2020=l9_2019;
float3 l9_2021=l9_2013.axis;
float l9_2022=l9_2002*l9_2002;
float l9_2023=dot(l9_2001,l9_2021);
float l9_2024=fast::clamp(l9_2023,0.0,1.0);
float l9_2025=l9_2024;
float l9_2026=dot(l9_2001,l9_2003);
float l9_2027=fast::clamp(l9_2026,0.0,1.0);
float l9_2028=l9_2027;
float3 l9_2029=normalize(l9_2013.axis+l9_2003);
float l9_2030=l9_2022;
float l9_2031=l9_2025;
float l9_2032=1.0/(l9_2031+sqrt(l9_2030+(((1.0-l9_2030)*l9_2031)*l9_2031)));
float l9_2033=l9_2022;
float l9_2034=l9_2028;
float l9_2035=1.0/(l9_2034+sqrt(l9_2033+(((1.0-l9_2033)*l9_2034)*l9_2034)));
l9_2020*=(l9_2032*l9_2035);
float l9_2036=dot(l9_2021,l9_2029);
float l9_2037=fast::clamp(l9_2036,0.0,1.0);
float l9_2038=pow(1.0-l9_2037,5.0);
l9_2020*=(l9_2004+((float3(1.0)-l9_2004)*l9_2038));
l9_2020*=l9_2025;
float3 l9_2039=l9_2020;
l9_1996+=l9_2039;
l9_2000++;
continue;
}
...
float3 l9_2040=l9_1996;
l9_1848+=l9_2040;
}
float3 l9_2041=l9_1848;
l9_1608.indirectSpecular=l9_2041;
LightingComponents l9_2042=l9_1608;
LightingComponents l9_2043=l9_2042;
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_2043.directDiffuse=float3(0.0);
l9_2043.indirectDiffuse=float3(0.0);
float4 l9_2044=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_2045=out.sc_FragData0;
l9_2044=l9_2045;
}
else
{
float4 l9_2046=gl_FragCoord;
float2 l9_2047=l9_2046.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_2052=l9_2051;
int l9_2053=l9_2052;
float3 l9_2054=float3(l9_2048,0.0);
int l9_2055=l9_2050;
int l9_2056=l9_2053;
if (l9_2055==1)
{
l9_2054.y=((2.0*l9_2054.y)+float(l9_2056))-1.0;
}
float2 l9_2057=l9_2054.xy;
l9_2049=l9_2057;
}
else
{
...
float2 l9_2058=l9_2049;
float2 l9_2059=l9_2058;
float2 l9_2060=l9_2059;
float2 l9_2061=l9_2060;
float l9_2062=0.0;
int l9_2063;
...
int l9_2070=sc_ScreenTextureLayout_tmp;
int l9_2071=l9_2068;
float l9_2072=l9_2062;
float2 l9_2073=l9_2069;
int l9_2074=l9_2070;
int l9_2075=l9_2071;
float3 l9_2076=float3(0.0);
if (l9_2074==0)
{
l9_2076=float3(l9_2073,0.0);
}
else
{
if (l9_2074==1)
{
l9_2076=float3(l9_2073.x,(l9_2073.y*0.5)+(0.5-(float(l9_2075)*0.5)),0.0);
}
else
{
l9_2076=float3(l9_2073,float(l9_2075));
}
}
float3 l9_2077=l9_2076;
float3 l9_2078=l9_2077;
float4 l9_2079=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_2078.xy,bias(l9_2072));
float4 l9_2080=l9_2079;
float4 l9_2081=l9_2080;
l9_2044=l9_2081;
}
float4 l9_2082=l9_2044;
float3 l9_2083=l9_2082.xyz;
float3 l9_2084;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_2084=float3(pow(l9_2083.x,2.2),pow(l9_2083.y,2.2),pow(l9_2083.z,2.2));
}
else
{
l9_2084=l9_2083*l9_2083;
}
float3 l9_2085=l9_2084;
float3 l9_2086=l9_2085;
l9_2043.transmitted=l9_2086*mix(float3(1.0),l9_1592.albedo,float3(l9_1592.opacity));
l9_1592.opacity=1.0;
}
bool l9_2087=false;
...
SurfaceProperties l9_2088=l9_1592;
LightingComponents l9_2089=l9_2043;
bool l9_2090=l9_2087;
float3 l9_2091=l9_2088.albedo*(l9_2089.directDiffuse+(l9_2089.indirectDiffuse*l9_2088.ao));
float3 l9_2092=l9_2089.directSpecular+(l9_2089.indirectSpecular*l9_2088.specularAo);
float3 l9_2093=l9_2088.emissive;
float3 l9_2094=l9_2089.transmitted;
if (l9_2090)
{
float l9_2095=l9_2088.opacity;
l9_2091*=srgbToLinear(l9_2095);
}
float3 l9_2096=((l9_2091+l9_2092)+l9_2093)+l9_2094;
float3 l9_2097=l9_2096;
float4 l9_2098=float4(l9_2097,l9_1592.opacity);
if ((int(sc_IsEditor_tmp)!=0))
{
l9_2098.x+=((l9_1592.ao.x*l9_1592.specularAo.x)*9.9999997e-06);
}
if (!(int(sc_BlendMode_Multiply_tmp)!=0))
{
float3 l9_2099=l9_2098.xyz;
float l9_2100=1.8;
float l9_2101=1.4;
float l9_2102=0.5;
float l9_2103=1.5;
float3 l9_2104=(l9_2099*((l9_2099*l9_2100)+float3(l9_2101)))/((l9_2099*((l9_2099*l9_2100)+float3(l9_2102)))+float3(l9_2103));
l9_2098=float4(l9_2104.x,l9_2104.y,l9_2104.z,l9_2098.w);
}
float3 l9_2105=l9_2098.xyz;
float l9_2106=l9_2105.x;
float l9_2107=l9_2105.y;
float l9_2108=l9_2105.z;
float3 l9_2109=float3(linearToSrgb(l9_2106),linearToSrgb(l9_2107),linearToSrgb(l9_2108));
l9_2098=float4(l9_2109.x,l9_2109.y,l9_2109.z,l9_2098.w);
float4 l9_2110=l9_2098;
l9_1579=l9_2110;
}
l9_1579=fast::max(l9_1579,float4(0.0));
l9_1565=l9_1579;
param=l9_1565;
param_2=param;
}
...
l9_2112-=0.001;
l9_2111=l9_2112;
float4 l9_2113=float4(0.0);
l9_2113=param_3.VertexColor;
float l9_2114=0.0;
l9_2114=l9_2113.x;
float l9_2115=0.0;
float l9_2116=l9_2111;
bool l9_2117=(l9_2116*1.0)!=0.0;
bool l9_2118;
if (l9_2117)
{
l9_2118=(l9_2114*1.0)!=0.0;
}
else
{
l9_2118=l9_2117;
}
l9_2115=float(l9_2118);
float2 l9_2119=float2(0.0);
float2 l9_2120=(*sc_set0.UserUniforms).trailFadeStartEnd;
l9_2119=l9_2120;
float2 l9_2121=float2(0.0);
float l9_2122=(*sc_set0.UserUniforms).Port_Input1_N216;
float2 l9_2123=float2(0.0);
float2 l9_2124;
if (TRAILBEHAVIOR_tmp!=0)
{
l9_2124=float2(l9_2122);
}
else
{
float2 l9_2125=float2(0.0);
float2 l9_2126=(*sc_set0.UserUniforms).trailFadeInOut;
l9_2125=l9_2126;
l9_2123=l9_2125;
l9_2124=l9_2123;
}
l9_2121=l9_2124;
float4 l9_2127=float4(0.0);
l9_2127=float4(l9_2119.x,l9_2119.y,l9_2127.z,l9_2127.w);
l9_2127=float4(l9_2127.x,l9_2127.y,l9_2121.x,l9_2121.y);
float3 l9_2128=float3(0.0);
float3 l9_2129=(*sc_set0.UserUniforms).colorStart;
l9_2128=l9_2129;
float3 l9_2130=float3(0.0);
float3 l9_2131=(*sc_set0.UserUniforms).colorEnd;
l9_2130=l9_2131;
float3 l9_2132=float3(0.0);
float3 l9_2133=(*sc_set0.UserUniforms).colorMinStart;
l9_2132=l9_2133;
float3 l9_2134=float3(0.0);
float3 l9_2135=(*sc_set0.UserUniforms).colorMinEnd;
l9_2134=l9_2135;
float3 l9_2136=float3(0.0);
float3 l9_2137=(*sc_set0.UserUniforms).colorMaxStart;
l9_2136=l9_2137;
float3 l9_2138=float3(0.0);
float3 l9_2139=(*sc_set0.UserUniforms).colorMaxEnd;
l9_2138=l9_2139;
float l9_2140=0.0;
float l9_2141=(*sc_set0.UserUniforms).alphaStart;
l9_2140=l9_2141;
float l9_2142=0.0;
float l9_2143=(*sc_set0.UserUniforms).alphaEnd;
l9_2142=l9_2143;
float l9_2144=0.0;
float l9_2145=(*sc_set0.UserUniforms).alphaMinStart;
l9_2144=l9_2145;
float l9_2146=0.0;
float l9_2147=(*sc_set0.UserUniforms).alphaMinEnd;
l9_2146=l9_2147;
float l9_2148=0.0;
float l9_2149=(*sc_set0.UserUniforms).alphaMaxStart;
l9_2148=l9_2149;
float l9_2150=0.0;
float l9_2151=(*sc_set0.UserUniforms).alphaMaxEnd;
l9_2150=l9_2151;
float l9_2152=0.0;
float l9_2153=(*sc_set0.UserUniforms).alphaDissolveMult;
l9_2152=l9_2153;
float l9_2154=0.0;
float l9_2155=(*sc_set0.UserUniforms).numValidFrames;
l9_2154=l9_2155;
float2 l9_2156=float2(0.0);
float2 l9_2157=(*sc_set0.UserUniforms).gridSize;
l9_2156=l9_2157;
float l9_2158=0.0;
float l9_2159=(*sc_set0.UserUniforms).flipBookSpeedMult;
l9_2158=l9_2159;
float l9_2160=0.0;
float l9_2161=(*sc_set0.UserUniforms).flipBookRandomStart;
l9_2160=l9_2161;
float2 l9_2162=float2(0.0);
float2 l9_2163=(*sc_set0.UserUniforms).colorRampTextureSize.xy;
l9_2162=l9_2163;
float4 l9_2164=float4(0.0);
float4 l9_2165=(*sc_set0.UserUniforms).colorRampMult;
l9_2164=l9_2165;
float l9_2166=0.0;
float l9_2167=(*sc_set0.UserUniforms).externalSeed;
l9_2166=l9_2167;
float4 l9_2168=float4(0.0);
float4 l9_2169;
l9_2169.x=in.Interpolator0.x;
l9_2169.y=in.Interpolator0.y;
l9_2169.z=in.Interpolator0.z;
l9_2169.w=in.Interpolator0.w;
l9_2168=l9_2169;
float4 l9_2170=float4(0.0);
float4 l9_2171;
l9_2171.x=in.Interpolator1.x;
l9_2171.y=in.Interpolator1.y;
l9_2171.z=in.Interpolator1.z;
l9_2171.w=in.Interpolator1.w;
l9_2170=l9_2171;
float4 l9_2172=float4(0.0);
float l9_2173=l9_2115;
float4 l9_2174=l9_2127;
float3 l9_2175=l9_2128;
float3 l9_2176=l9_2130;
float3 l9_2177=l9_2132;
float3 l9_2178=l9_2134;
float3 l9_2179=l9_2136;
float3 l9_2180=l9_2138;
float l9_2181=l9_2140;
float l9_2182=l9_2142;
float l9_2183=l9_2144;
float l9_2184=l9_2146;
float l9_2185=l9_2148;
float l9_2186=l9_2150;
float l9_2187=l9_2152;
float l9_2188=l9_2154;
float2 l9_2189=l9_2156;
float l9_2190=l9_2158;
float l9_2191=l9_2160;
float2 l9_2192=l9_2162;
float4 l9_2193=l9_2164;
float l9_2194=l9_2166;
float4 l9_2195=l9_2168;
float4 l9_2196=l9_2170;
ssGlobals l9_2197=param_3;
tempGlobals=l9_2197;
float4 l9_2198=float4(0.0);
N2_ENABLE_TRAILS=(int(TRAILS_tmp)!=0);
N2_ENABLE_INDEPENDENTTRAIL=TRAILBEHAVIOR_tmp!=0;
N2_isTrailCondition=l9_2173!=0.0;
N2_ENABLE_TRAILTEXTURE=(int(TRAILTEXTURE_tmp)!=0);
N2_ENABLE_TRAILCOLORRAMP=(int(TRAILCOLORRAMP_tmp)!=0);
N2_fadeInOut=l9_2174;
N2_colorStart=l9_2175;
N2_colorEnd=l9_2176;
N2_ENABLE_COLORMINMAX=(int(COLORMINMAX_tmp)!=0);
N2_colorMinStart=l9_2177;
N2_colorMinEnd=l9_2178;
N2_colorMaxStart=l9_2179;
N2_colorMaxEnd=l9_2180;
N2_ENABLE_COLORMONOMIN=(int(COLORMONOMIN_tmp)!=0);
N2_alphaStart=l9_2181;
N2_alphaEnd=l9_2182;
N2_ENABLE_ALPHAMINMAX=(int(ALPHAMINMAX_tmp)!=0);
N2_alphaMinStart=l9_2183;
N2_alphaMinEnd=l9_2184;
N2_alphaMaxStart=l9_2185;
N2_alphaMaxEnd=l9_2186;
N2_ENABLE_ALPHADISSOLVE=(int(ALPHADISSOLVE_tmp)!=0);
N2_alphaDissolveMult=l9_2187;
N2_ENABLE_PREMULTIPLIEDCOLOR=(int(PREMULTIPLIEDCOLOR_tmp)!=0);
N2_ENABLE_BLACKASALPHA=(int(BLACKASALPHA_tmp)!=0);
N2_ENABLE_SCREENFADE=(int(SCREENFADE_tmp)!=0);
N2_ENABLE_FLIPBOOK=(int(FLIPBOOK_tmp)!=0);
N2_numValidFrames=l9_2188;
N2_gridSize=l9_2189;
N2_flipBookSpeedMult=l9_2190;
N2_flipBookRandomStart=l9_2191;
N2_ENABLE_FLIPBOOKBLEND=(int(FLIPBOOKBLEND_tmp)!=0);
N2_ENABLE_FLIPBOOKBYLIFE=(int(FLIPBOOKBYLIFE_tmp)!=0);
N2_ENABLE_COLORRAMP=(int(COLORRAMP_tmp)!=0);
N2_texSize=l9_2192;
N2_colorRampMult=l9_2193;
N2_ENABLE_NORANDOFFSET=(int(NORANDOFFSET_tmp)!=0);
N2_ENABLE_BASETEXTURE=(int(BASETEXTURE_tmp)!=0);
N2_ENABLE_WORLDPOSSEED=(int(WORLDPOSSEED_tmp)!=0);
N2_externalSeed=l9_2194;
N2_timeValuesIn=l9_2195;
N2_cameraFade_trailHeadTime_taper=l9_2196;
float l9_2199=0.0;
if (N2_ENABLE_WORLDPOSSEED)
{
float4x4 l9_2200=(*sc_set0.UserUniforms).sc_ModelMatrix;
l9_2199=length(float4(1.0)*l9_2200);
}
N2_globalSeed=N2_externalSeed+l9_2199;
int l9_2201=0;
l9_2201=int(tempGlobals.gInstanceID+0.5);
int l9_2202=l9_2201;
float l9_2203=float(l9_2202);
int l9_2204=int(l9_2203);
int l9_2205=l9_2204^(l9_2204*15299);
int l9_2206=l9_2205;
int l9_2207=l9_2206;
int l9_2208=((l9_2207*((l9_2207*1471343)+101146501))+1559861749)&2147483647;
int l9_2209=l9_2208;
int l9_2210=l9_2206*1399;
int l9_2211=((l9_2210*((l9_2210*1471343)+101146501))+1559861749)&2147483647;
int l9_2212=l9_2211;
int l9_2213=l9_2206*7177;
int l9_2214=((l9_2213*((l9_2213*1471343)+101146501))+1559861749)&2147483647;
int l9_2215=l9_2214;
int l9_2216=l9_2209;
float l9_2217=float(l9_2216)*4.6566129e-10;
int l9_2218=l9_2212;
float l9_2219=float(l9_2218)*4.6566129e-10;
int l9_2220=l9_2215;
float l9_2221=float(l9_2220)*4.6566129e-10;
float3 l9_2222=float3(l9_2217,l9_2219,l9_2221);
float3 l9_2223=l9_2222;
N2_particleSeed=l9_2223;
float l9_2224=N2_timeValuesIn.w;
float l9_2225=N2_particleSeed.x;
float l9_2226=N2_particleSeed.y;
float l9_2227=N2_particleSeed.z;
float3 l9_2228=fract((float3(l9_2225,l9_2226,l9_2227)*27.21883)+float3(N2_globalSeed));
if (N2_ENABLE_COLORMONOMIN)
{
l9_2228=fract((float3(l9_2225,l9_2225,l9_2225)*27.21883)+float3(N2_globalSeed));
}
float l9_2229=fract((N2_particleSeed.x*3121.3333)+N2_globalSeed);
float l9_2230=fract((N2_particleSeed.y*13.2234)+N2_globalSeed);
float l9_2231=fract((N2_particleSeed.z*3.5358)+N2_globalSeed);
N2_isTrail=0.0;
float l9_2232=1.0;
N2_trailHeadTime=N2_cameraFade_trailHeadTime_taper.yz;
float4 l9_2233=float4(1.0);
float2 l9_2234=tempGlobals.Surface_UVCoord0;
N2_uv=l9_2234;
if (N2_ENABLE_TRAILS)
{
if (N2_isTrailCondition)
{
N2_isTrail=1.0;
float l9_2235=N2_cameraFade_trailHeadTime_taper.w;
float2 l9_2236=float2(0.5-(l9_2235/2.0),0.5+(l9_2235/2.0));
float l9_2237=N2_uv.x;
float l9_2238=l9_2236.x;
bool l9_2239=l9_2237<l9_2238;
bool l9_2240;
if (!l9_2239)
{
l9_2240=N2_uv.x>l9_2236.y;
}
else
{
l9_2240=l9_2239;
...
N2_uv=float2(0.0+(((N2_uv.x-l9_2236.x)*1.0)/((l9_2236.y-l9_2236.x)+1e-06)),N2_uv.y);
if (N2_ENABLE_TRAILTEXTURE)
{
float2 l9_2241=float2(N2_uv.x,1.0-N2_uv.y);
...
int l9_2248=l9_2243;
int l9_2249=trailTexLayout_tmp;
int l9_2250=l9_2248;
float2 l9_2251=l9_2241;
bool l9_2252=(int(SC_USE_UV_TRANSFORM_trailTex_tmp)!=0);
float3x3 l9_2253=(*sc_set0.UserUniforms).trailTexTransform;
int2 l9_2254=int2(SC_SOFTWARE_WRAP_MODE_U_trailTex_tmp,SC_SOFTWARE_WRAP_MODE_V_trailTex_tmp);
bool l9_2255=(int(SC_USE_UV_MIN_MAX_trailTex_tmp)!=0);
float4 l9_2256=(*sc_set0.UserUniforms).trailTexUvMinMax;
bool l9_2257=(int(SC_USE_CLAMP_TO_BORDER_trailTex_tmp)!=0);
float4 l9_2258=(*sc_set0.UserUniforms).trailTexBorderColor;
float l9_2259=0.0;
bool l9_2260=l9_2257&&(!l9_2255);
float l9_2261=1.0;
float l9_2262=l9_2251.x;
int l9_2263=l9_2254.x;
if (l9_2263==1)
{
l9_2262=fract(l9_2262);
}
else
{
if (l9_2263==2)
{
float l9_2264=fract(l9_2262);
float l9_2265=l9_2262-l9_2264;
float l9_2266=step(0.25,fract(l9_2265*0.5));
l9_2262=mix(l9_2264,1.0-l9_2264,fast::clamp(l9_2266,0.0,1.0));
}
}
l9_2251.x=l9_2262;
float l9_2267=l9_2251.y;
int l9_2268=l9_2254.y;
if (l9_2268==1)
{
l9_2267=fract(l9_2267);
}
else
{
if (l9_2268==2)
{
float l9_2269=fract(l9_2267);
float l9_2270=l9_2267-l9_2269;
float l9_2271=step(0.25,fract(l9_2270*0.5));
l9_2267=mix(l9_2269,1.0-l9_2269,fast::clamp(l9_2271,0.0,1.0));
}
}
l9_2251.y=l9_2267;
if (l9_2255)
{
bool l9_2272=l9_2257;
bool l9_2273;
if (l9_2272)
{
l9_2273=l9_2254.x==3;
...
float l9_2274=l9_2251.x;
float l9_2275=l9_2256.x;
float l9_2276=l9_2256.z;
bool l9_2277=l9_2273;
float l9_2278=l9_2261;
...
float l9_2283=l9_2251.y;
float l9_2284=l9_2256.y;
float l9_2285=l9_2256.w;
bool l9_2286=l9_2282;
float l9_2287=l9_2261;
...
float2 l9_2290=l9_2251;
bool l9_2291=l9_2252;
float3x3 l9_2292=l9_2253;
if (l9_2291)
{
l9_2290=float2((l9_2292*float3(l9_2290,1.0)).xy);
}
float2 l9_2293=l9_2290;
l9_2251=l9_2293;
float l9_2294=l9_2251.x;
int l9_2295=l9_2254.x;
bool l9_2296=l9_2260;
float l9_2297=l9_2261;
...
l9_2251.x=l9_2294;
l9_2261=l9_2297;
float l9_2305=l9_2251.y;
int l9_2306=l9_2254.y;
bool l9_2307=l9_2260;
float l9_2308=l9_2261;
if ((l9_2306==0)||(l9_2306==3))
{
float l9_2309=l9_2305;
float l9_2310=0.0;
float l9_2311=1.0;
bool l9_2312=l9_2307;
float l9_2313=l9_2308;
float l9_2314=fast::clamp(l9_2309,l9_2310,l9_2311);
float l9_2315=step(abs(l9_2309-l9_2314),9.9999997e-06);
l9_2313*=(l9_2315+((1.0-float(l9_2312))*(1.0-l9_2315)));
l9_2309=l9_2314;
l9_2305=l9_2309;
l9_2308=l9_2313;
}
l9_2251.y=l9_2305;
l9_2261=l9_2308;
float2 l9_2316=l9_2251;
int l9_2317=l9_2249;
int l9_2318=l9_2250;
float l9_2319=l9_2259;
float2 l9_2320=l9_2316;
int l9_2321=l9_2317;
int l9_2322=l9_2318;
float3 l9_2323=float3(0.0);
if (l9_2321==0)
{
l9_2323=float3(l9_2320,0.0);
}
else
{
if (l9_2321==1)
{
l9_2323=float3(l9_2320.x,(l9_2320.y*0.5)+(0.5-(float(l9_2322)*0.5)),0.0);
}
else
{
l9_2323=float3(l9_2320,float(l9_2322));
}
}
float3 l9_2324=l9_2323;
float3 l9_2325=l9_2324;
float4 l9_2326=sc_set0.trailTex.sample(sc_set0.trailTexSmpSC,l9_2325.xy,bias(l9_2319));
float4 l9_2327=l9_2326;
if (l9_2257)
{
l9_2327=mix(l9_2258,l9_2327,float4(l9_2261));
}
float4 l9_2328=l9_2327;
l9_2242=l9_2328;
float4 l9_2329=l9_2242;
l9_2233=l9_2329;
}
float l9_2330=fast::max(1e-06,N2_fadeInOut.x);
float l9_2331=N2_timeValuesIn.w;
l9_2232*=mix(0.0,1.0,fast::clamp(l9_2331,0.0,l9_2330)/l9_2330);
l9_2330=fast::max(1e-06,N2_fadeInOut.y);
l9_2232*=mix(0.0,1.0,fast::clamp(1.0-l9_2331,0.0,l9_2330)/l9_2330);
if (!N2_ENABLE_INDEPENDENTTRAIL)
{
l9_2224=N2_trailHeadTime.y;
l9_2330=fast::max(1e-06,N2_fadeInOut.z);
l9_2232*=mix(0.0,1.0,fast::clamp(l9_2224,0.0,l9_2330)/l9_2330);
l9_2330=fast::max(1e-06,N2_fadeInOut.w);
l9_2232*=mix(0.0,1.0,fast::clamp(1.0-l9_2224,0.0,l9_2330)/l9_2330);
}
if (N2_ENABLE_TRAILCOLORRAMP)
{
float2 l9_2332=float2(0.0);
l9_2332=(*sc_set0.UserUniforms).trailColorRampTexSize.xy;
float2 l9_2333=l9_2332;
float2 l9_2334=float2(0.0);
l9_2334=(*sc_set0.UserUniforms).trailColorRampTexSize.xy;
float2 l9_2335=l9_2334;
float l9_2336=ceil(l9_2224*l9_2333.x)/l9_2335.x;
float2 l9_2337=float2(l9_2336,0.5);
...
{
l9_2342=in.varStereoViewID;
}
int l9_2343=l9_2342;
l9_2339=l9_2343;
}
int l9_2344=l9_2339;
int l9_2345=trailColorRampTexLayout_tmp;
int l9_2346=l9_2344;
float2 l9_2347=l9_2337;
bool l9_2348=(int(SC_USE_UV_TRANSFORM_trailColorRampTex_tmp)!=0);
float3x3 l9_2349=(*sc_set0.UserUniforms).trailColorRampTexTransform;
int2 l9_2350=int2(SC_SOFTWARE_WRAP_MODE_U_trailColorRampTex_tmp,SC_SOFTWARE_WRAP_MODE_V_trailColorRampTex_tmp);
bool l9_2351=(int(SC_USE_UV_MIN_MAX_trailColorRampTex_tmp)!=0);
float4 l9_2352=(*sc_set0.UserUniforms).trailColorRampTexUvMinMax;
bool l9_2353=(int(SC_USE_CLAMP_TO_BORDER_trailColorRampTex_tmp)!=0);
float4 l9_2354=(*sc_set0.UserUniforms).trailColorRampTexBorderColor;
float l9_2355=0.0;
bool l9_2356=l9_2353&&(!l9_2351);
float l9_2357=1.0;
float l9_2358=l9_2347.x;
int l9_2359=l9_2350.x;
if (l9_2359==1)
{
l9_2358=fract(l9_2358);
}
else
{
if (l9_2359==2)
{
float l9_2360=fract(l9_2358);
float l9_2361=l9_2358-l9_2360;
float l9_2362=step(0.25,fract(l9_2361*0.5));
l9_2358=mix(l9_2360,1.0-l9_2360,fast::clamp(l9_2362,0.0,1.0));
}
}
l9_2347.x=l9_2358;
float l9_2363=l9_2347.y;
int l9_2364=l9_2350.y;
if (l9_2364==1)
{
l9_2363=fract(l9_2363);
}
else
{
if (l9_2364==2)
{
float l9_2365=fract(l9_2363);
float l9_2366=l9_2363-l9_2365;
float l9_2367=step(0.25,fract(l9_2366*0.5));
l9_2363=mix(l9_2365,1.0-l9_2365,fast::clamp(l9_2367,0.0,1.0));
}
}
l9_2347.y=l9_2363;
if (l9_2351)
{
bool l9_2368=l9_2353;
bool l9_2369;
if (l9_2368)
{
l9_2369=l9_2350.x==3;
...
float l9_2370=l9_2347.x;
float l9_2371=l9_2352.x;
float l9_2372=l9_2352.z;
bool l9_2373=l9_2369;
float l9_2374=l9_2357;
float l9_2375=fast::clamp(l9_2370,l9_2371,l9_2372);
float l9_2376=step(abs(l9_2370-l9_2375),9.9999997e-06);
l9_2374*=(l9_2376+((1.0-float(l9_2373))*(1.0-l9_2376)));
l9_2370=l9_2375;
l9_2347.x=l9_2370;
l9_2357=l9_2374;
bool l9_2377=l9_2353;
bool l9_2378;
if (l9_2377)
{
l9_2378=l9_2350.y==3;
...
float l9_2379=l9_2347.y;
float l9_2380=l9_2352.y;
float l9_2381=l9_2352.w;
bool l9_2382=l9_2378;
float l9_2383=l9_2357;
...
float2 l9_2386=l9_2347;
bool l9_2387=l9_2348;
float3x3 l9_2388=l9_2349;
if (l9_2387)
{
l9_2386=float2((l9_2388*float3(l9_2386,1.0)).xy);
}
float2 l9_2389=l9_2386;
l9_2347=l9_2389;
float l9_2390=l9_2347.x;
int l9_2391=l9_2350.x;
bool l9_2392=l9_2356;
float l9_2393=l9_2357;
...
l9_2347.x=l9_2390;
l9_2357=l9_2393;
float l9_2401=l9_2347.y;
int l9_2402=l9_2350.y;
bool l9_2403=l9_2356;
float l9_2404=l9_2357;
if ((l9_2402==0)||(l9_2402==3))
{
float l9_2405=l9_2401;
float l9_2406=0.0;
float l9_2407=1.0;
bool l9_2408=l9_2403;
float l9_2409=l9_2404;
float l9_2410=fast::clamp(l9_2405,l9_2406,l9_2407);
float l9_2411=step(abs(l9_2405-l9_2410),9.9999997e-06);
l9_2409*=(l9_2411+((1.0-float(l9_2408))*(1.0-l9_2411)));
l9_2405=l9_2410;
l9_2401=l9_2405;
l9_2404=l9_2409;
}
l9_2347.y=l9_2401;
l9_2357=l9_2404;
float2 l9_2412=l9_2347;
int l9_2413=l9_2345;
int l9_2414=l9_2346;
float l9_2415=l9_2355;
float2 l9_2416=l9_2412;
int l9_2417=l9_2413;
int l9_2418=l9_2414;
float3 l9_2419=float3(0.0);
if (l9_2417==0)
{
l9_2419=float3(l9_2416,0.0);
}
else
{
if (l9_2417==1)
{
l9_2419=float3(l9_2416.x,(l9_2416.y*0.5)+(0.5-(float(l9_2418)*0.5)),0.0);
}
else
{
l9_2419=float3(l9_2416,float(l9_2418));
}
}
float3 l9_2420=l9_2419;
float3 l9_2421=l9_2420;
float4 l9_2422=sc_set0.trailColorRampTex.sample(sc_set0.trailColorRampTexSmpSC,l9_2421.xy,bias(l9_2415));
float4 l9_2423=l9_2422;
if (l9_2353)
{
l9_2423=mix(l9_2354,l9_2423,float4(l9_2357));
}
float4 l9_2424=l9_2423;
l9_2338=l9_2424;
float4 l9_2425=l9_2338;
l9_2233*=l9_2425;
}
}
}
float4 l9_2426=float4(0.0);
float3 l9_2427=float3(0.0);
float3 l9_2428=float3(0.0);
float l9_2429=0.0;
float l9_2430=0.0;
if (N2_ENABLE_COLORMINMAX)
{
l9_2427=mix(N2_colorMinStart,N2_colorMaxStart,l9_2228);
l9_2428=mix(N2_colorMinEnd,N2_colorMaxEnd,l9_2228);
}
else
{
l9_2427=N2_colorStart;
l9_2428=N2_colorEnd;
}
if (N2_ENABLE_ALPHAMINMAX)
{
l9_2429=mix(N2_alphaMinStart,N2_alphaMaxStart,l9_2229);
l9_2430=mix(N2_alphaMinEnd,N2_alphaMaxEnd,l9_2229);
}
else
{
l9_2429=N2_alphaStart;
l9_2430=N2_alphaEnd;
}
l9_2427=mix(l9_2427,l9_2428,float3(l9_2224));
l9_2429=mix(l9_2429,l9_2430,l9_2224);
l9_2426=float4(l9_2427,l9_2429);
float4 l9_2431=float4(0.0);
float2 l9_2432=float2(0.0);
if (N2_ENABLE_BASETEXTURE)
{
if (N2_ENABLE_FLIPBOOK)
{
float2 l9_2433=tempGlobals.Surface_UVCoord0;
l9_2432=l9_2433;
float2 l9_2434=l9_2432;
float l9_2435=fast::max(N2_timeValuesIn.x,1e-06);
float l9_2436=fast::max(N2_timeValuesIn.y,1e-06);
float l9_2437=N2_timeValuesIn.z;
if (N2_ENABLE_FLIPBOOKBYLIFE)
{
float l9_2438=mix(l9_2435,l9_2436,l9_2231);
l9_2437/=l9_2438;
}
float l9_2439=floor((N2_flipBookRandomStart+1.0)*l9_2230);
float2 l9_2440=l9_2432;
float2 l9_2441=N2_gridSize;
float l9_2442=N2_numValidFrames;
float l9_2443=l9_2439;
float l9_2444=N2_flipBookSpeedMult;
float l9_2445=l9_2437;
float l9_2446=floor(l9_2441.x);
float l9_2447=floor(l9_2441.y);
float l9_2448=1.0/l9_2446;
float l9_2449=1.0/l9_2447;
float l9_2450=fast::min(l9_2446*l9_2447,floor(l9_2442));
float l9_2451=floor(mod((l9_2445*l9_2444)+floor(l9_2443),l9_2450));
float l9_2452=floor(l9_2451/l9_2446);
float l9_2453=mod(l9_2451,l9_2446);
float2 l9_2454=float2((l9_2448*l9_2440.x)+(l9_2453*l9_2448),((1.0-l9_2449)-(l9_2452*l9_2449))+(l9_2449*l9_2440.y));
l9_2432=l9_2454;
float2 l9_2455=l9_2432;
...
{
l9_2460=in.varStereoViewID;
}
int l9_2461=l9_2460;
l9_2457=l9_2461;
}
int l9_2462=l9_2457;
int l9_2463=mainTextureLayout_tmp;
int l9_2464=l9_2462;
float2 l9_2465=l9_2455;
bool l9_2466=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 l9_2467=(*sc_set0.UserUniforms).mainTextureTransform;
int2 l9_2468=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool l9_2469=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 l9_2470=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool l9_2471=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 l9_2472=(*sc_set0.UserUniforms).mainTextureBorderColor;
float l9_2473=0.0;
...
float4 l9_2540=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_2539.xy,bias(l9_2533));
...
if (N2_ENABLE_FLIPBOOKBLEND)
{
float2 l9_2544=l9_2434;
float2 l9_2545=N2_gridSize;
float l9_2546=N2_numValidFrames;
float l9_2547=floor(mod(l9_2439+1.0,N2_numValidFrames));
float l9_2548=N2_flipBookSpeedMult;
float l9_2549=l9_2437;
float l9_2550=floor(l9_2545.x);
float l9_2551=floor(l9_2545.y);
float l9_2552=1.0/l9_2550;
float l9_2553=1.0/l9_2551;
float l9_2554=fast::min(l9_2550*l9_2551,floor(l9_2546));
float l9_2555=floor(mod((l9_2549*l9_2548)+floor(l9_2547),l9_2554));
float l9_2556=floor(l9_2555/l9_2550);
float l9_2557=mod(l9_2555,l9_2550);
float2 l9_2558=float2((l9_2552*l9_2544.x)+(l9_2557*l9_2552),((1.0-l9_2553)-(l9_2556*l9_2553))+(l9_2553*l9_2544.y));
l9_2434=l9_2558;
float4 l9_2559=l9_2431;
float2 l9_2560=l9_2434;
...
int l9_2567=l9_2562;
int l9_2568=mainTextureLayout_tmp;
int l9_2569=l9_2567;
float2 l9_2570=l9_2560;
bool l9_2571=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 l9_2572=(*sc_set0.UserUniforms).mainTextureTransform;
int2 l9_2573=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool l9_2574=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 l9_2575=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool l9_2576=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 l9_2577=(*sc_set0.UserUniforms).mainTextureBorderColor;
float l9_2578=0.0;
bool l9_2579=l9_2576&&(!l9_2574);
float l9_2580=1.0;
float l9_2581=l9_2570.x;
int l9_2582=l9_2573.x;
if (l9_2582==1)
{
...
l9_2570.x=l9_2581;
float l9_2586=l9_2570.y;
int l9_2587=l9_2573.y;
if (l9_2587==1)
{
l9_2586=fract(l9_2586);
}
else
{
if (l9_2587==2)
{
float l9_2588=fract(l9_2586);
float l9_2589=l9_2586-l9_2588;
float l9_2590=step(0.25,fract(l9_2589*0.5));
l9_2586=mix(l9_2588,1.0-l9_2588,fast::clamp(l9_2590,0.0,1.0));
}
}
l9_2570.y=l9_2586;
if (l9_2574)
{
bool l9_2591=l9_2576;
bool l9_2592;
if (l9_2591)
{
l9_2592=l9_2573.x==3;
...
float l9_2593=l9_2570.x;
float l9_2594=l9_2575.x;
float l9_2595=l9_2575.z;
bool l9_2596=l9_2592;
float l9_2597=l9_2580;
...
float l9_2602=l9_2570.y;
float l9_2603=l9_2575.y;
float l9_2604=l9_2575.w;
bool l9_2605=l9_2601;
float l9_2606=l9_2580;
...
float2 l9_2609=l9_2570;
bool l9_2610=l9_2571;
float3x3 l9_2611=l9_2572;
if (l9_2610)
{
l9_2609=float2((l9_2611*float3(l9_2609,1.0)).xy);
}
float2 l9_2612=l9_2609;
l9_2570=l9_2612;
float l9_2613=l9_2570.x;
int l9_2614=l9_2573.x;
bool l9_2615=l9_2579;
float l9_2616=l9_2580;
...
l9_2570.x=l9_2613;
l9_2580=l9_2616;
float l9_2624=l9_2570.y;
int l9_2625=l9_2573.y;
bool l9_2626=l9_2579;
float l9_2627=l9_2580;
if ((l9_2625==0)||(l9_2625==3))
{
float l9_2628=l9_2624;
float l9_2629=0.0;
float l9_2630=1.0;
bool l9_2631=l9_2626;
float l9_2632=l9_2627;
...
l9_2570.y=l9_2624;
l9_2580=l9_2627;
float2 l9_2635=l9_2570;
int l9_2636=l9_2568;
int l9_2637=l9_2569;
float l9_2638=l9_2578;
float2 l9_2639=l9_2635;
int l9_2640=l9_2636;
int l9_2641=l9_2637;
float3 l9_2642=float3(0.0);
if (l9_2640==0)
{
l9_2642=float3(l9_2639,0.0);
}
else
{
if (l9_2640==1)
{
l9_2642=float3(l9_2639.x,(l9_2639.y*0.5)+(0.5-(float(l9_2641)*0.5)),0.0);
}
else
{
l9_2642=float3(l9_2639,float(l9_2641));
}
}
float3 l9_2643=l9_2642;
float3 l9_2644=l9_2643;
float4 l9_2645=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_2644.xy,bias(l9_2638));
float4 l9_2646=l9_2645;
if (l9_2576)
{
l9_2646=mix(l9_2577,l9_2646,float4(l9_2580));
}
float4 l9_2647=l9_2646;
l9_2561=l9_2647;
float4 l9_2648=l9_2561;
l9_2431=mix(l9_2559,l9_2648,float4(fract((l9_2437*N2_flipBookSpeedMult)+l9_2439)));
}
}
}
float4 l9_2649=float4(1.0);
if (N2_ENABLE_COLORRAMP)
{
float l9_2650=ceil(l9_2224*N2_texSize.x)/N2_texSize.x;
float l9_2651=l9_2650;
if (N2_ENABLE_NORANDOFFSET)
{
float2 l9_2652=tempGlobals.Surface_UVCoord0;
l9_2651+=(l9_2652.x/N2_texSize.x);
}
float2 l9_2653=float2(l9_2651,0.5);
...
{
l9_2658=in.varStereoViewID;
}
int l9_2659=l9_2658;
l9_2655=l9_2659;
}
int l9_2660=l9_2655;
int l9_2661=colorRampTextureLayout_tmp;
int l9_2662=l9_2660;
float2 l9_2663=l9_2653;
bool l9_2664=(int(SC_USE_UV_TRANSFORM_colorRampTexture_tmp)!=0);
float3x3 l9_2665=(*sc_set0.UserUniforms).colorRampTextureTransform;
int2 l9_2666=int2(SC_SOFTWARE_WRAP_MODE_U_colorRampTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_colorRampTexture_tmp);
bool l9_2667=(int(SC_USE_UV_MIN_MAX_colorRampTexture_tmp)!=0);
float4 l9_2668=(*sc_set0.UserUniforms).colorRampTextureUvMinMax;
bool l9_2669=(int(SC_USE_CLAMP_TO_BORDER_colorRampTexture_tmp)!=0);
float4 l9_2670=(*sc_set0.UserUniforms).colorRampTextureBorderColor;
float l9_2671=0.0;
bool l9_2672=l9_2669&&(!l9_2667);
float l9_2673=1.0;
float l9_2674=l9_2663.x;
int l9_2675=l9_2666.x;
if (l9_2675==1)
{
...
l9_2663.x=l9_2674;
float l9_2679=l9_2663.y;
int l9_2680=l9_2666.y;
if (l9_2680==1)
{
l9_2679=fract(l9_2679);
}
else
{
if (l9_2680==2)
{
float l9_2681=fract(l9_2679);
float l9_2682=l9_2679-l9_2681;
float l9_2683=step(0.25,fract(l9_2682*0.5));
l9_2679=mix(l9_2681,1.0-l9_2681,fast::clamp(l9_2683,0.0,1.0));
}
}
l9_2663.y=l9_2679;
if (l9_2667)
{
bool l9_2684=l9_2669;
bool l9_2685;
if (l9_2684)
{
l9_2685=l9_2666.x==3;
...
float l9_2686=l9_2663.x;
float l9_2687=l9_2668.x;
float l9_2688=l9_2668.z;
bool l9_2689=l9_2685;
float l9_2690=l9_2673;
...
float l9_2695=l9_2663.y;
float l9_2696=l9_2668.y;
float l9_2697=l9_2668.w;
bool l9_2698=l9_2694;
float l9_2699=l9_2673;
...
float2 l9_2702=l9_2663;
bool l9_2703=l9_2664;
float3x3 l9_2704=l9_2665;
if (l9_2703)
{
l9_2702=float2((l9_2704*float3(l9_2702,1.0)).xy);
}
float2 l9_2705=l9_2702;
l9_2663=l9_2705;
float l9_2706=l9_2663.x;
int l9_2707=l9_2666.x;
bool l9_2708=l9_2672;
float l9_2709=l9_2673;
...
l9_2663.x=l9_2706;
l9_2673=l9_2709;
float l9_2717=l9_2663.y;
int l9_2718=l9_2666.y;
bool l9_2719=l9_2672;
float l9_2720=l9_2673;
...
l9_2663.y=l9_2717;
l9_2673=l9_2720;
float2 l9_2728=l9_2663;
int l9_2729=l9_2661;
int l9_2730=l9_2662;
float l9_2731=l9_2671;
float2 l9_2732=l9_2728;
int l9_2733=l9_2729;
int l9_2734=l9_2730;
float3 l9_2735=float3(0.0);
if (l9_2733==0)
{
l9_2735=float3(l9_2732,0.0);
}
else
{
if (l9_2733==1)
{
l9_2735=float3(l9_2732.x,(l9_2732.y*0.5)+(0.5-(float(l9_2734)*0.5)),0.0);
}
else
{
l9_2735=float3(l9_2732,float(l9_2734));
}
}
float3 l9_2736=l9_2735;
float3 l9_2737=l9_2736;
float4 l9_2738=sc_set0.colorRampTexture.sample(sc_set0.colorRampTextureSmpSC,l9_2737.xy,bias(l9_2731));
float4 l9_2739=l9_2738;
if (l9_2669)
{
l9_2739=mix(l9_2670,l9_2739,float4(l9_2673));
}
float4 l9_2740=l9_2739;
l9_2654=l9_2740;
float4 l9_2741=l9_2654;
l9_2649=l9_2741*N2_colorRampMult;
}
float4 l9_2742=float4(1.0);
float4 l9_2743=float4(1.0);
if (N2_ENABLE_BASETEXTURE)
{
if (N2_ENABLE_FLIPBOOK)
{
...
{
float2 l9_2744=N2_uv;
float4 l9_2745=float4(0.0);
int l9_2746;
if ((int(mainTextureHasSwappedViews_tmp)!=0))
{
int l9_2747=0;
...
int l9_2751=l9_2746;
int l9_2752=mainTextureLayout_tmp;
int l9_2753=l9_2751;
float2 l9_2754=l9_2744;
bool l9_2755=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 l9_2756=(*sc_set0.UserUniforms).mainTextureTransform;
int2 l9_2757=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool l9_2758=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 l9_2759=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool l9_2760=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 l9_2761=(*sc_set0.UserUniforms).mainTextureBorderColor;
float l9_2762=0.0;
bool l9_2763=l9_2760&&(!l9_2758);
float l9_2764=1.0;
float l9_2765=l9_2754.x;
int l9_2766=l9_2757.x;
if (l9_2766==1)
{
l9_2765=fract(l9_2765);
}
else
{
if (l9_2766==2)
{
float l9_2767=fract(l9_2765);
float l9_2768=l9_2765-l9_2767;
float l9_2769=step(0.25,fract(l9_2768*0.5));
l9_2765=mix(l9_2767,1.0-l9_2767,fast::clamp(l9_2769,0.0,1.0));
}
}
l9_2754.x=l9_2765;
float l9_2770=l9_2754.y;
int l9_2771=l9_2757.y;
if (l9_2771==1)
{
l9_2770=fract(l9_2770);
}
else
{
if (l9_2771==2)
{
float l9_2772=fract(l9_2770);
float l9_2773=l9_2770-l9_2772;
float l9_2774=step(0.25,fract(l9_2773*0.5));
l9_2770=mix(l9_2772,1.0-l9_2772,fast::clamp(l9_2774,0.0,1.0));
}
}
l9_2754.y=l9_2770;
if (l9_2758)
{
bool l9_2775=l9_2760;
bool l9_2776;
if (l9_2775)
{
l9_2776=l9_2757.x==3;
...
float l9_2777=l9_2754.x;
float l9_2778=l9_2759.x;
float l9_2779=l9_2759.z;
bool l9_2780=l9_2776;
float l9_2781=l9_2764;
float l9_2782=fast::clamp(l9_2777,l9_2778,l9_2779);
float l9_2783=step(abs(l9_2777-l9_2782),9.9999997e-06);
l9_2781*=(l9_2783+((1.0-float(l9_2780))*(1.0-l9_2783)));
l9_2777=l9_2782;
l9_2754.x=l9_2777;
l9_2764=l9_2781;
bool l9_2784=l9_2760;
bool l9_2785;
if (l9_2784)
{
l9_2785=l9_2757.y==3;
...
float l9_2786=l9_2754.y;
float l9_2787=l9_2759.y;
float l9_2788=l9_2759.w;
bool l9_2789=l9_2785;
float l9_2790=l9_2764;
float l9_2791=fast::clamp(l9_2786,l9_2787,l9_2788);
float l9_2792=step(abs(l9_2786-l9_2791),9.9999997e-06);
l9_2790*=(l9_2792+((1.0-float(l9_2789))*(1.0-l9_2792)));
l9_2786=l9_2791;
l9_2754.y=l9_2786;
l9_2764=l9_2790;
}
float2 l9_2793=l9_2754;
bool l9_2794=l9_2755;
float3x3 l9_2795=l9_2756;
if (l9_2794)
{
l9_2793=float2((l9_2795*float3(l9_2793,1.0)).xy);
}
float2 l9_2796=l9_2793;
l9_2754=l9_2796;
float l9_2797=l9_2754.x;
int l9_2798=l9_2757.x;
bool l9_2799=l9_2763;
float l9_2800=l9_2764;
...
l9_2754.x=l9_2797;
l9_2764=l9_2800;
float l9_2808=l9_2754.y;
int l9_2809=l9_2757.y;
bool l9_2810=l9_2763;
float l9_2811=l9_2764;
...
l9_2754.y=l9_2808;
l9_2764=l9_2811;
float2 l9_2819=l9_2754;
int l9_2820=l9_2752;
int l9_2821=l9_2753;
float l9_2822=l9_2762;
...
float4 l9_2829=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_2828.xy,bias(l9_2822));
float4 l9_2830=l9_2829;
if (l9_2760)
{
l9_2830=mix(l9_2761,l9_2830,float4(l9_2764));
}
float4 l9_2831=l9_2830;
l9_2745=l9_2831;
float4 l9_2832=l9_2745;
l9_2742=l9_2832;
}
}
if (N2_ENABLE_COLORRAMP)
...
N2_result=(l9_2742*l9_2426)*l9_2743;
if (N2_ENABLE_TRAILS)
{
if (N2_isTrail>0.0)
{
N2_result=(l9_2233*l9_2426)*l9_2743;
N2_result.w*=l9_2232;
}
}
if (N2_ENABLE_SCREENFADE)
...
if (N2_ENABLE_ALPHADISSOLVE)
{
float l9_2833=l9_2224*N2_alphaDissolveMult;
N2_result.w=fast::clamp(N2_result.w-l9_2833,0.0,1.0);
}
if (N2_ENABLE_BLACKASALPHA)
{
float l9_2834=length(N2_result.xyz);
N2_result.w=l9_2834;
if (N2_ENABLE_TRAILS)
{
N2_result.w*=l9_2232;
...
if (N2_ENABLE_PREMULTIPLIEDCOLOR)
{
float3 l9_2835=N2_result.xyz*N2_result.w;
N2_result=float4(l9_2835.x,l9_2835.y,l9_2835.z,N2_result.w);
}
l9_2198=N2_result;
l9_2172=l9_2198;
param_1=l9_2172;
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_2838=fast::clamp(l9_2837.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_2838=fast::clamp(dot(l9_2837.xyz,float3(l9_2837.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_2838=(1.0-dot(l9_2837.xyz,float3(0.33333001)))*l9_2837.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_2838=(1.0-fast::clamp(dot(l9_2837.xyz,float3(1.0)),0.0,1.0))*l9_2837.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_2838=fast::clamp(dot(l9_2837.xyz,float3(1.0)),0.0,1.0)*l9_2837.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_2838=fast::clamp(dot(l9_2837.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_2838=dot(l9_2837.xyz,float3(0.33333001))*l9_2837.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_2838=1.0-fast::clamp(dot(l9_2837.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_2841=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_2840;
float3 l9_2842=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_2836.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_2843=float4(l9_2842.x,l9_2842.y,l9_2842.z,l9_2841);
param_4=l9_2843;
}
else
{
...
{
float4 l9_2844=param_4;
float4 l9_2845=float4(0.0);
float4 l9_2846=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_2847=out.sc_FragData0;
l9_2846=l9_2847;
}
else
{
float4 l9_2848=gl_FragCoord;
float2 l9_2849=l9_2848.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
{
l9_2853=in.varStereoViewID;
}
int l9_2854=l9_2853;
int l9_2855=l9_2854;
float3 l9_2856=float3(l9_2850,0.0);
int l9_2857=l9_2852;
int l9_2858=l9_2855;
if (l9_2857==1)
{
l9_2856.y=((2.0*l9_2856.y)+float(l9_2858))-1.0;
}
float2 l9_2859=l9_2856.xy;
l9_2851=l9_2859;
}
else
{
...
float2 l9_2860=l9_2851;
float2 l9_2861=l9_2860;
float2 l9_2862=l9_2861;
float2 l9_2863=l9_2862;
float l9_2864=0.0;
int l9_2865;
if ((int(sc_ScreenTextureHasSwappedViews_tmp)!=0))
{
...
int l9_2872=sc_ScreenTextureLayout_tmp;
int l9_2873=l9_2870;
...
if (l9_2876==0)
{
l9_2878=float3(l9_2875,0.0);
}
else
{
if (l9_2876==1)
{
l9_2878=float3(l9_2875.x,(l9_2875.y*0.5)+(0.5-(float(l9_2877)*0.5)),0.0);
}
else
{
l9_2878=float3(l9_2875,float(l9_2877));
}
}
float3 l9_2879=l9_2878;
float3 l9_2880=l9_2879;
float4 l9_2881=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_2880.xy,bias(l9_2874));
float4 l9_2882=l9_2881;
float4 l9_2883=l9_2882;
l9_2846=l9_2883;
}
float4 l9_2884=l9_2846;
float3 l9_2885=l9_2884.xyz;
float3 l9_2886=l9_2885;
float3 l9_2887=l9_2844.xyz;
float3 l9_2888=definedBlend(l9_2886,l9_2887,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_2845=float4(l9_2888.x,l9_2888.y,l9_2888.z,l9_2845.w);
float3 l9_2889=mix(l9_2885,l9_2845.xyz,float3(l9_2844.w));
l9_2845=float4(l9_2889.x,l9_2889.y,l9_2889.z,l9_2845.w);
l9_2845.w=1.0;
float4 l9_2890=l9_2845;
param_4=l9_2890;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_2891=float4(in.varScreenPos.xyz,1.0);
param_4=l9_2891;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_2892=gl_FragCoord;
float l9_2893=fast::clamp(abs(l9_2892.z),0.0,1.0);
float4 l9_2894=float4(l9_2893,1.0-l9_2893,1.0,1.0);
param_4=l9_2894;
}
else
{
float4 l9_2895=param_4;
float4 l9_2896=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_2896=float4(mix(float3(1.0),l9_2895.xyz,float3(l9_2895.w)),l9_2895.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_2897=l9_2895.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_2897=fast::clamp(l9_2897,0.0,1.0);
}
l9_2896=float4(l9_2895.xyz*l9_2897,l9_2897);
}
else
{
l9_2896=l9_2895;
...
float4 l9_2902=param_6;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_2902.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_2902;
return out;
}
} // FRAGMENT SHADER
