...
//}
//ubo int UserUniforms 0:26:4736 {
//float4 sc_Time 1376
...
//float3x3 noiseTexTransform 4304
//float4 noiseTexUvMinMax 4352
//float4 noiseTexBorderColor 4368
//float2 Tweak_N15 4384
//float speed 4392
//float simplexScale 4396
//float Tweak_N19 4400
//float Tweak_N80 4404
//float Tweak_N52 4408
//float highfreqScale 4412
//float smoothness 4416
//float2 Port_Direction_N003 4424
//float Port_Default_N051 4432
//float Port_Input1_N046 4436
//float Port_RangeMinA_N014 4440
//float Port_RangeMaxA_N014 4444
//float Port_RangeMinB_N014 4448
//float Port_RangeMaxB_N014 4452
//float2 Port_Scale_N038 4456
//float2 Port_Input1_N011 4464
//float2 Port_Scale_N062 4472
//float Port_Input1_N037 4480
//float Port_Input1_N057 4484
//float Port_RangeMinA_N013 4488
//float Port_RangeMaxA_N013 4492
//float Port_RangeMinB_N013 4496
//float Port_RangeMaxB_N013 4500
//float Port_Input1_N031 4504
//float Port_Input2_N031 4508
//float Port_Input1_N050 4512
//float Port_RangeMinA_N009 4516
//float Port_RangeMaxA_N009 4520
//float Port_RangeMinB_N009 4524
//float Port_RangeMaxB_N009 4528
//float Port_Input1_N000 4532
//float Port_Input2_N000 4536
//float2 Port_Scale_N045 4544
//float Port_Input1_N027 4552
//float2 Port_Input1_N018 4560
//float Port_Input1_N094 4568
//float2 Port_Direction_N079 4576
//float2 Port_Input1_N020 4584
//float Port_Input1_N093 4592
//float Port_Input1_N069 4596
//float Port_Input1_N005 4600
//float2 Port_Scale_N032 4608
//float Port_RangeMinA_N022 4616
//float Port_RangeMaxA_N022 4620
//float Port_RangeMinB_N022 4624
//float Port_RangeMaxB_N022 4628
//float Port_Input1_N007 4632
//float Port_Input2_N007 4636
//float Port_Input1_N043 4640
//float Port_Input2_N043 4644
//float Port_RangeMinA_N048 4648
//float Port_RangeMaxA_N048 4652
//float Port_RangeMinB_N048 4656
//float Port_RangeMaxB_N048 4660
//float Port_Input1_N072 4664
//float Port_Input2_N072 4668
//float Port_Input1_N010 4672
//float Port_Input2_N010 4676
//float Port_RangeMinA_N036 4680
//float Port_RangeMaxA_N036 4684
//float Port_RangeMinB_N036 4688
//float Port_RangeMaxB_N036 4692
//float Port_Input1_N039 4696
//float Port_Input2_N039 4700
//float Port_RangeMinA_N077 4704
//float Port_RangeMaxA_N077 4708
//float Port_RangeMinB_N077 4712
//float Port_RangeMaxB_N077 4716
//float Port_Input1_N078 4720
//float Port_Input2_N078 4724
//float Port_Input1_N074 4728
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_noiseTex 32 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_noiseTex 34 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_noiseTex 36 0
//spec_const bool Tweak_N71 37 0
//spec_const bool UseViewSpaceDepthVariant 38 1
//spec_const bool intensityTextureHasSwappedViews 39 0
//spec_const bool noiseTexHasSwappedViews 40 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_noiseTex 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_noiseTex 75 -1
//spec_const int intensityTextureLayout 76 0
//spec_const int noiseTexLayout 77 0
...
constant bool SC_USE_CLAMP_TO_BORDER_noiseTex [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_noiseTex [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_noiseTex [[function_constant(36)]];
...
constant bool Tweak_N71 [[function_constant(37)]];
...
constant bool noiseTexHasSwappedViews [[function_constant(40)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_noiseTex [[function_constant(73)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_noiseTex [[function_constant(75)]];
...
constant int noiseTexLayout [[function_constant(77)]];
...
float highfreqScale;
float smoothness;
float2 Port_Direction_N003;
float Port_Default_N051;
...
float2 Port_Scale_N038;
float2 Port_Input1_N011;
float2 Port_Scale_N062;
...
float Port_Input2_N039;
float Port_RangeMinA_N077;
float Port_RangeMaxA_N077;
float Port_RangeMinB_N077;
float Port_RangeMaxB_N077;
float Port_Input1_N078;
float Port_Input2_N078;
float Port_Input1_N074;
};
struct sc_Bone_t
{
float4 boneMatrix[3];
...
float2 UVCoord_N63=float2(0.0);
UVCoord_N63=Globals.Surface_UVCoord0;
float2 Output_N15=float2(0.0);
float2 param=(*sc_set0.UserUniforms).Tweak_N15;
Output_N15=param;
float2 Output_N35=float2(0.0);
Output_N35=UVCoord_N63*Output_N15;
float Result_N51=0.0;
float param_1=0.0;
float param_2=(*sc_set0.UserUniforms).Port_Default_N051;
float param_3;
if ((int(Tweak_N71_tmp)!=0))
{
float l9_0=0.0;
float l9_1=(*sc_set0.UserUniforms).speed;
l9_0=l9_1;
param_1=l9_0;
param_3=param_1;
}
...
Output_N46=Result_N51*(*sc_set0.UserUniforms).Port_Input1_N046;
float2 CoordsOut_N3=float2(0.0);
CoordsOut_N3=Output_N35+((*sc_set0.UserUniforms).Port_Direction_N003*(Globals.gTimeElapsed*Output_N46));
float Output_N54=0.0;
float param_4=(*sc_set0.UserUniforms).simplexScale;
Output_N54=param_4;
float2 Output_N29=float2(0.0);
Output_N29=CoordsOut_N3*float2(Output_N54);
float4 Color_N60=float4(0.0);
int l9_2;
...
int l9_7=l9_2;
int param_5=noiseTexLayout_tmp;
int param_6=l9_7;
float2 param_7=Output_N29;
bool param_8=(int(SC_USE_UV_TRANSFORM_noiseTex_tmp)!=0);
float3x3 param_9=(*sc_set0.UserUniforms).noiseTexTransform;
int2 param_10=int2(SC_SOFTWARE_WRAP_MODE_U_noiseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_noiseTex_tmp);
bool param_11=(int(SC_USE_UV_MIN_MAX_noiseTex_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).noiseTexUvMinMax;
bool param_13=(int(SC_USE_CLAMP_TO_BORDER_noiseTex_tmp)!=0);
float4 param_14=(*sc_set0.UserUniforms).noiseTexBorderColor;
float param_15=0.0;
bool l9_8=param_13&&(!param_11);
float l9_9=1.0;
float l9_10=param_7.x;
int l9_11=param_10.x;
if (l9_11==1)
{
l9_10=fract(l9_10);
}
...
param_7.x=l9_10;
float l9_15=param_7.y;
int l9_16=param_10.y;
if (l9_16==1)
{
l9_15=fract(l9_15);
}
...
float l9_22=param_7.x;
float l9_23=param_12.x;
float l9_24=param_12.z;
bool l9_25=l9_21;
float l9_26=l9_9;
...
float l9_31=param_7.y;
float l9_32=param_12.y;
float l9_33=param_12.w;
bool l9_34=l9_30;
float l9_35=l9_9;
...
float2 l9_38=param_7;
bool l9_39=param_8;
float3x3 l9_40=param_9;
if (l9_39)
{
...
param_7.y=l9_53;
l9_9=l9_56;
float2 l9_64=param_7;
int l9_65=param_5;
int l9_66=param_6;
float l9_67=param_15;
float2 l9_68=l9_64;
int l9_69=l9_65;
int l9_70=l9_66;
...
float3 l9_72=l9_71;
float3 l9_73=l9_72;
float4 l9_74=sc_set0.noiseTex.sample(sc_set0.noiseTexSmpSC,l9_73.xy,bias(l9_67));
float4 l9_75=l9_74;
if (param_13)
{
l9_75=mix(param_14,l9_75,float4(l9_9));
}
float4 l9_76=l9_75;
Color_N60=l9_76;
float Value1_N84=0.0;
float Value2_N84=0.0;
float4 param_16=Color_N60;
float param_17=param_16.x;
float param_18=param_16.y;
Value1_N84=param_17;
Value2_N84=param_18;
float ValueOut_N14=0.0;
ValueOut_N14=(((Value2_N84-(*sc_set0.UserUniforms).Port_RangeMinA_N014)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N014-(*sc_set0.UserUniforms).Port_RangeMinA_N014)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N014-(*sc_set0.UserUniforms).Port_RangeMinB_N014))+(*sc_set0.UserUniforms).Port_RangeMinB_N014;
float Output_N19=0.0;
float param_19=(*sc_set0.UserUniforms).Tweak_N19;
Output_N19=param_19;
float2 Output_N2=float2(0.0);
Output_N2=float2(Output_N19)*Output_N35;
float Result_N82=0.0;
float param_20=0.0;
float param_21=0.0;
...
{
float l9_77=0.0;
float l9_78=(*sc_set0.UserUniforms).speed;
l9_77=l9_78;
float l9_79=0.0;
l9_79=param_23.gTimeElapsed*l9_77;
float l9_80=0.0;
float l9_81=(*sc_set0.UserUniforms).Tweak_N80;
l9_80=l9_81;
float l9_82=0.0;
l9_82=l9_79+l9_80;
param_20=l9_82;
...
{
float l9_83=0.0;
float l9_84=(*sc_set0.UserUniforms).Tweak_N80;
l9_83=l9_84;
param_21=l9_83;
param_22=param_21;
}
Result_N82=param_22;
float Noise_N38=0.0;
float2 param_24=Output_N2;
float2 param_25=(*sc_set0.UserUniforms).Port_Scale_N038;
float param_26=Result_N82;
float param_27;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_24.x=floor(param_24.x*10000.0)*9.9999997e-05;
param_24.y=floor(param_24.y*10000.0)*9.9999997e-05;
float2 l9_85=floor(param_24*param_25);
float2 l9_86=fract(param_24*param_25);
float3 l9_87=float3(8.0,0.0,0.0);
int l9_88=-1;
...
if (l9_89<=1)
{
float2 l9_90=float2(float(l9_89),float(l9_88));
float2 l9_91=l9_90+l9_85;
float l9_92=abs(param_26)+1000.0;
float2 l9_93=VoronoiHash2D(l9_91,l9_92);
float2 l9_94=l9_93;
float l9_95=distance(l9_90+l9_94,l9_86);
if (l9_95<l9_87.x)
{
l9_87=float3(l9_95,l9_94.x,l9_94.y);
param_27=l9_87.x;
param_27=floor(param_27*10000.0)*9.9999997e-05;
}
l9_89++;
continue;
}
...
Output_N11=Output_N2+(*sc_set0.UserUniforms).Port_Input1_N011;
float Output_N37=0.0;
Output_N37=Result_N82+(*sc_set0.UserUniforms).Port_Input1_N037;
float Noise_N62=0.0;
float2 param_28=Output_N11;
float2 param_29=(*sc_set0.UserUniforms).Port_Scale_N062;
float param_30=Output_N37;
float param_31;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_28.x=floor(param_28.x*10000.0)*9.9999997e-05;
param_28.y=floor(param_28.y*10000.0)*9.9999997e-05;
float2 l9_96=floor(param_28*param_29);
float2 l9_97=fract(param_28*param_29);
float3 l9_98=float3(8.0,0.0,0.0);
int l9_99=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_99<=1)
...
if (l9_100<=1)
{
float2 l9_101=float2(float(l9_100),float(l9_99));
float2 l9_102=l9_101+l9_96;
float l9_103=abs(param_30)+1000.0;
float2 l9_104=VoronoiHash2D(l9_102,l9_103);
float2 l9_105=l9_104;
float l9_106=distance(l9_101+l9_105,l9_97);
if (l9_106<l9_98.x)
{
l9_98=float3(l9_106,l9_105.x,l9_105.y);
param_31=l9_98.x;
param_31=floor(param_31*10000.0)*9.9999997e-05;
}
l9_100++;
continue;
}
...
Output_N44=Noise_N38+Noise_N62;
float Output_N57=0.0;
Output_N57=Output_N44*(*sc_set0.UserUniforms).Port_Input1_N057;
float Output_N52=0.0;
float param_32=(*sc_set0.UserUniforms).Tweak_N52;
Output_N52=param_32;
...
{
l9_107=pow(Output_N57,Output_N52);
}
Output_N47=l9_107;
float ValueOut_N13=0.0;
ValueOut_N13=(((Output_N47-(*sc_set0.UserUniforms).Port_RangeMinA_N013)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N013-(*sc_set0.UserUniforms).Port_RangeMinA_N013)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N013-(*sc_set0.UserUniforms).Port_RangeMinB_N013))+(*sc_set0.UserUniforms).Port_RangeMinB_N013;
float Output_N31=0.0;
Output_N31=fast::clamp(ValueOut_N13+0.001,(*sc_set0.UserUniforms).Port_Input1_N031+0.001,(*sc_set0.UserUniforms).Port_Input2_N031+0.001)-0.001;
float Output_N30=0.0;
Output_N30=ValueOut_N14*Output_N31;
float Output_N50=0.0;
Output_N50=Output_N30*(*sc_set0.UserUniforms).Port_Input1_N050;
float ValueOut_N9=0.0;
ValueOut_N9=(((Output_N47-(*sc_set0.UserUniforms).Port_RangeMinA_N009)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N009-(*sc_set0.UserUniforms).Port_RangeMinA_N009)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N009-(*sc_set0.UserUniforms).Port_RangeMinB_N009))+(*sc_set0.UserUniforms).Port_RangeMinB_N009;
float Output_N0=0.0;
Output_N0=fast::clamp(ValueOut_N9+0.001,(*sc_set0.UserUniforms).Port_Input1_N000+0.001,(*sc_set0.UserUniforms).Port_Input2_N000+0.001)-0.001;
float Output_N28=0.0;
float param_33=(*sc_set0.UserUniforms).highfreqScale;
Output_N28=param_33;
float2 Output_N25=float2(0.0);
Output_N25=Output_N35*float2(Output_N28);
float Output_N27=0.0;
Output_N27=Result_N82*(*sc_set0.UserUniforms).Port_Input1_N027;
float Noise_N45=0.0;
float2 param_34=Output_N25;
float2 param_35=(*sc_set0.UserUniforms).Port_Scale_N045;
float param_36=Output_N27;
float param_37;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_34.x=floor(param_34.x*10000.0)*9.9999997e-05;
param_34.y=floor(param_34.y*10000.0)*9.9999997e-05;
float2 l9_108=floor(param_34*param_35);
float2 l9_109=fract(param_34*param_35);
float3 l9_110=float3(8.0,0.0,0.0);
int l9_111=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_111<=1)
...
if (l9_112<=1)
{
float2 l9_113=float2(float(l9_112),float(l9_111));
float2 l9_114=l9_113+l9_108;
float l9_115=abs(param_36)+1000.0;
float2 l9_116=VoronoiHash2D(l9_114,l9_115);
float2 l9_117=l9_116;
float l9_118=distance(l9_113+l9_117,l9_109);
if (l9_118<l9_110.x)
{
l9_110=float3(l9_118,l9_117.x,l9_117.y);
param_37=l9_110.x;
param_37=floor(param_37*10000.0)*9.9999997e-05;
}
l9_112++;
continue;
}
...
Output_N18=Output_N29+(*sc_set0.UserUniforms).Port_Input1_N018;
float2 Output_N94=float2(0.0);
Output_N94=Output_N18*float2((*sc_set0.UserUniforms).Port_Input1_N094);
...
float param_48=0.0;
bool l9_125=param_46&&(!param_44);
float l9_126=1.0;
float l9_127=param_40.x;
int l9_128=param_43.x;
if (l9_128==1)
{
l9_127=fract(l9_127);
}
...
param_40.x=l9_127;
float l9_132=param_40.y;
int l9_133=param_43.y;
if (l9_133==1)
{
l9_132=fract(l9_132);
}
...
float l9_139=param_40.x;
float l9_140=param_45.x;
float l9_141=param_45.z;
bool l9_142=l9_138;
float l9_143=l9_126;
...
float l9_148=param_40.y;
float l9_149=param_45.y;
float l9_150=param_45.w;
bool l9_151=l9_147;
float l9_152=l9_126;
...
float2 l9_155=param_40;
bool l9_156=param_41;
float3x3 l9_157=param_42;
if (l9_156)
{
...
param_40=l9_158;
float l9_159=param_40.x;
int l9_160=param_43.x;
bool l9_161=l9_125;
float l9_162=l9_126;
...
param_40.x=l9_159;
l9_126=l9_162;
float l9_170=param_40.y;
int l9_171=param_43.y;
bool l9_172=l9_125;
float l9_173=l9_126;
...
param_40.y=l9_170;
l9_126=l9_173;
float2 l9_181=param_40;
int l9_182=param_38;
int l9_183=param_39;
float l9_184=param_48;
...
float4 l9_191=sc_set0.noiseTex.sample(sc_set0.noiseTexSmpSC,l9_190.xy,bias(l9_184));
float4 l9_192=l9_191;
if (param_46)
{
l9_192=mix(param_47,l9_192,float4(l9_126));
}
float4 l9_193=l9_192;
Color_N90=l9_193;
float Value1_N91=0.0;
float4 param_49=Color_N90;
float param_50=param_49.x;
Value1_N91=param_50;
float2 CoordsOut_N79=float2(0.0);
CoordsOut_N79=Output_N35+((*sc_set0.UserUniforms).Port_Direction_N079*(Globals.gTimeElapsed*Output_N46));
float2 Output_N76=float2(0.0);
Output_N76=CoordsOut_N79*float2(Output_N54);
float2 Output_N20=float2(0.0);
Output_N20=Output_N76+(*sc_set0.UserUniforms).Port_Input1_N020;
float2 Output_N93=float2(0.0);
Output_N93=Output_N20*float2((*sc_set0.UserUniforms).Port_Input1_N093);
...
int l9_199=l9_194;
int param_51=noiseTexLayout_tmp;
int param_52=l9_199;
float2 param_53=Output_N93;
bool param_54=(int(SC_USE_UV_TRANSFORM_noiseTex_tmp)!=0);
float3x3 param_55=(*sc_set0.UserUniforms).noiseTexTransform;
int2 param_56=int2(SC_SOFTWARE_WRAP_MODE_U_noiseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_noiseTex_tmp);
bool param_57=(int(SC_USE_UV_MIN_MAX_noiseTex_tmp)!=0);
float4 param_58=(*sc_set0.UserUniforms).noiseTexUvMinMax;
bool param_59=(int(SC_USE_CLAMP_TO_BORDER_noiseTex_tmp)!=0);
float4 param_60=(*sc_set0.UserUniforms).noiseTexBorderColor;
float param_61=0.0;
bool l9_200=param_59&&(!param_57);
float l9_201=1.0;
float l9_202=param_53.x;
int l9_203=param_56.x;
if (l9_203==1)
{
l9_202=fract(l9_202);
}
...
param_53.x=l9_202;
float l9_207=param_53.y;
int l9_208=param_56.y;
if (l9_208==1)
{
l9_207=fract(l9_207);
}
...
float l9_214=param_53.x;
float l9_215=param_58.x;
float l9_216=param_58.z;
bool l9_217=l9_213;
float l9_218=l9_201;
...
float l9_223=param_53.y;
float l9_224=param_58.y;
float l9_225=param_58.w;
bool l9_226=l9_222;
float l9_227=l9_201;
...
float2 l9_230=param_53;
bool l9_231=param_54;
float3x3 l9_232=param_55;
if (l9_231)
{
...
param_53=l9_233;
float l9_234=param_53.x;
int l9_235=param_56.x;
bool l9_236=l9_200;
float l9_237=l9_201;
...
param_53.x=l9_234;
l9_201=l9_237;
float l9_245=param_53.y;
int l9_246=param_56.y;
bool l9_247=l9_200;
float l9_248=l9_201;
...
param_53.y=l9_245;
l9_201=l9_248;
float2 l9_256=param_53;
int l9_257=param_51;
int l9_258=param_52;
float l9_259=param_61;
...
float4 l9_266=sc_set0.noiseTex.sample(sc_set0.noiseTexSmpSC,l9_265.xy,bias(l9_259));
float4 l9_267=l9_266;
if (param_59)
{
l9_267=mix(param_60,l9_267,float4(l9_201));
}
float4 l9_268=l9_267;
Color_N87=l9_268;
float Value2_N89=0.0;
float4 param_62=Color_N87;
float param_63=param_62.y;
Value2_N89=param_63;
float Output_N24=0.0;
Output_N24=Value1_N91+Value2_N89;
float Output_N69=0.0;
Output_N69=Output_N24+(*sc_set0.UserUniforms).Port_Input1_N069;
float Output_N5=0.0;
Output_N5=Output_N69*(*sc_set0.UserUniforms).Port_Input1_N005;
float Output_N12=0.0;
Output_N12=Noise_N45*Output_N5;
float Noise_N32=0.0;
float2 param_64=Output_N25;
float2 param_65=(*sc_set0.UserUniforms).Port_Scale_N032;
float param_66=Output_N27;
float param_67;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_64.x=floor(param_64.x*10000.0)*9.9999997e-05;
param_64.y=floor(param_64.y*10000.0)*9.9999997e-05;
float2 l9_269=floor(param_64*param_65);
float2 l9_270=fract(param_64*param_65);
float3 l9_271=float3(8.0,0.0,0.0);
int l9_272=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_272<=1)
...
if (l9_273<=1)
{
float2 l9_274=float2(float(l9_273),float(l9_272));
float2 l9_275=l9_274+l9_269;
float l9_276=abs(param_66)+1000.0;
float2 l9_277=VoronoiHash2D(l9_275,l9_276);
float2 l9_278=l9_277;
float l9_279=distance(l9_274+l9_278,l9_270);
if (l9_279<l9_271.x)
{
l9_271=float3(l9_279,l9_278.x,l9_278.y);
param_67=l9_271.x;
param_67=floor(param_67*10000.0)*9.9999997e-05;
}
l9_273++;
continue;
}
...
Output_N33=Noise_N32*Value1_N84;
float ValueOut_N22=0.0;
ValueOut_N22=(((Output_N47-(*sc_set0.UserUniforms).Port_RangeMinA_N022)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N022-(*sc_set0.UserUniforms).Port_RangeMinA_N022)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N022-(*sc_set0.UserUniforms).Port_RangeMinB_N022))+(*sc_set0.UserUniforms).Port_RangeMinB_N022;
float Output_N7=0.0;
Output_N7=fast::clamp(ValueOut_N22+0.001,(*sc_set0.UserUniforms).Port_Input1_N007+0.001,(*sc_set0.UserUniforms).Port_Input2_N007+0.001)-0.001;
float Output_N26=0.0;
Output_N26=mix(Output_N12,Output_N33,Output_N7);
float Output_N43=0.0;
Output_N43=fast::clamp(Output_N26+0.001,(*sc_set0.UserUniforms).Port_Input1_N043+0.001,(*sc_set0.UserUniforms).Port_Input2_N043+0.001)-0.001;
float Output_N64=0.0;
Output_N64=Value1_N84+Output_N5;
float Output_N61=0.0;
float param_68=(*sc_set0.UserUniforms).smoothness;
Output_N61=param_68;
float ValueOut_N48=0.0;
ValueOut_N48=(((Output_N61-(*sc_set0.UserUniforms).Port_RangeMinA_N048)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N048-(*sc_set0.UserUniforms).Port_RangeMinA_N048)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N048-(*sc_set0.UserUniforms).Port_RangeMinB_N048))+(*sc_set0.UserUniforms).Port_RangeMinB_N048;
float Output_N72=0.0;
Output_N72=fast::clamp(ValueOut_N48+0.001,(*sc_set0.UserUniforms).Port_Input1_N072+0.001,(*sc_set0.UserUniforms).Port_Input2_N072+0.001)-0.001;
float Output_N58=0.0;
Output_N58=Output_N64*Output_N72;
float Output_N55=0.0;
Output_N55=mix(Output_N0,Output_N43,Output_N58);
float Output_N49=0.0;
Output_N49=Output_N50+Output_N55;
float Output_N1=0.0;
Output_N1=1.0-Output_N49;
float Output_N10=0.0;
Output_N10=fast::clamp(Output_N1+0.001,(*sc_set0.UserUniforms).Port_Input1_N010+0.001,(*sc_set0.UserUniforms).Port_Input2_N010+0.001)-0.001;
float ValueOut_N36=0.0;
ValueOut_N36=(((Output_N10-(*sc_set0.UserUniforms).Port_RangeMinA_N036)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N036-(*sc_set0.UserUniforms).Port_RangeMinA_N036)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N036-(*sc_set0.UserUniforms).Port_RangeMinB_N036))+(*sc_set0.UserUniforms).Port_RangeMinB_N036;
float Output_N39=0.0;
Output_N39=fast::clamp(ValueOut_N36+0.001,(*sc_set0.UserUniforms).Port_Input1_N039+0.001,(*sc_set0.UserUniforms).Port_Input2_N039+0.001)-0.001;
float ValueOut_N77=0.0;
ValueOut_N77=(((Output_N64-(*sc_set0.UserUniforms).Port_RangeMinA_N077)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N077-(*sc_set0.UserUniforms).Port_RangeMinA_N077)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N077-(*sc_set0.UserUniforms).Port_RangeMinB_N077))+(*sc_set0.UserUniforms).Port_RangeMinB_N077;
float Output_N78=0.0;
Output_N78=fast::clamp(ValueOut_N77+0.001,(*sc_set0.UserUniforms).Port_Input1_N078+0.001,(*sc_set0.UserUniforms).Port_Input2_N078+0.001)-0.001;
float Output_N59=0.0;
Output_N59=Output_N39*Output_N78;
float Output_N74=0.0;
Output_N74=Output_N59*(*sc_set0.UserUniforms).Port_Input1_N074;
float Output_N68=0.0;
Output_N68=Output_N10+Output_N74;
float4 Output_N8=float4(0.0);
Output_N8=float4(Output_N68,0.0,0.0,1.0);
FinalColor=Output_N8;
float param_69=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_69<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_281=floor(mod(l9_280.xy,float2(4.0)));
float l9_282=(mod(dot(l9_281,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_69<l9_282)
{
discard_fragment();
}
...
{
l9_285=fast::clamp(l9_284.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_285=fast::clamp(dot(l9_284.xyz,float3(l9_284.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_285=(1.0-dot(l9_284.xyz,float3(0.33333001)))*l9_284.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_285=(1.0-fast::clamp(dot(l9_284.xyz,float3(1.0)),0.0,1.0))*l9_284.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_285=fast::clamp(dot(l9_284.xyz,float3(1.0)),0.0,1.0)*l9_284.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_285=fast::clamp(dot(l9_284.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_285=dot(l9_284.xyz,float3(0.33333001))*l9_284.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_285=1.0-fast::clamp(dot(l9_284.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_286=l9_285;
float l9_287=l9_286;
float l9_288=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_287;
float3 l9_289=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_283.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_290=float4(l9_289.x,l9_289.y,l9_289.z,l9_288);
param_70=l9_290;
}
else
{
...
{
float4 l9_291=param_70;
float4 l9_292=float4(0.0);
float4 l9_293=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_294=out.sc_FragData0;
l9_293=l9_294;
}
else
{
float4 l9_295=gl_FragCoord;
float2 l9_296=l9_295.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_301=l9_300;
int l9_302=l9_301;
float3 l9_303=float3(l9_297,0.0);
int l9_304=l9_299;
int l9_305=l9_302;
if (l9_304==1)
{
l9_303.y=((2.0*l9_303.y)+float(l9_305))-1.0;
}
float2 l9_306=l9_303.xy;
l9_298=l9_306;
}
else
{
...
float4 l9_328=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_327.xy,bias(l9_321));
float4 l9_329=l9_328;
float4 l9_330=l9_329;
l9_293=l9_330;
}
float4 l9_331=l9_293;
float3 l9_332=l9_331.xyz;
float3 l9_333=l9_332;
float3 l9_334=l9_291.xyz;
float3 l9_335=definedBlend(l9_333,l9_334,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_292=float4(l9_335.x,l9_335.y,l9_335.z,l9_292.w);
float3 l9_336=mix(l9_332,l9_292.xyz,float3(l9_291.w));
l9_292=float4(l9_336.x,l9_336.y,l9_336.z,l9_292.w);
l9_292.w=1.0;
float4 l9_337=l9_292;
param_70=l9_337;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_338=float4(in.varScreenPos.xyz,1.0);
param_70=l9_338;
}
else
{
...
float l9_340=fast::clamp(abs(l9_339.z),0.0,1.0);
float4 l9_341=float4(l9_340,1.0-l9_340,1.0,1.0);
param_70=l9_341;
}
else
{
float4 l9_342=param_70;
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_71,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_72=FinalColor;
float4 l9_349=param_72;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_349.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_349;
return out;
}
} // FRAGMENT SHADER
