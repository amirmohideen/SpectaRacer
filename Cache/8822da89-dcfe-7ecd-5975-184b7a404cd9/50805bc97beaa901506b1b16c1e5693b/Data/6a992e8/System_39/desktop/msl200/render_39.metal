...
//float2 Port_SpriteCount_N019 7528
//float Port_MaxFrames_N019 7536
//float Port_Input1_N008 7540
//float Port_Input1_N002 7552
//float Port_Input2_N002 7556
//}
...
float2 Port_SpriteCount_N019;
float Port_MaxFrames_N019;
float Port_Input1_N008;
float Port_Speed_N019;
float Port_SecondOffset_N019;
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/480]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(480*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/480]!=0)==false;
}
else
{
l9_5=l9_4;
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[ssInstanceID/480]*float4(gParticle.Position,1.0)).xyz;
int l9_23=ssInstanceID/480;
gParticle.Velocity=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_23][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_23][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_23][2].xyz)*gParticle.Velocity;
int l9_24=ssInstanceID/480;
gParticle.Force=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_24][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_24][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_24][2].xyz)*gParticle.Force;
int l9_25=ssInstanceID/480;
gParticle.Matrix=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_25][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_25][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_25][2].xyz)*gParticle.Matrix;
float3 l9_26=gParticle.Position+(gParticle.Matrix*float3(v.position.x*gParticle.Size,v.position.y*gParticle.Size,0.0));
out.varPosAndMotion=float4(l9_26.x,l9_26.y,l9_26.z,out.varPosAndMotion.w);
float3 l9_27=gParticle.Matrix*float3(0.0,0.0,1.0);
out.varNormalAndMotion=float4(l9_27.x,l9_27.y,l9_27.z,out.varNormalAndMotion.w);
float3 l9_28=gParticle.Matrix*float3(1.0,0.0,0.0);
out.varTangent=float4(l9_28.x,l9_28.y,l9_28.z,out.varTangent.w);
...
int l9_30=l9_29;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_30]*float4(out.varPosAndMotion.xyz,1.0);
...
int l9_32=l9_31;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_32][2].w!=0.0)
{
float l9_33=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
param_4.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_4.w))*l9_33)-1.0)*param_4.w;
}
}
float4 l9_34=param_4;
clipPosition=l9_34;
...
float4 l9_35=param_5;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_36=dot(l9_35,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_37=l9_36;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_37;
}
}
float4 l9_38=float4(param_5.x,-param_5.y,(param_5.z*0.5)+(param_5.w*0.5),param_5.w);
out.gl_Position=l9_38;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/480];
...
param_1.Index1DPerCopy=param%480;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(480*((param/480)+1))-1;
...
param_1.SpawnOffset=param_1.Ratio1D*0.80000001;
...
float Value_N3=0.0;
Value_N3=gParticle.Seed;
float Output_N8=0.0;
Output_N8=Value_N3*(*sc_set0.UserUniforms).Port_Input1_N008;
float4 Color_N19=float4(0.0);
float2 param_2=(*sc_set0.UserUniforms).Port_SpriteCount_N019;
float param_3=(*sc_set0.UserUniforms).Port_MaxFrames_N019;
float param_4=Output_N8;
...
int l9_38=l9_33;
int l9_39=mainTexLayout_tmp;
int l9_40=l9_38;
float2 l9_41=l9_24;
bool l9_42=(int(SC_USE_UV_TRANSFORM_mainTex_tmp)!=0);
float3x3 l9_43=(*sc_set0.UserUniforms).mainTexTransform;
int2 l9_44=int2(SC_SOFTWARE_WRAP_MODE_U_mainTex_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTex_tmp);
bool l9_45=(int(SC_USE_UV_MIN_MAX_mainTex_tmp)!=0);
float4 l9_46=(*sc_set0.UserUniforms).mainTexUvMinMax;
bool l9_47=(int(SC_USE_CLAMP_TO_BORDER_mainTex_tmp)!=0);
float4 l9_48=(*sc_set0.UserUniforms).mainTexBorderColor;
float l9_49=0.0;
...
float3 l9_115=l9_114;
float4 l9_116=sc_set0.mainTex.sample(sc_set0.mainTexSmpSC,l9_115.xy,bias(l9_109));
...
Output_N66=Color_N19.w;
float Value_N5=0.0;
Value_N5=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float Output_N1=0.0;
Output_N1=Output_N66-Value_N5;
float Output_N2=0.0;
Output_N2=fast::clamp(Output_N1+0.001,(*sc_set0.UserUniforms).Port_Input1_N002+0.001,(*sc_set0.UserUniforms).Port_Input2_N002+0.001)-0.001;
float4 Value_N27=float4(0.0);
Value_N27=float4(Color_N19.xyz.x,Color_N19.xyz.y,Color_N19.xyz.z,Value_N27.w);
Value_N27.w=Output_N2;
float4 param_7=Value_N27;
...
{
float4 l9_122=out.sc_FragData0;
l9_121=l9_122;
}
else
{
...
float4 l9_159=l9_121;
float3 l9_160=l9_159.xyz;
float3 l9_161=l9_160;
float3 l9_162=l9_119.xyz;
...
l9_120=float4(l9_163.x,l9_163.y,l9_163.z,l9_120.w);
float3 l9_164=mix(l9_160,l9_120.xyz,float3(l9_119.w));
l9_120=float4(l9_164.x,l9_164.y,l9_164.z,l9_120.w);
l9_120.w=1.0;
float4 l9_165=l9_120;
param_8=l9_165;
}
else
{
...
float4 l9_174=param_8;
Output_Color0=l9_174;
