...
//float3x3 Tweak_N1Transform 4448
//float4 Tweak_N1UvMinMax 4496
//float4 Tweak_N1BorderColor 4512
//float4 Port_Input1_N005 4528
//float Port_Value2_N007 4544
//float depthRef 4548
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 75 -1
//spec_const int Tweak_N1Layout 76 0
...
constant bool Tweak_N9 [[function_constant(38)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 [[function_constant(72)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 [[function_constant(74)]];
...
constant int Tweak_N1Layout [[function_constant(76)]];
...
float4 l9_2=(*sc_set0.UserUniforms).Tweak_N0;
l9_1=l9_2;
...
int l9_9=l9_4;
int l9_10=Tweak_N1Layout_tmp;
int l9_11=l9_9;
float2 l9_12=param_4.Surface_UVCoord0;
bool l9_13=(int(SC_USE_UV_TRANSFORM_Tweak_N1_tmp)!=0);
float3x3 l9_14=(*sc_set0.UserUniforms).Tweak_N1Transform;
int2 l9_15=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1_tmp);
bool l9_16=(int(SC_USE_UV_MIN_MAX_Tweak_N1_tmp)!=0);
float4 l9_17=(*sc_set0.UserUniforms).Tweak_N1UvMinMax;
bool l9_18=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1_tmp)!=0);
float4 l9_19=(*sc_set0.UserUniforms).Tweak_N1BorderColor;
float l9_20=0.0;
...
float3 l9_85=l9_84;
float3 l9_86=l9_85;
float4 l9_87=sc_set0.Tweak_N1.sample(sc_set0.Tweak_N1SmpSC,l9_86.xy,bias(l9_80));
float4 l9_88=l9_87;
if (l9_18)
{
...
l9_91=l9_90+(*sc_set0.UserUniforms).Port_Input1_N005;
float4 l9_92=float4(0.0);
l9_92=float4(l9_91.xyz.x,l9_91.xyz.y,l9_91.xyz.z,l9_92.w);
l9_92.w=(*sc_set0.UserUniforms).Port_Value2_N007;
param_1=l9_92;
param_3=param_1;
}
else
...
float4 l9_94=(*sc_set0.UserUniforms).Tweak_N0;
l9_93=l9_94;
...
int l9_101=l9_96;
int l9_102=Tweak_N1Layout_tmp;
int l9_103=l9_101;
float2 l9_104=param_4.Surface_UVCoord0;
bool l9_105=(int(SC_USE_UV_TRANSFORM_Tweak_N1_tmp)!=0);
float3x3 l9_106=(*sc_set0.UserUniforms).Tweak_N1Transform;
int2 l9_107=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1_tmp);
bool l9_108=(int(SC_USE_UV_MIN_MAX_Tweak_N1_tmp)!=0);
float4 l9_109=(*sc_set0.UserUniforms).Tweak_N1UvMinMax;
bool l9_110=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1_tmp)!=0);
float4 l9_111=(*sc_set0.UserUniforms).Tweak_N1BorderColor;
float l9_112=0.0;
...
float3 l9_178=l9_177;
float4 l9_179=sc_set0.Tweak_N1.sample(sc_set0.Tweak_N1SmpSC,l9_178.xy,bias(l9_172));
...
l9_183=l9_182+(*sc_set0.UserUniforms).Port_Input1_N005;
param_2=l9_183;
param_3=param_2;
}
Result_N10=param_3;
FinalColor=Result_N10;
...
{
float4 l9_184=gl_FragCoord;
float2 l9_185=floor(mod(l9_184.xy,float2(4.0)));
float l9_186=(mod(dot(l9_185,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_5<l9_186)
{
discard_fragment();
}
...
float4 l9_187=fast::max(param_6,float4(0.0));
float4 param_7=l9_187;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_190=fast::clamp(l9_189.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_190=fast::clamp(dot(l9_189.xyz,float3(l9_189.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_190=(1.0-dot(l9_189.xyz,float3(0.33333001)))*l9_189.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_190=(1.0-fast::clamp(dot(l9_189.xyz,float3(1.0)),0.0,1.0))*l9_189.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_190=fast::clamp(dot(l9_189.xyz,float3(1.0)),0.0,1.0)*l9_189.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_190=fast::clamp(dot(l9_189.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_190=dot(l9_189.xyz,float3(0.33333001))*l9_189.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_190=1.0-fast::clamp(dot(l9_189.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_191=l9_190;
float l9_192=l9_191;
float l9_193=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_192;
float3 l9_194=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_188.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_195=float4(l9_194.x,l9_194.y,l9_194.z,l9_193);
param_8=l9_195;
}
else
{
...
{
float4 l9_199=out.sc_FragData0;
l9_198=l9_199;
}
else
{
float4 l9_200=gl_FragCoord;
float2 l9_201=l9_200.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_206=l9_205;
int l9_207=l9_206;
float3 l9_208=float3(l9_202,0.0);
int l9_209=l9_204;
int l9_210=l9_207;
if (l9_209==1)
{
l9_208.y=((2.0*l9_208.y)+float(l9_210))-1.0;
}
float2 l9_211=l9_208.xy;
l9_203=l9_211;
}
else
{
...
int l9_222=l9_217;
float2 l9_223=l9_215;
int l9_224=sc_ScreenTextureLayout_tmp;
int l9_225=l9_222;
float l9_226=l9_216;
...
float4 l9_233=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_232.xy,bias(l9_226));
float4 l9_234=l9_233;
float4 l9_235=l9_234;
l9_198=l9_235;
}
float4 l9_236=l9_198;
float3 l9_237=l9_236.xyz;
float3 l9_238=l9_237;
float3 l9_239=l9_196.xyz;
float3 l9_240=definedBlend(l9_238,l9_239,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_197=float4(l9_240.x,l9_240.y,l9_240.z,l9_197.w);
float3 l9_241=mix(l9_237,l9_197.xyz,float3(l9_196.w));
l9_197=float4(l9_241.x,l9_241.y,l9_241.z,l9_197.w);
l9_197.w=1.0;
float4 l9_242=l9_197;
param_8=l9_242;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_243=float4(in.varScreenPos.xyz,1.0);
param_8=l9_243;
}
else
{
...
float l9_245=fast::clamp(abs(l9_244.z),0.0,1.0);
float4 l9_246=float4(l9_245,1.0-l9_245,1.0,1.0);
param_8=l9_246;
}
else
{
float4 l9_247=param_8;
float4 l9_248=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_248=float4(mix(float3(1.0),l9_247.xyz,float3(l9_247.w)),l9_247.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_249=l9_247.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_249=fast::clamp(l9_249,0.0,1.0);
}
l9_248=float4(l9_247.xyz*l9_249,l9_249);
}
else
{
l9_248=l9_247;
...
float4 l9_254=param_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_254.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_254;
return out;
}
} // FRAGMENT SHADER
