...
export class MainMenu extends BaseScriptComponent {
  ...
  tutorialButton: RoundButton | undefined

  @input
  @allowUndefined
  @hint("Play button on Panel 1")
  playButton: RoundButton | undefined
  ...
  pauseButton1: RoundButton | undefined

  @input
  @allowUndefined
  @hint("Second pause button")
  pauseButton2: RoundButton | undefined
  ...
  resumeButton: RoundButton | undefined

  @input
  @allowUndefined
  @hint("Weather toggle button on Panel 2")
  weatherToggleButton: RoundButton | undefined

  @input
  @allowUndefined
  @hint("Restart button on Panel 2")
  restartButton: RoundButton | undefined

  @input
  @allowUndefined
  @hint("Main Menu button on Panel 2")
  mainMenuButtonPanel2: RoundButton | undefined
  ...
  mainMenuButtonPanel3: RoundButton | undefined
  ...
  private wireButtons(): void {
    ...
    if (this.weatherToggleButton)  this.weatherToggleButton.onTriggerUp.add(()  => this.toggleWeather())
  ...
  private toggleWeather(): void {
    ...
    this.weatherObject.enabled = !this.weatherObject.enabled
    this.logger.info(`Weather toggled — now ${this.weatherObject.enabled ? "enabled" : "disabled"}`)
  }
