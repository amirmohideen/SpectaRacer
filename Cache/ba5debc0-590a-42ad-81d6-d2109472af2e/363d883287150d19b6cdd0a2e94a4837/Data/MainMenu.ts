...
export class MainMenu extends BaseScriptComponent {
  ...
  @input
  @allowUndefined
  @hint("AudioComponent for looping rain — attach it to this same SceneObject. Stops on Panel 1 and Panel 2, plays everywhere else.")
  rainAudio: AudioComponent | undefined
