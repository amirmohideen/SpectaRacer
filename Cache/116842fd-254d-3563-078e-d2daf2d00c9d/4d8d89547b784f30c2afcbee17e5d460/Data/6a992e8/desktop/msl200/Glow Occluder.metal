...
//}
//ubo int UserUniforms 0:24:4288 {
...
//float4 Port_FinalColor_N004 4256
//float4 Port_FinalColor1_N004 4272
//}
...
out.sc_FragData1=param_2;
float4 param_3=FinalColor;
FinalColor=sc_OutputMotionVectorIfNeeded(param_3,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_4=FinalColor;
float4 l9_69=param_4;
if (sc_ShaderCacheConstant_tmp!=0)
{
