...
//float Port_Import_N080 7392
//float2 Port_Import_N110 7400
//float2 Port_Input1_N137 7416
//float Port_Input1_N138 7424
//float Port_Import_N092 7428
//float Port_Import_N095 7432
//float Port_Input1_N108 7436
//float Port_Input2_N108 7440
//}
...
float2 Port_Import_N110;
float Port_AlphaTestThreshold_N039;
float2 Port_Input1_N137;
float Port_Input1_N138;
float Port_Import_N092;
float Port_Import_N095;
float Port_Input1_N108;
float Port_Input2_N108;
};
struct sc_Set0
{
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/7000]!=0);
}
else
{
l9_46=l9_45;
...
main_vert_out out={};
int ssInstanceID=0;
int N111_FacingMode=0;
int N111_Alignment=0;
float N111_VelocityStretchAmount=0.0;
float2 N111_PivotPoint=float2(0.0);
sc_Vertex_t l9_0;
...
bool l9_4=l9_3>=(7000*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/7000]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/7000];
...
Value_N48=0.0;
float Value_N80=0.0;
Value_N80=(*sc_set0.UserUniforms).Port_Import_N080;
float2 Value_N110=float2(0.0);
Value_N110=fast::clamp((*sc_set0.UserUniforms).Port_Import_N110,float2(-0.5),float2(0.5));
float param_4=Value_N47;
float param_5=Value_N48;
float param_6=Value_N80;
float2 param_7=Value_N110;
ssGlobals param_8=Globals;
ssGlobals tempGlobals=param_8;
N111_FacingMode=int(param_4);
N111_Alignment=int(param_5);
N111_VelocityStretchAmount=param_6;
N111_PivotPoint=param_7;
float l9_26=0.029999999;
float3 l9_27=float3(0.0,1.0,0.0);
float3 l9_28=gParticle.Velocity;
float l9_29=length(l9_28);
float l9_30=fast::max(l9_29*N111_VelocityStretchAmount,1.0);
if ((l9_29<l9_26)||(N111_VelocityStretchAmount<9.9999997e-05))
{
if (N111_Alignment==1)
{
int l9_31=0;
...
int l9_32=l9_31;
float3 l9_33=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_32][1].xyz;
l9_27=l9_33;
}
}
else
{
float3 l9_34=gParticle.Velocity;
l9_27=normalize(l9_34);
}
int l9_35=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_36=l9_35;
float4x4 l9_37=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_36];
float3 l9_38=l9_37[2].xyz;
if (N111_FacingMode==0)
{
float3 l9_39=(*sc_set0.UserUniforms).sc_Camera.position;
float3 l9_40=gParticle.Position;
l9_38=l9_39-l9_40;
}
l9_38=normalize(l9_38);
float3 l9_41=normalize(cross(l9_38,l9_27));
float3 l9_42=normalize(cross(l9_41,l9_38));
float2 l9_43=tempGlobals.Surface_UVCoord0;
float2 l9_44=(l9_43-float2(0.5))+N111_PivotPoint;
float4x4 l9_45=float4x4(float4(gParticle.Matrix[0].x,gParticle.Matrix[0].y,gParticle.Matrix[0].z,0.0),float4(gParticle.Matrix[1].x,gParticle.Matrix[1].y,gParticle.Matrix[1].z,0.0),float4(gParticle.Matrix[2].x,gParticle.Matrix[2].y,gParticle.Matrix[2].z,0.0),float4(0.0,0.0,0.0,1.0));
l9_44=(l9_45*float4(l9_44,0.0,1.0)).xy;
float3 l9_46=gParticle.Position;
float3 l9_47=l9_46;
float l9_48=gParticle.Size;
l9_47+=((-l9_41)*(l9_48*l9_44.x));
float l9_49=gParticle.Size;
l9_47+=(l9_42*((l9_49*l9_44.y)*l9_30));
float3 l9_50=l9_47;
out.varPosAndMotion=float4(l9_50.x,l9_50.y,l9_50.z,out.varPosAndMotion.w);
float3 l9_51=l9_42;
out.varTangent=float4(l9_51.x,l9_51.y,l9_51.z,out.varTangent.w);
float3 l9_52=l9_38;
out.varNormalAndMotion=float4(l9_52.x,l9_52.y,l9_52.z,out.varNormalAndMotion.w);
int l9_53=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_53=0;
...
{
l9_53=gl_InstanceIndex%2;
}
int l9_54=l9_53;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_54]*float4(out.varPosAndMotion.xyz,1.0);
...
{
l9_55=gl_InstanceIndex%2;
}
int l9_56=l9_55;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_56][2].w!=0.0)
{
float l9_57=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
param_9.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_9.w))*l9_57)-1.0)*param_9.w;
}
}
float4 l9_58=param_9;
clipPosition=l9_58;
...
float4 l9_59=param_10;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_60=dot(l9_59,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_61=l9_60;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_61;
}
}
float4 l9_62=float4(param_10.x,-param_10.y,(param_10.z*0.5)+(param_10.w*0.5),param_10.w);
out.gl_Position=l9_62;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/7000];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
param_1.Index1DPerCopy=param%7000;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(7000*((param/7000)+1))-1;
...
float4 Value_N43=float4(0.0);
Value_N43=gParticle.Color;
float2 UVCoord_N136=float2(0.0);
UVCoord_N136=Globals.Surface_UVCoord0;
float Output_N137=0.0;
Output_N137=distance(UVCoord_N136,(*sc_set0.UserUniforms).Port_Input1_N137);
float Output_N138=0.0;
Output_N138=Output_N137*(*sc_set0.UserUniforms).Port_Input1_N138;
float Output_N139=0.0;
Output_N139=1.0-Output_N138;
float Value_N92=0.0;
...
{
l9_24=pow(Output_N139,Value_N92);
}
Output_N93=l9_24;
float Value_N95=0.0;
Value_N95=(*sc_set0.UserUniforms).Port_Import_N095;
float Output_N107=0.0;
Output_N107=Output_N93*Value_N95;
float Output_N108=0.0;
Output_N108=fast::clamp(Output_N107+0.001,(*sc_set0.UserUniforms).Port_Input1_N108+0.001,(*sc_set0.UserUniforms).Port_Input2_N108+0.001)-0.001;
float Export_N109=0.0;
Export_N109=Output_N108;
float4 Output_N51=float4(0.0);
Output_N51=Value_N43*float4(Export_N109);
float4 param_2=Output_N51;
Output_Color0=param_2;
float4 param_3=Output_Color0;
