...
float4 param_1=(*sc_set0.UserUniforms).Tweak_N3;
Output_N3=param_1;
...
float4 l9_75=l9_74;
Output_N2=l9_75;
float4 ValueOut_N1=float4(0.0);
ValueOut_N1=(((Output_N2-float4((*sc_set0.UserUniforms).Port_RangeMinA_N001))/float4(((*sc_set0.UserUniforms).Port_RangeMaxA_N001-(*sc_set0.UserUniforms).Port_RangeMinA_N001)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N001-(*sc_set0.UserUniforms).Port_RangeMinB_N001))+float4((*sc_set0.UserUniforms).Port_RangeMinB_N001);
float4 Output_N0=float4(0.0);
Output_N0=Output_N3*ValueOut_N1;
