...
export class TreeInstantiator extends BaseScriptComponent {
  @ui.label('<span style="color: #4ADE80;">TreeInstantiator – spawn and animate tree obstacle cubes</span><br/><span style="color: #94A3B8; font-size: 11px;">Instantiates tree prefabs at regular intervals and moves them toward a target. Hitting a tree deals damage.</span>')
  @ui.separator
  ...
  private drawGizmo(): void {
    ...
    // Green color for tree/danger path
