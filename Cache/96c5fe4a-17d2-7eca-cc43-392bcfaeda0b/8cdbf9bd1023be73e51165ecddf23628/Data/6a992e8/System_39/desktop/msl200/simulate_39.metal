...
//ubo int UserUniforms 0:35:7712 {
//float4 sc_Time 1376
...
//float3 boundingBoxMin 7392
//float3 boundingBoxMax 7408
//float3 offset 7424
//float Port_Multiplier_N028 7440
//float Port_Input0_N030 7444
//float2 Port_Scale_N047 7448
//float Port_RangeMinA_N056 7456
//float Port_RangeMaxA_N056 7460
//float2 Port_Input1_N043 7464
//float2 Port_Scale_N050 7472
//float Port_RangeMinA_N055 7480
//float Port_RangeMaxA_N055 7484
//float2 Port_Input1_N044 7488
//float2 Port_Scale_N054 7496
//float Port_RangeMinA_N057 7504
//float Port_RangeMaxA_N057 7508
//float3 Port_Min_N129 7536
//float3 Port_Max_N129 7552
//float Port_Min_N134 7568
//float Port_Max_N134 7572
//float Port_Import_N152 7576
//float3 Port_Import_N153 7584
//float Port_Import_N267 7600
//float Port_Import_N268 7604
//float3 Port_Import_N169 7616
//float3 Port_Import_N170 7632
//float Port_Import_N017 7648
//float Port_Import_N018 7652
//float Port_Input0_N214 7660
//float Port_Import_N007 7664
//float Port_Input1_N072 7672
//float Port_Input2_N072 7676
//float Port_Input0_N100 7680
//float Port_Import_N020 7684
//float Port_Input1_N102 7692
//float Port_Input2_N102 7696
//}
...
float3 offset;
float Port_Multiplier_N028;
float Port_Input0_N030;
float2 Port_Scale_N047;
float Port_RangeMinA_N056;
float Port_RangeMaxA_N056;
float2 Port_Input1_N043;
float2 Port_Scale_N050;
float Port_RangeMinA_N055;
float Port_RangeMaxA_N055;
float2 Port_Input1_N044;
float2 Port_Scale_N054;
float Port_RangeMinA_N057;
float Port_RangeMaxA_N057;
float3 Port_Import_N128;
float3 Port_Min_N129;
float3 Port_Max_N129;
float Port_Min_N134;
float Port_Max_N134;
float Port_Import_N152;
float3 Port_Import_N153;
float Port_Import_N267;
float Port_Import_N268;
float3 Port_Import_N169;
float3 Port_Import_N170;
float Port_Import_N017;
float Port_Import_N018;
...
param.CopyId=float(param_1/900);
...
float l9_8=float(l9_7)/899.0;
param_3.Ratio1D=l9_8;
int l9_9=param_3.Index1DPerCopy;
float l9_10=float(l9_9)/899.0;
...
param_3.SpawnOffset=param_3.Ratio1D*30.0;
...
l9_16.Seed+=(floor(((((l9_19-l9_16.SpawnOffset)-0.0)+0.0)+60.0)/30.0)*4.32723);
...
l9_43=!(UserUniforms.vfxBatchEnable[l9_44/900]!=0);
}
else
{
l9_43=l9_42;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/900];
...
float Delay=0.0;
float Warmup=0.0;
gParticle.Age=mod((Globals.gTimeElapsedShifted-gParticle.SpawnOffset)+Warmup,30.0);
...
if (!l9_13)
{
l9_14=mod(((fast::max(Globals.gTimeElapsed,0.1)-gParticle.SpawnOffset)-Delay)+Warmup,30.0)<=Globals.gTimeDelta;
}
else
{
l9_14=l9_13;
...
l9_15.Seed+=(floor(((((l9_18-l9_15.SpawnOffset)-0.0)+0.0)+60.0)/30.0)*4.32723);
...
float l9_21=0.0;
l9_21=param_1.gTimeElapsedShifted*(*sc_set0.UserUniforms).Port_Multiplier_N028;
float l9_22=0.0;
l9_22=30.0;
float l9_23=0.0;
l9_23=(*sc_set0.UserUniforms).Port_Input0_N030/(l9_22+1.234e-06);
float l9_24=0.0;
l9_24=l9_21/(l9_23+1.234e-06);
float l9_25=0.0;
l9_25=floor(l9_24);
float l9_26=0.0;
l9_26=mod(l9_21,l9_23);
float2 l9_27=float2(0.0);
l9_27.x=l9_25;
l9_27.y=l9_26;
float l9_28=0.0;
float2 l9_29=l9_27;
float2 l9_30=(*sc_set0.UserUniforms).Port_Scale_N047;
l9_29=floor(l9_29*10000.0)*9.9999997e-05;
float l9_31=dot(floor(l9_29*l9_30),float2(0.98000002,0.72000003));
l9_31=floor(l9_31*10000.0)*9.9999997e-05;
l9_31=sin(l9_31);
l9_31*=437.58499;
l9_31=fract(l9_31);
l9_31=floor(l9_31*10000.0)*9.9999997e-05;
...
float3 l9_33=(*sc_set0.UserUniforms).boundingBoxMin;
l9_32=l9_33;
float l9_34=0.0;
float l9_35=0.0;
float l9_36=0.0;
...
float3 l9_42=(*sc_set0.UserUniforms).boundingBoxMax;
l9_41=l9_42;
float l9_43=0.0;
float l9_44=0.0;
float l9_45=0.0;
...
l9_45=l9_49;
float l9_50=0.0;
l9_50=(((l9_28-(*sc_set0.UserUniforms).Port_RangeMinA_N056)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N056-(*sc_set0.UserUniforms).Port_RangeMinA_N056)+1e-06))*(l9_43-l9_34))+l9_34;
float2 l9_51=float2(0.0);
l9_51=l9_27+(*sc_set0.UserUniforms).Port_Input1_N043;
float l9_52=0.0;
float2 l9_53=l9_51;
float2 l9_54=(*sc_set0.UserUniforms).Port_Scale_N050;
l9_53=floor(l9_53*10000.0)*9.9999997e-05;
float l9_55=dot(floor(l9_53*l9_54),float2(0.98000002,0.72000003));
...
l9_52=l9_55;
float l9_56=0.0;
l9_56=(((l9_52-(*sc_set0.UserUniforms).Port_RangeMinA_N055)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N055-(*sc_set0.UserUniforms).Port_RangeMinA_N055)+1e-06))*(l9_44-l9_35))+l9_35;
float2 l9_57=float2(0.0);
l9_57=l9_27+(*sc_set0.UserUniforms).Port_Input1_N044;
float l9_58=0.0;
float2 l9_59=l9_57;
float2 l9_60=(*sc_set0.UserUniforms).Port_Scale_N054;
l9_59=floor(l9_59*10000.0)*9.9999997e-05;
float l9_61=dot(floor(l9_59*l9_60),float2(0.98000002,0.72000003));
...
l9_58=l9_61;
float l9_62=0.0;
l9_62=(((l9_58-(*sc_set0.UserUniforms).Port_RangeMinA_N057)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N057-(*sc_set0.UserUniforms).Port_RangeMinA_N057)+1e-06))*(l9_45-l9_36))+l9_36;
...
float3 l9_66=(*sc_set0.UserUniforms).Port_Min_N129;
float3 l9_67=(*sc_set0.UserUniforms).Port_Max_N129;
ssGlobals l9_68=param_1;
int l9_69=3;
bool l9_70=true;
bool l9_71=true;
bool l9_72=true;
float l9_73=129.0;
ssParticle l9_74=gParticle;
float l9_75=1.0;
float l9_76=l9_68.gTimeElapsed;
float4 l9_77=float4(0.0);
float4 l9_78=float4(1.0);
float l9_79=1.0;
float2 l9_80=float2(1.0);
if (l9_70)
{
l9_78=float4(fract(l9_76*10.0));
l9_78=floor(l9_78*10000.0)*9.9999997e-05;
l9_78=float4(0.32339999,0.65740001,0.22579999,0.87629998)+l9_78;
}
if (l9_71)
{
l9_79=1.0+((l9_73+1.0)*0.0099999998);
}
if (l9_72)
{
l9_80=l9_74.Seed2000;
}
l9_75=(l9_75+1.0)*0.5;
if (l9_69>=1)
{
float2 l9_81=(((float2(0.2353,0.78750002)*l9_80)*l9_79)*l9_78.x)*l9_75;
float l9_82=dot(l9_81,float2(0.98253,0.72662002));
l9_82=sin(l9_82)*479.371;
l9_82=fract(l9_82);
l9_82=floor(l9_82*10000.0)*9.9999997e-05;
float l9_83=l9_82;
l9_77.x=l9_83;
}
if (l9_69>=2)
{
float2 l9_84=(((float2(0.5751,0.62730002)*l9_80)*l9_79)*l9_78.y)*l9_75;
...
if (l9_69>=3)
{
float2 l9_87=(((float2(0.6947,0.52170002)*l9_80)*l9_79)*l9_78.z)*l9_75;
...
if (l9_69>=4)
{
float2 l9_90=(((float2(0.47889999,0.39669999)*l9_80)*l9_79)*l9_78.w)*l9_75;
...
float4 l9_93=l9_77;
float4 l9_94=l9_93;
float3 l9_95=mix(l9_66,l9_67,l9_94.xyz);
l9_65=l9_95;
float l9_96=0.0;
l9_96=length(l9_65);
float3 l9_97=float3(0.0);
l9_97=l9_65/(float3(l9_96)+float3(1.234e-06));
float l9_98=0.0;
float l9_99=(*sc_set0.UserUniforms).Port_Min_N134;
float l9_100=(*sc_set0.UserUniforms).Port_Max_N134;
ssGlobals l9_101=param_1;
int l9_102=1;
bool l9_103=true;
bool l9_104=true;
bool l9_105=true;
float l9_106=134.0;
ssParticle l9_107=gParticle;
float l9_108=1.0;
float l9_109=l9_101.gTimeElapsed;
float4 l9_110=float4(0.0);
float4 l9_111=float4(1.0);
float l9_112=1.0;
float2 l9_113=float2(1.0);
if (l9_103)
{
l9_111=float4(fract(l9_109*10.0));
l9_111=floor(l9_111*10000.0)*9.9999997e-05;
l9_111=float4(0.32339999,0.65740001,0.22579999,0.87629998)+l9_111;
}
if (l9_104)
{
l9_112=1.0+((l9_106+1.0)*0.0099999998);
}
if (l9_105)
{
l9_113=l9_107.Seed2000;
}
l9_108=(l9_108+1.0)*0.5;
if (l9_102>=1)
{
float2 l9_114=(((float2(0.2353,0.78750002)*l9_113)*l9_112)*l9_111.x)*l9_108;
...
if (l9_102>=2)
{
float2 l9_117=(((float2(0.5751,0.62730002)*l9_113)*l9_112)*l9_111.y)*l9_108;
float l9_118=dot(l9_117,float2(0.98253,0.72662002));
l9_118=sin(l9_118)*479.371;
l9_118=fract(l9_118);
l9_118=floor(l9_118*10000.0)*9.9999997e-05;
float l9_119=l9_118;
l9_110.y=l9_119;
}
if (l9_102>=3)
{
float2 l9_120=(((float2(0.6947,0.52170002)*l9_113)*l9_112)*l9_111.z)*l9_108;
float l9_121=dot(l9_120,float2(0.98253,0.72662002));
l9_121=sin(l9_121)*479.371;
l9_121=fract(l9_121);
l9_121=floor(l9_121*10000.0)*9.9999997e-05;
float l9_122=l9_121;
l9_110.z=l9_122;
}
if (l9_102>=4)
{
float2 l9_123=(((float2(0.47889999,0.39669999)*l9_113)*l9_112)*l9_111.w)*l9_108;
float l9_124=dot(l9_123,float2(0.98253,0.72662002));
l9_124=sin(l9_124)*479.371;
l9_124=fract(l9_124);
l9_124=floor(l9_124*10000.0)*9.9999997e-05;
float l9_125=l9_124;
l9_110.w=l9_125;
}
float4 l9_126=l9_110;
float4 l9_127=l9_126;
float l9_128=mix(l9_99,l9_100,l9_127.x);
l9_98=l9_128;
float l9_129=0.0;
float l9_130;
if (l9_98<=0.0)
...
l9_131=l9_132;
float l9_133=0.0;
l9_133=(*sc_set0.UserUniforms).Port_Import_N152;
float3 l9_134=float3(0.0);
l9_134=(*sc_set0.UserUniforms).Port_Import_N153;
float3 l9_135=float3(0.0);
l9_135=((l9_97*float3(l9_131))*float3(l9_133))*l9_134;
float3 l9_136=float3(0.0);
l9_136=l9_64+l9_135;
gParticle.Position=l9_136;
float l9_137=0.0;
l9_137=(*sc_set0.UserUniforms).Port_Import_N267;
float l9_138=0.0;
l9_138=(*sc_set0.UserUniforms).Port_Import_N268;
float l9_139=0.0;
float l9_140=l9_137;
float l9_141=l9_138;
ssGlobals l9_142=param_1;
int l9_143=1;
bool l9_144=true;
bool l9_145=true;
bool l9_146=true;
float l9_147=269.0;
ssParticle l9_148=gParticle;
float l9_149=1.0;
float l9_150=l9_142.gTimeElapsed;
float4 l9_151=float4(0.0);
float4 l9_152=float4(1.0);
float l9_153=1.0;
float2 l9_154=float2(1.0);
if (l9_144)
{
l9_152=float4(fract(l9_150*10.0));
l9_152=floor(l9_152*10000.0)*9.9999997e-05;
l9_152=float4(0.32339999,0.65740001,0.22579999,0.87629998)+l9_152;
}
if (l9_145)
{
l9_153=1.0+((l9_147+1.0)*0.0099999998);
}
if (l9_146)
{
l9_154=l9_148.Seed2000;
}
l9_149=(l9_149+1.0)*0.5;
if (l9_143>=1)
{
float2 l9_155=(((float2(0.2353,0.78750002)*l9_154)*l9_153)*l9_152.x)*l9_149;
...
if (l9_143>=2)
{
float2 l9_158=(((float2(0.5751,0.62730002)*l9_154)*l9_153)*l9_152.y)*l9_149;
...
if (l9_143>=3)
{
float2 l9_161=(((float2(0.6947,0.52170002)*l9_154)*l9_153)*l9_152.z)*l9_149;
...
if (l9_143>=4)
{
float2 l9_164=(((float2(0.47889999,0.39669999)*l9_154)*l9_153)*l9_152.w)*l9_149;
...
float l9_169=mix(l9_140,l9_141,l9_168.x);
l9_139=l9_169;
gParticle.Size=l9_139;
float3 l9_170=float3(0.0);
float3 l9_171=(*sc_set0.UserUniforms).offset;
l9_170=l9_171;
gParticle.Position+=l9_170;
float3 l9_172=float3(0.0);
l9_172=(*sc_set0.UserUniforms).Port_Import_N169;
float3 l9_173=float3(0.0);
l9_173=(*sc_set0.UserUniforms).Port_Import_N170;
float3 l9_174=float3(0.0);
float3 l9_175=l9_172;
float3 l9_176=l9_173;
ssGlobals l9_177=param_1;
int l9_178=3;
bool l9_179=true;
bool l9_180=true;
bool l9_181=true;
float l9_182=171.0;
ssParticle l9_183=gParticle;
float l9_184=1.0;
float l9_185=l9_177.gTimeElapsed;
float4 l9_186=float4(0.0);
float4 l9_187=float4(1.0);
float l9_188=1.0;
float2 l9_189=float2(1.0);
if (l9_179)
{
l9_187=float4(fract(l9_185*10.0));
l9_187=floor(l9_187*10000.0)*9.9999997e-05;
l9_187=float4(0.32339999,0.65740001,0.22579999,0.87629998)+l9_187;
}
if (l9_180)
{
l9_188=1.0+((l9_182+1.0)*0.0099999998);
}
if (l9_181)
{
l9_189=l9_183.Seed2000;
}
l9_184=(l9_184+1.0)*0.5;
if (l9_178>=1)
{
float2 l9_190=(((float2(0.2353,0.78750002)*l9_189)*l9_188)*l9_187.x)*l9_184;
...
if (l9_178>=2)
{
float2 l9_193=(((float2(0.5751,0.62730002)*l9_189)*l9_188)*l9_187.y)*l9_184;
float l9_194=dot(l9_193,float2(0.98253,0.72662002));
l9_194=sin(l9_194)*479.371;
l9_194=fract(l9_194);
l9_194=floor(l9_194*10000.0)*9.9999997e-05;
float l9_195=l9_194;
l9_186.y=l9_195;
}
if (l9_178>=3)
{
float2 l9_196=(((float2(0.6947,0.52170002)*l9_189)*l9_188)*l9_187.z)*l9_184;
...
if (l9_178>=4)
{
float2 l9_199=(((float2(0.47889999,0.39669999)*l9_189)*l9_188)*l9_187.w)*l9_184;
...
float4 l9_202=l9_186;
float4 l9_203=l9_202;
float3 l9_204=mix(l9_175,l9_176,l9_203.xyz);
l9_174=l9_204;
gParticle.Velocity+=l9_174;
...
float4 l9_205=param_2;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_206=dot(l9_205,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_207=l9_206;
...
{
out.varClipDistance=l9_207;
}
}
float4 l9_208=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
out.gl_Position=l9_208;
return out;
}
float4 Value_N16=float4(0.0);
Value_N16=gParticle.Color;
float Value_N17=0.0;
Value_N17=(*sc_set0.UserUniforms).Port_Import_N017;
float Value_N18=0.0;
Value_N18=(*sc_set0.UserUniforms).Port_Import_N018;
float Value_N6=0.0;
Value_N6=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float Value_N62=0.0;
Value_N62=Value_N6;
float Value_N7=0.0;
Value_N7=(*sc_set0.UserUniforms).Port_Import_N007;
float Value_N13=0.0;
Value_N13=gParticle.Life;
float Output_N19=0.0;
Output_N19=Value_N7/(Value_N13+1.234e-06);
float Value_N213=0.0;
Value_N213=Output_N19;
float Output_N214=0.0;
Output_N214=(*sc_set0.UserUniforms).Port_Input0_N214/(Value_N213+1.234e-06);
float Output_N215=0.0;
Output_N215=Value_N62*Output_N214;
float Output_N72=0.0;
Output_N72=fast::clamp(Output_N215+0.001,(*sc_set0.UserUniforms).Port_Input1_N072+0.001,(*sc_set0.UserUniforms).Port_Input2_N072+0.001)-0.001;
float Output_N83=0.0;
Output_N83=1.0-Value_N62;
float Value_N20=0.0;
Value_N20=(*sc_set0.UserUniforms).Port_Import_N020;
float Output_N59=0.0;
Output_N59=Value_N20/(Value_N13+1.234e-06);
float Value_N99=0.0;
Value_N99=Output_N59;
float Output_N100=0.0;
Output_N100=(*sc_set0.UserUniforms).Port_Input0_N100/(Value_N99+1.234e-06);
float Output_N101=0.0;
Output_N101=Output_N83*Output_N100;
...
Output_N103=Output_N72*Output_N102;
float Export_N104=0.0;
Export_N104=Output_N103;
float Output_N105=0.0;
Output_N105=mix(Value_N17,Value_N18,Export_N104);
float4 Value_N107=float4(0.0);
Value_N107=float4(Value_N16.xyz.x,Value_N16.xyz.y,Value_N16.xyz.z,Value_N107.w);
Value_N107.w=Output_N105;
gParticle.Color=Value_N107;
float3x3 param_3=gParticle.Matrix;
gParticle.Quaternion=matrixToQuaternion(param_3);
float Drift=0.0049999999;
if (gParticle.Dead)
{
float4 param_4=float4(4334.0,4334.0,4334.0,0.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_210=param_4;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_211=dot(l9_210,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_212=l9_211;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_212;
}
}
float4 l9_213=float4(param_4.x,-param_4.y,(param_4.z*0.5)+(param_4.w*0.5),param_4.w);
out.gl_Position=l9_213;
return out;
}
float l9_214;
...
{
l9_214=gParticle.Force.x;
}
gParticle.Force.x=l9_214;
float l9_215;
...
{
l9_215=gParticle.Force.y;
}
gParticle.Force.y=l9_215;
float l9_216;
...
{
l9_216=gParticle.Force.z;
}
gParticle.Force.z=l9_216;
...
{
l9_218=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_218;
float l9_219;
...
{
l9_219=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_219;
...
Vertex.y=l9_221;
Vertex+=Offset;
float4 param_5=float4((Vertex*2.0)-float2(1.0),1.0,1.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_222=param_5;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_223=dot(l9_222,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_224=l9_223;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_224;
}
}
float4 l9_225=float4(param_5.x,-param_5.y,(param_5.z*0.5)+(param_5.w*0.5),param_5.w);
out.gl_Position=l9_225;
...
if (gParticle.Dead)
{
float4 param_6=float4(4334.0,4334.0,4334.0,0.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_226=param_6;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_227=dot(l9_226,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_228=l9_227;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_228;
}
}
float4 l9_229=float4(param_6.x,-param_6.y,(param_6.z*0.5)+(param_6.w*0.5),param_6.w);
out.gl_Position=l9_229;
return out;
}
return out;
}
