...
//float4 outlineColor 4384
//float cornerRadius 4400
//float outlineThickness 4404
//float4 baseColor 4416
//float Port_Smoothness_N003 4432
//float depthRef 4436
//}
...
{
main_frag_out out={};
float4 N12_FirstLayer=float4(0.0);
float4 N12_SecondLayer=float4(0.0);
float4 N12_BlendResult=float4(0.0);
float4 N6_InColor=float4(0.0);
float N6_Opacity=0.0;
float4 N6_OutColor=float4(0.0);
float N3_CornerRadius=0.0;
float N3_Smoothness=0.0;
float N3_OutlineThickness=0.0;
float N3_Outline=0.0;
float N3_Result=0.0;
float4 N5_InColor=float4(0.0);
float N5_Opacity=0.0;
float4 N5_OutColor=float4(0.0);
...
float4 param_1=(*sc_set0.UserUniforms).outlineColor;
Output_N0=param_1;
float Output_N7=0.0;
float param_2=(*sc_set0.UserUniforms).cornerRadius;
Output_N7=param_2;
float Output_N8=0.0;
float param_3=(*sc_set0.UserUniforms).outlineThickness;
Output_N8=param_3;
float Outline_N3=0.0;
float Result_N3=0.0;
float param_4=Output_N7;
float param_5=(*sc_set0.UserUniforms).Port_Smoothness_N003;
float param_6=Output_N8;
ssGlobals param_9=Globals;
ssGlobals tempGlobals=param_9;
float param_7=0.0;
float param_8=0.0;
N3_CornerRadius=param_4;
N3_Smoothness=param_5;
N3_OutlineThickness=param_6;
float4x4 l9_1=(*sc_set0.UserUniforms).sc_ModelMatrix;
float4x4 l9_2=l9_1;
float2 l9_3=float2(length(l9_2[0]),length(l9_2[1]));
float l9_4=N3_Smoothness/fast::min(l9_3.x,l9_3.y);
float2 l9_5=tempGlobals.Surface_UVCoord0;
float2 l9_6=float2(0.5)-abs(l9_5-float2(0.5));
l9_6*=(l9_3/float2(fast::min(l9_3.x,l9_3.y)));
float2 l9_7=l9_6-float2(N3_OutlineThickness*0.5);
float l9_8=N3_CornerRadius-(N3_OutlineThickness*0.5);
float l9_9=l9_8-length(fast::max(float2(l9_8)-l9_7,float2(0.0)));
float l9_10=fast::min(l9_7.x,l9_7.y);
l9_10=(l9_10<=l9_8) ? 0.0 : l9_10;
float l9_11=fast::max(l9_9,l9_10);
N3_Result=l9_11;
N3_Result=smoothstep(0.0,l9_4,N3_Result);
float2 l9_12=l9_6;
float l9_13=N3_CornerRadius;
float l9_14=l9_13-length(fast::max(float2(l9_13)-l9_12,float2(0.0)));
float l9_15=fast::min(l9_12.x,l9_12.y);
l9_15=(l9_15<=l9_13) ? 0.0 : l9_15;
float l9_16=fast::max(l9_14,l9_15);
N3_Outline=l9_16;
N3_Outline=smoothstep(0.0,l9_4,N3_Outline)-N3_Result;
param_7=N3_Outline;
param_8=N3_Result;
Outline_N3=param_7;
Result_N3=param_8;
float4 OutColor_N6=float4(0.0);
float4 param_10=Output_N0;
float param_11=Outline_N3;
ssGlobals param_13=Globals;
tempGlobals=param_13;
float4 param_12=float4(0.0);
N6_InColor=param_10;
N6_Opacity=param_11;
N6_OutColor=N6_InColor;
N6_OutColor.w*=N6_Opacity;
param_12=N6_OutColor;
OutColor_N6=param_12;
float4 Output_N2=float4(0.0);
float4 param_14=(*sc_set0.UserUniforms).baseColor;
Output_N2=param_14;
float4 OutColor_N5=float4(0.0);
float4 param_15=Output_N2;
float param_16=Result_N3;
ssGlobals param_18=Globals;
tempGlobals=param_18;
float4 param_17=float4(0.0);
N5_InColor=param_15;
N5_Opacity=param_16;
N5_OutColor=N5_InColor;
N5_OutColor.w*=N5_Opacity;
param_17=N5_OutColor;
OutColor_N5=param_17;
float4 BlendResult_N12=float4(0.0);
float4 param_19=OutColor_N6;
float4 param_20=OutColor_N5;
ssGlobals param_22=Globals;
tempGlobals=param_22;
float4 param_21=float4(0.0);
N12_FirstLayer=param_19;
N12_SecondLayer=param_20;
float l9_17=N12_FirstLayer.w*(1.0-N12_SecondLayer.w);
N12_BlendResult=((N12_SecondLayer*N12_SecondLayer.w)+(N12_FirstLayer*l9_17))/float4(l9_17+N12_SecondLayer.w);
N12_BlendResult.w=N12_SecondLayer.w+l9_17;
param_21=N12_BlendResult;
BlendResult_N12=param_21;
FinalColor=BlendResult_N12;
...
float2 l9_19=floor(mod(l9_18.xy,float2(4.0)));
float l9_20=(mod(dot(l9_19,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_23<l9_20)
{
discard_fragment();
}
...
float4 l9_21=fast::max(param_24,float4(0.0));
float4 param_25=l9_21;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_24=fast::clamp(l9_23.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_24=fast::clamp(dot(l9_23.xyz,float3(l9_23.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_24=(1.0-dot(l9_23.xyz,float3(0.33333001)))*l9_23.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_24=(1.0-fast::clamp(dot(l9_23.xyz,float3(1.0)),0.0,1.0))*l9_23.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_24=fast::clamp(dot(l9_23.xyz,float3(1.0)),0.0,1.0)*l9_23.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_24=fast::clamp(dot(l9_23.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_24=dot(l9_23.xyz,float3(0.33333001))*l9_23.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_24=1.0-fast::clamp(dot(l9_23.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_25=l9_24;
float l9_26=l9_25;
float l9_27=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_26;
float3 l9_28=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_22.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_29=float4(l9_28.x,l9_28.y,l9_28.z,l9_27);
param_26=l9_29;
}
else
{
...
{
float4 l9_30=param_26;
float4 l9_31=float4(0.0);
float4 l9_32=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_33=out.sc_FragData0;
l9_32=l9_33;
}
else
{
float4 l9_34=gl_FragCoord;
float2 l9_35=l9_34.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_36=l9_35;
...
float3 l9_65=l9_64;
float3 l9_66=l9_65;
float4 l9_67=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_66.xy,bias(l9_60));
float4 l9_68=l9_67;
float4 l9_69=l9_68;
l9_32=l9_69;
}
float4 l9_70=l9_32;
float3 l9_71=l9_70.xyz;
float3 l9_72=l9_71;
float3 l9_73=l9_30.xyz;
float3 l9_74=definedBlend(l9_72,l9_73,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_31=float4(l9_74.x,l9_74.y,l9_74.z,l9_31.w);
float3 l9_75=mix(l9_71,l9_31.xyz,float3(l9_30.w));
l9_31=float4(l9_75.x,l9_75.y,l9_75.z,l9_31.w);
l9_31.w=1.0;
float4 l9_76=l9_31;
param_26=l9_76;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_77=float4(in.varScreenPos.xyz,1.0);
param_26=l9_77;
}
else
{
...
float l9_79=fast::clamp(abs(l9_78.z),0.0,1.0);
float4 l9_80=float4(l9_79,1.0-l9_79,1.0,1.0);
param_26=l9_80;
}
else
{
float4 l9_81=param_26;
float4 l9_82=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_82=float4(mix(float3(1.0),l9_81.xyz,float3(l9_81.w)),l9_81.w);
}
else
{
...
{
l9_83=fast::clamp(l9_83,0.0,1.0);
}
l9_82=float4(l9_81.xyz*l9_83,l9_83);
}
else
{
l9_82=l9_81;
...
float4 l9_88=param_28;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_88.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_88;
return out;
}
} // FRAGMENT SHADER
