...
//sampler sampler Tweak_N2SmpSC 0:24
...
//texture texture2D Tweak_N2 0:5:0:24
...
//}
//ubo int UserUniforms 0:35:4768 {
//float4 sc_Time 1376
...
//float3x3 Tweak_N2Transform 4432
//float4 Tweak_N2UvMinMax 4480
//float4 Tweak_N2BorderColor 4496
//float Tweak_N6 4512
//float4 Tweak_N0 4528
//float4 Tweak_N13 4544
//float3x3 Tweak_N10Transform 4608
//float4 Tweak_N10UvMinMax 4656
//float4 Tweak_N10BorderColor 4672
//float Port_RangeMinA_N007 4688
//float Port_RangeMaxA_N007 4692
//float Port_RangeMinB_N007 4696
//float Port_RangeMaxB_N007 4700
//float2 Port_Center_N003 4704
//float4 Port_Input1_N009 4720
//float2 Port_Scale_N011 4736
//float2 Port_Center_N011 4744
//float depthRef 4752
//}
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N2 [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N2 [[function_constant(35)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N2 [[function_constant(38)]];
...
constant bool Tweak_N2HasSwappedViews [[function_constant(41)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N2 [[function_constant(76)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N2 [[function_constant(79)]];
...
constant int Tweak_N2Layout [[function_constant(82)]];
...
float4 Port_Input1_N009;
float2 Port_Scale_N011;
float2 Port_Center_N011;
float depthRef;
};
struct sc_Bone_t
{
...
float2 UVCoord_N5=float2(0.0);
UVCoord_N5=Globals.Surface_UVCoord1;
float Output_N6=0.0;
float param_1=(*sc_set0.UserUniforms).Tweak_N6;
Output_N6=param_1;
float Output_N8=0.0;
Output_N8=1.0-Output_N6;
float ValueOut_N7=0.0;
ValueOut_N7=(((Output_N8-(*sc_set0.UserUniforms).Port_RangeMinA_N007)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N007-(*sc_set0.UserUniforms).Port_RangeMinA_N007)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N007-(*sc_set0.UserUniforms).Port_RangeMinB_N007))+(*sc_set0.UserUniforms).Port_RangeMinB_N007;
float2 CoordsOut_N3=float2(0.0);
CoordsOut_N3=((UVCoord_N5-(*sc_set0.UserUniforms).Port_Center_N003)*float2(ValueOut_N7))+(*sc_set0.UserUniforms).Port_Center_N003;
...
int l9_6=l9_1;
int param_2=Tweak_N2Layout_tmp;
int param_3=l9_6;
float2 param_4=CoordsOut_N3;
bool param_5=(int(SC_USE_UV_TRANSFORM_Tweak_N2_tmp)!=0);
float3x3 param_6=(*sc_set0.UserUniforms).Tweak_N2Transform;
int2 param_7=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2_tmp);
bool param_8=(int(SC_USE_UV_MIN_MAX_Tweak_N2_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).Tweak_N2UvMinMax;
bool param_10=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).Tweak_N2BorderColor;
float param_12=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.Tweak_N2.sample(sc_set0.Tweak_N2SmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_10)
{
...
float4 param_13=(*sc_set0.UserUniforms).Tweak_N0;
Output_N0=param_13;
float4 Output_N1=float4(0.0);
Output_N1=Output_N2*Output_N0;
float4 Output_N13=float4(0.0);
float4 param_14=(*sc_set0.UserUniforms).Tweak_N13;
Output_N13=param_14;
float2 UVCoord_N14=float2(0.0);
UVCoord_N14=Globals.Surface_UVCoord1;
float2 CoordsOut_N11=float2(0.0);
CoordsOut_N11=((UVCoord_N14-(*sc_set0.UserUniforms).Port_Center_N011)*(*sc_set0.UserUniforms).Port_Scale_N011)+(*sc_set0.UserUniforms).Port_Center_N011;
...
int l9_81=l9_76;
int param_15=Tweak_N10Layout_tmp;
int param_16=l9_81;
float2 param_17=CoordsOut_N11;
bool param_18=(int(SC_USE_UV_TRANSFORM_Tweak_N10_tmp)!=0);
float3x3 param_19=(*sc_set0.UserUniforms).Tweak_N10Transform;
int2 param_20=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10_tmp);
bool param_21=(int(SC_USE_UV_MIN_MAX_Tweak_N10_tmp)!=0);
float4 param_22=(*sc_set0.UserUniforms).Tweak_N10UvMinMax;
bool param_23=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10_tmp)!=0);
float4 param_24=(*sc_set0.UserUniforms).Tweak_N10BorderColor;
float param_25=0.0;
bool l9_82=param_23&&(!param_21);
float l9_83=1.0;
float l9_84=param_17.x;
int l9_85=param_20.x;
if (l9_85==1)
{
l9_84=fract(l9_84);
}
...
param_17.x=l9_84;
float l9_89=param_17.y;
int l9_90=param_20.y;
if (l9_90==1)
{
l9_89=fract(l9_89);
}
...
float l9_96=param_17.x;
float l9_97=param_22.x;
float l9_98=param_22.z;
bool l9_99=l9_95;
float l9_100=l9_83;
...
float l9_105=param_17.y;
float l9_106=param_22.y;
float l9_107=param_22.w;
bool l9_108=l9_104;
float l9_109=l9_83;
...
float2 l9_112=param_17;
bool l9_113=param_18;
float3x3 l9_114=param_19;
if (l9_113)
{
...
param_17=l9_115;
float l9_116=param_17.x;
int l9_117=param_20.x;
bool l9_118=l9_82;
float l9_119=l9_83;
...
param_17.x=l9_116;
l9_83=l9_119;
float l9_127=param_17.y;
int l9_128=param_20.y;
bool l9_129=l9_82;
float l9_130=l9_83;
...
param_17.y=l9_127;
l9_83=l9_130;
float2 l9_138=param_17;
int l9_139=param_15;
int l9_140=param_16;
float l9_141=param_25;
...
float4 l9_148=sc_set0.Tweak_N10.sample(sc_set0.Tweak_N10SmpSC,l9_147.xy,bias(l9_141));
float4 l9_149=l9_148;
if (param_23)
{
l9_149=mix(param_24,l9_149,float4(l9_83));
}
float4 l9_150=l9_149;
Output_N10=l9_150;
float4 Output_N9=float4(0.0);
Output_N9=mix(Output_N13,(*sc_set0.UserUniforms).Port_Input1_N009,Output_N10);
float4 Output_N12=float4(0.0);
Output_N12=Output_N1*Output_N9;
...
float4 l9_154=fast::max(param_27,float4(0.0));
float4 param_28=l9_154;
if (sc_ShaderCacheConstant_tmp!=0)
{
