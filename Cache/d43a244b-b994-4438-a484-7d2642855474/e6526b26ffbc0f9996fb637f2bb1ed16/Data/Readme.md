...
| Method                                                        | Description                                                                           |
|:--------------------------------------------------------------|:--------------------------------------------------------------------------------------|
| getCurrentUserIndex(): Promise<number>                        | Returns the index of the current user (0 or 1).                                       |
...
| getUser(index: number): Promise<SnapchatUser \| null>         | Snapchat user for the given index (0 or 1), or null if it refers to the current user. |
| getUserVariable(userIndex: number, key)                       | Get a persistent variable for a specific user (userIndex must be 0 or 1).             |
| setUserVariable(userIndex: number, key, value)                | Set a persistent variable for a specific user (userIndex must be 0 or 1).             |
