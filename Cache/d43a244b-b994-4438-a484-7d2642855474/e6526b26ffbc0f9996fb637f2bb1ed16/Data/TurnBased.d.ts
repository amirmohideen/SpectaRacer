...
interface TurnBased {
    ...
    /**
     * Sets score for the current turn. Pass `null` to clear the score.
     * The score will be included in the turn data.
     * @param score - numeric score or `null` to remove
     */
    setScore(score: number | null): void;

    /**
     * Returns currently set score or `null` if no score is set.
     */
    getScore(): number | null;

    /**
     * Returns promise of index of current user (0 or 1).
     */
    getCurrentUserIndex(): Promise<number>;

    /**
     * Returns promise of index of the other user (0 or 1).
     */
    getOtherUserIndex(): Promise<number>;
