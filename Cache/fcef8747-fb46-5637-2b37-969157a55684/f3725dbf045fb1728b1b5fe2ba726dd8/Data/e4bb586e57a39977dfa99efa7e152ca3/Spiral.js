...
/**
 * Specs Inc. 2026
 * Runtime spiral gizmo for visualizing helical paths and rotational motion. Renders customizable
 * spirals with linear, exponential, logarithmic, or helix patterns, configurable radius amplitudes,
 * axis directions, and real-time center tracking.
 */
...
let Spiral = (() => {
    ...
    var Spiral = _classThis = class extends _classSuper {
       ...
       */
        onAwake() {
            // Initialize logger
            this.logger = new Logger_1.Logger("Spiral", this.enableLogging || this.enableLoggingLifecycle, true);
        ...
        createSpiral() {
            ...
            if (points.length < 2) {
                this.logger.debug("Error: Not enough points to create spiral!");
                return;
            }
