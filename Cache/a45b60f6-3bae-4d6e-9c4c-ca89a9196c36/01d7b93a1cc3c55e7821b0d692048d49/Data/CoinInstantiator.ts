...
export class CoinInstantiator extends BaseScriptComponent {
  @ui.label('<span style="color: #FBBF24;">CoinInstantiator – spawn and animate coin target cubes</span><br/><span style="color: #94A3B8; font-size: 11px;">Instantiates coin prefabs at regular intervals and moves them toward a target with configurable rotation.</span>')
  @ui.separator
