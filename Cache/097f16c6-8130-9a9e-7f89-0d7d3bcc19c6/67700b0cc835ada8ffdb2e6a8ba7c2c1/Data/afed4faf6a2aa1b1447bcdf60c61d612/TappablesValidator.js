...
exports.TappablesValidator = void 0;
/**
 ...
 */
class TappablesValidator {
    constructor(logger) {
        this.logger = logger;
    }
    validateTappablesCount(tappableAreas) {
    ...
    validateTappableConfig(tappableArea) {
...
exports.TappablesValidator = TappablesValidator;
TappablesValidator.KEY_LENGTH_LIMIT = 24;
TappablesValidator.MAX_NUM_TAPPABLES = 16;
TappablesValidator.MAX_TOTAL_TAPPABLE_AREA = 0.4;
TappablesValidator.CENTER_BOUNDS = { min: 0.05, max: 0.95 };
TappablesValidator.MAX_AREA = 0.4;
TappablesValidator.MIN_ASPECT_RATIO = 0.125;
//# sourceMappingURL=TappablesValidator.js.map