...
let CarHandleSteering = (() => {
    ...
    var CarHandleSteering = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.stationaryThreshold = this.stationaryThreshold;
        ...
        onUpdate() {
            ...
            if (this.enableLogging) {
                this.logger.debug(`x: ${currentX.toFixed(2)}  vel: ${this.smoothedVelocity.toFixed(2)}  factor: ${stationaryFactor.toFixed(2)}  targetY: ${targetOffsetY.toFixed(2)}°  carY: ${this.currentOffsetY.toFixed(2)}°`);
            }
        }
    };
