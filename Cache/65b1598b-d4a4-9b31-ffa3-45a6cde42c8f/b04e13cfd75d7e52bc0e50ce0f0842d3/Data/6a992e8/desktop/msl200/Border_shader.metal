...
//float3x3 Tweak_N2Transform 4448
//float4 Tweak_N2UvMinMax 4496
//float4 Tweak_N2BorderColor 4512
//float Port_RangeMinA_N006 4528
//float Port_RangeMaxA_N006 4532
//float Port_RangeMinB_N006 4536
//float Port_RangeMaxB_N006 4540
//float depthRef 4544
//}
...
float4 l9_75=l9_74;
Output_N2=l9_75;
float4 ValueOut_N6=float4(0.0);
ValueOut_N6=(((Output_N2-float4((*sc_set0.UserUniforms).Port_RangeMinA_N006))/float4(((*sc_set0.UserUniforms).Port_RangeMaxA_N006-(*sc_set0.UserUniforms).Port_RangeMinA_N006)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N006-(*sc_set0.UserUniforms).Port_RangeMinB_N006))+float4((*sc_set0.UserUniforms).Port_RangeMinB_N006);
float4 Output_N1=float4(0.0);
Output_N1=Output_N0+ValueOut_N6;
