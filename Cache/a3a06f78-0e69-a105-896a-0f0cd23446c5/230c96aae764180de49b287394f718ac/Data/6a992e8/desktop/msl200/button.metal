...
if (l9_32)
{
float l9_39=tempGlobals.gTimeElapsed;
l9_35+=(l9_31*l9_39);
}
}
float2 l9_40=l9_35;
tempGlobals.N7_TransformedUV3=l9_40;
...
{
int l9_45=N7_BaseTextureUVSwitch;
...
if (l9_45==2)
{
l9_47=tempGlobals.N7_TransformedUV2;
}
if (l9_45==3)
{
l9_47=tempGlobals.N7_TransformedUV3;
}
float2 l9_50=l9_47;
l9_42=l9_50;
float2 l9_51=l9_42;
...
int l9_58=l9_53;
int l9_59=baseTexLayout_tmp;
int l9_60=l9_58;
float2 l9_61=l9_51;
bool l9_62=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_63=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_64=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_65=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_66=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_67=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_68=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_69=0.0;
...
float4 l9_136=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_135.xy,bias(l9_129));
float4 l9_137=l9_136;
if (l9_67)
{
l9_137=mix(l9_68,l9_137,float4(l9_71));
}
...
if (N7_EnableRecolor)
{
float3 l9_140=((N7_RecolorR*N7_Albedo.x)+(N7_RecolorG*N7_Albedo.y))+(N7_RecolorB*N7_Albedo.z);
N7_Albedo=float4(l9_140.x,l9_140.y,l9_140.z,N7_Albedo.w);
}
if (N7_EnableOpacityTexture)
{
int l9_141=N7_OpacityUVSwitch;
float2 l9_142=tempGlobals.Surface_UVCoord0;
...
if (l9_141==1)
{
float2 l9_145=tempGlobals.Surface_UVCoord1;
l9_143=l9_145;
}
if (l9_141==2)
{
l9_143=tempGlobals.N7_TransformedUV2;
}
if (l9_141==3)
{
l9_143=tempGlobals.N7_TransformedUV3;
}
...
int l9_154=l9_149;
int l9_155=opacityTexLayout_tmp;
int l9_156=l9_154;
float2 l9_157=l9_147;
bool l9_158=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_159=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_160=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_161=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_162=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_163=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_164=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_165=0.0;
bool l9_166=l9_163&&(!l9_161);
float l9_167=1.0;
float l9_168=l9_157.x;
int l9_169=l9_160.x;
if (l9_169==1)
{
l9_168=fract(l9_168);
...
float l9_180=l9_157.x;
float l9_181=l9_162.x;
float l9_182=l9_162.z;
bool l9_183=l9_179;
float l9_184=l9_167;
...
float l9_189=l9_157.y;
float l9_190=l9_162.y;
float l9_191=l9_162.w;
bool l9_192=l9_188;
float l9_193=l9_167;
...
float2 l9_196=l9_157;
bool l9_197=l9_158;
float3x3 l9_198=l9_159;
if (l9_197)
{
...
float4 l9_232=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_231.xy,bias(l9_225));
float4 l9_233=l9_232;
if (l9_163)
{
l9_233=mix(l9_164,l9_233,float4(l9_167));
}
float4 l9_234=l9_233;
l9_148=l9_234;
float4 l9_235=l9_148;
N7_Opacity=l9_235.x;
}
N7_Opacity*=N7_Albedo.w;
if (N7_VertexColorSwitch==1)
{
float4 l9_236=tempGlobals.VertexColor;
N7_Albedo*=l9_236;
float4 l9_237=tempGlobals.VertexColor;
N7_Opacity*=l9_237.w;
}
float2 l9_238=tempGlobals.Surface_UVCoord0;
...
{
int l9_242=N7_EmissiveUVSwitch;
...
int l9_255=l9_250;
int l9_256=emissiveTexLayout_tmp;
int l9_257=l9_255;
float2 l9_258=l9_248;
bool l9_259=(int(SC_USE_UV_TRANSFORM_emissiveTex_tmp)!=0);
float3x3 l9_260=(*sc_set0.UserUniforms).emissiveTexTransform;
int2 l9_261=int2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex_tmp,SC_SOFTWARE_WRAP_MODE_V_emissiveTex_tmp);
bool l9_262=(int(SC_USE_UV_MIN_MAX_emissiveTex_tmp)!=0);
float4 l9_263=(*sc_set0.UserUniforms).emissiveTexUvMinMax;
bool l9_264=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex_tmp)!=0);
float4 l9_265=(*sc_set0.UserUniforms).emissiveTexBorderColor;
float l9_266=0.0;
...
float4 l9_333=sc_set0.emissiveTex.sample(sc_set0.emissiveTexSmpSC,l9_332.xy,bias(l9_326));
...
l9_249=l9_335;
float4 l9_336=l9_249;
N7_Emissive=l9_336.xyz;
}
if (N7_VertexColorSwitch==2)
{
float4 l9_337=tempGlobals.VertexColor;
N7_Emissive+=l9_337.xyz;
}
if ((N7_VertexColorSwitch==2)||N7_EnableEmissiveTexture)
{
float3 l9_338=(N7_Emissive*N7_EmissiveColor)*float3(N7_EmissiveIntensity);
float3 l9_339=float3(2.2);
float l9_340;
if (l9_338.x<=0.0)
{
l9_340=0.0;
...
{
l9_344=pow(l9_338.z,l9_339.z);
}
float3 l9_345=float3(l9_341,l9_343,l9_344);
N7_Emissive=l9_345;
}
float3 l9_346=(N7_Emissive+l9_240)+l9_241;
float3 l9_347=float3(0.45454547);
float l9_348;
if (l9_346.x<=0.0)
{
l9_348=0.0;
...
{
l9_352=pow(l9_346.z,l9_347.z);
}
float3 l9_353=float3(l9_349,l9_351,l9_352);
N7_Emissive=l9_353;
param_21=N7_Albedo;
param_22=N7_Opacity;
...
{
float4 l9_354=gl_FragCoord;
float2 l9_355=floor(mod(l9_354.xy,float2(4.0)));
float l9_356=(mod(dot(l9_355,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_25<l9_356)
{
discard_fragment();
}
...
float4 l9_357=fast::max(param_26,float4(0.0));
float4 param_27=l9_357;
if (sc_ShaderCacheConstant_tmp!=0)
{
