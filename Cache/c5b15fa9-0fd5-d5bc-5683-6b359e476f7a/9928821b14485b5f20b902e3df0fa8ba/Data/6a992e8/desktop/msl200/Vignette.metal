...
//float4 Tweak_N16 4384
//float Tweak_N20 4400
//float2 Port_Input1_N018 4408
//float Port_Input1_N019 4416
//float Port_Input1_N022 4420
//float depthRef 4424
//}
...
float4 param_1=(*sc_set0.UserUniforms).Tweak_N16;
Output_N16=param_1;
float2 UVCoord_N17=float2(0.0);
UVCoord_N17=Globals.Surface_UVCoord0;
float Output_N18=0.0;
Output_N18=distance(UVCoord_N17,(*sc_set0.UserUniforms).Port_Input1_N018);
float Output_N19=0.0;
Output_N19=Output_N18*(*sc_set0.UserUniforms).Port_Input1_N019;
...
{
l9_1=pow(Output_N19,(*sc_set0.UserUniforms).Port_Input1_N022);
}
Output_N22=l9_1;
float Output_N20=0.0;
float param_2=(*sc_set0.UserUniforms).Tweak_N20;
Output_N20=param_2;
float Output_N21=0.0;
Output_N21=Output_N22*Output_N20;
float4 Value_N15=float4(0.0);
Value_N15=float4(Output_N16.xyz.x,Output_N16.xyz.y,Output_N16.xyz.z,Value_N15.w);
Value_N15.w=Output_N21;
...
float4 l9_5=fast::max(param_4,float4(0.0));
float4 param_5=l9_5;
if (sc_ShaderCacheConstant_tmp!=0)
{
