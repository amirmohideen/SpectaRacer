...
export class SnapSaberInstantiator extends BaseScriptComponent {
  @ui.label('<span style="color: #60A5FA;">SnaInstantiator – spawn and animate SnapSaber target cubes</span><br/><span style="color: #94A3B8; font-size: 11px;">Instantiates prefabs at regular intervals and moves them toward a target with configurable rotation.</span>')
  @ui.separator
