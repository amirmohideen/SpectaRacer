...
//sampler sampler Tweak_N2SmpSC 0:23
...
//texture texture2D Tweak_N2 0:4:0:23
...
//float3x3 Tweak_N6Transform 4432
//float4 Tweak_N6UvMinMax 4480
//float4 Tweak_N6BorderColor 4496
//float4 Tweak_N0 4512
//float3x3 Tweak_N2Transform 4576
//float4 Tweak_N2UvMinMax 4624
//float4 Tweak_N2BorderColor 4640
//float4 Port_Input0_N010 4656
//float4 Port_Input1_N010 4672
//float2 Port_Scale_N008 4688
//float2 Port_Center_N008 4696
//float4 Port_Input0_N003 4704
//float depthRef 4720
//}
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N2 [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N2 [[function_constant(37)]];
...
constant bool Tweak_N2HasSwappedViews [[function_constant(40)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N2 [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N2 [[function_constant(78)]];
...
constant int Tweak_N2Layout [[function_constant(81)]];
...
float4 Port_Input0_N010;
float4 Port_Input1_N010;
...
float2 UVCoord_N7=float2(0.0);
UVCoord_N7=Globals.Surface_UVCoord1;
float2 CoordsOut_N8=float2(0.0);
CoordsOut_N8=((UVCoord_N7-(*sc_set0.UserUniforms).Port_Center_N008)*(*sc_set0.UserUniforms).Port_Scale_N008)+(*sc_set0.UserUniforms).Port_Center_N008;
...
int l9_6=l9_1;
int param_1=Tweak_N6Layout_tmp;
int param_2=l9_6;
float2 param_3=CoordsOut_N8;
bool param_4=(int(SC_USE_UV_TRANSFORM_Tweak_N6_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).Tweak_N6Transform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_Tweak_N6_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).Tweak_N6UvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).Tweak_N6BorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.Tweak_N6.sample(sc_set0.Tweak_N6SmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
Output_N10=mix((*sc_set0.UserUniforms).Port_Input0_N010,(*sc_set0.UserUniforms).Port_Input1_N010,Output_N6);
float4 Output_N0=float4(0.0);
float4 param_12=(*sc_set0.UserUniforms).Tweak_N0;
Output_N0=param_12;
float2 UVCoord_N5=float2(0.0);
UVCoord_N5=Globals.Surface_UVCoord0;
...
int l9_81=l9_76;
int param_13=Tweak_N2Layout_tmp;
int param_14=l9_81;
float2 param_15=UVCoord_N5;
bool param_16=(int(SC_USE_UV_TRANSFORM_Tweak_N2_tmp)!=0);
float3x3 param_17=(*sc_set0.UserUniforms).Tweak_N2Transform;
int2 param_18=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2_tmp);
bool param_19=(int(SC_USE_UV_MIN_MAX_Tweak_N2_tmp)!=0);
float4 param_20=(*sc_set0.UserUniforms).Tweak_N2UvMinMax;
bool param_21=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2_tmp)!=0);
float4 param_22=(*sc_set0.UserUniforms).Tweak_N2BorderColor;
float param_23=0.0;
...
float4 l9_148=sc_set0.Tweak_N2.sample(sc_set0.Tweak_N2SmpSC,l9_147.xy,bias(l9_141));
...
Output_N3=mix((*sc_set0.UserUniforms).Port_Input0_N003,Output_N0,Output_N2);
float4 Output_N1=float4(0.0);
Output_N1=Output_N10*Output_N3;
