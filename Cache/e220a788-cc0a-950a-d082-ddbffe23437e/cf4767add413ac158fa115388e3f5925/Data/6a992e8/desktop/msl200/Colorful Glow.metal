...
//float Port_Multiplier_N006 4384
//float2 Port_Scale_N000 4392
//float Port_Offset_N000 4400
//float Port_Import_N026 4404
//float Port_Import_N025 4408
//float Port_Value3_N003 4412
//float Port_Value_N013 4416
//float depthRef 4420
//}
...
//spec_const int SC_DEVICE_CLASS 67 -1
...
constant int SC_DEVICE_CLASS [[function_constant(67)]];
...
float2 Port_Scale_N000;
float Port_Offset_N000;
float Port_Import_N026;
float Port_Import_N025;
float Port_Value3_N003;
...
float Time_N6=0.0;
Time_N6=Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Multiplier_N006;
float3 Output_N1=float3(0.0);
Output_N1=Position_N10+float3(Time_N6);
float Noise_N0=0.0;
float2 param_1=Output_N1.xy;
float2 param_2=(*sc_set0.UserUniforms).Port_Scale_N000;
float param_3=(*sc_set0.UserUniforms).Port_Offset_N000;
float param_4;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_1.x=floor(param_1.x*10000.0)*9.9999997e-05;
param_1.y=floor(param_1.y*10000.0)*9.9999997e-05;
float2 l9_1=floor(param_1*param_2);
float2 l9_2=fract(param_1*param_2);
float3 l9_3=float3(8.0,0.0,0.0);
int l9_4=-1;
...
if (l9_5<=1)
{
float2 l9_6=float2(float(l9_5),float(l9_4));
float2 l9_7=l9_6+l9_1;
float l9_8=abs(param_3)+1000.0;
float2 l9_9=VoronoiHash2D(l9_7,l9_8);
float2 l9_10=l9_9;
float l9_11=distance(l9_6+l9_10,l9_2);
if (l9_11<l9_3.x)
{
l9_3=float3(l9_11,l9_10.x,l9_10.y);
param_4=l9_3.x;
param_4=floor(param_4*10000.0)*9.9999997e-05;
}
l9_5++;
continue;
}
...
Noise_N0=param_4;
float Value_N26=0.0;
Value_N26=fast::clamp((*sc_set0.UserUniforms).Port_Import_N026,0.0,3.0);
float Output_N7=0.0;
Output_N7=Noise_N0*Value_N26;
float Value_N25=0.0;
Value_N25=fast::clamp((*sc_set0.UserUniforms).Port_Import_N025,0.0,1.0);
float3 Value_N3=float3(0.0);
Value_N3.x=Output_N7;
Value_N3.y=Value_N25;
Value_N3.z=(*sc_set0.UserUniforms).Port_Value3_N003;
float4 RGB_N2=float4(0.0);
float3 param_5=float4(Value_N3,0.0).xyz;
float3 l9_12=param_5.zzz;
float l9_13=3.0*fract(param_5.x+0.16666667);
float l9_14=2.0*fract(l9_13);
float l9_15=param_5.y;
float l9_16=fast::clamp(l9_15,0.0,1.0);
float2 l9_17=l9_12.yz-((float2(1.0,l9_14)-float2(fast::max(0.0,l9_14-1.0)))*(param_5.z*l9_16));
l9_12=float3(l9_12.x,l9_17.x,l9_17.y);
if (l9_13>=1.0)
{
l9_12=l9_12.zxy;
}
...
float3 l9_18=l9_12;
RGB_N2=float4(l9_18,float4(Value_N3,0.0).w);
float4 Output_N5=float4(0.0);
Output_N5=float4(RGB_N2.x,RGB_N2.y,RGB_N2.z,1.0);
float4 Export_N24=float4(0.0);
Export_N24=Output_N5;
FinalColor=Export_N24;
...
float3 Position_N10_1=float3(0.0);
Position_N10_1=Globals.SurfacePosition_ObjectSpace;
float Time_N6_1=0.0;
Time_N6_1=Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Multiplier_N006;
float3 Output_N1_1=float3(0.0);
Output_N1_1=Position_N10_1+float3(Time_N6_1);
float Noise_N0_1=0.0;
float2 param_7=Output_N1_1.xy;
float2 param_8=(*sc_set0.UserUniforms).Port_Scale_N000;
float param_9=(*sc_set0.UserUniforms).Port_Offset_N000;
float param_10;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_7.x=floor(param_7.x*10000.0)*9.9999997e-05;
param_7.y=floor(param_7.y*10000.0)*9.9999997e-05;
float2 l9_22=floor(param_7*param_8);
float2 l9_23=fract(param_7*param_8);
float3 l9_24=float3(8.0,0.0,0.0);
int l9_25=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_25<=1)
...
if (l9_26<=1)
{
float2 l9_27=float2(float(l9_26),float(l9_25));
float2 l9_28=l9_27+l9_22;
float l9_29=abs(param_9)+1000.0;
float2 l9_30=VoronoiHash2D(l9_28,l9_29);
float2 l9_31=l9_30;
float l9_32=distance(l9_27+l9_31,l9_23);
if (l9_32<l9_24.x)
{
l9_24=float3(l9_32,l9_31.x,l9_31.y);
param_10=l9_24.x;
...
Noise_N0_1=param_10;
float Value_N26_1=0.0;
Value_N26_1=fast::clamp((*sc_set0.UserUniforms).Port_Import_N026,0.0,3.0);
float Output_N7_1=0.0;
Output_N7_1=Noise_N0_1*Value_N26_1;
float Value_N25_1=0.0;
Value_N25_1=fast::clamp((*sc_set0.UserUniforms).Port_Import_N025,0.0,1.0);
float3 Value_N3_1=float3(0.0);
Value_N3_1.x=Output_N7_1;
Value_N3_1.y=Value_N25_1;
Value_N3_1.z=(*sc_set0.UserUniforms).Port_Value3_N003;
float4 RGB_N2_1=float4(0.0);
float3 param_11=float4(Value_N3_1,0.0).xyz;
float3 l9_33=param_11.zzz;
float l9_34=3.0*fract(param_11.x+0.16666667);
float l9_35=2.0*fract(l9_34);
float l9_36=param_11.y;
float l9_37=fast::clamp(l9_36,0.0,1.0);
float2 l9_38=l9_33.yz-((float2(1.0,l9_35)-float2(fast::max(0.0,l9_35-1.0)))*(param_11.z*l9_37));
l9_33=float3(l9_33.x,l9_38.x,l9_38.y);
if (l9_34>=1.0)
{
l9_33=l9_33.zxy;
}
...
float3 l9_39=l9_33;
RGB_N2_1=float4(l9_39,float4(Value_N3_1,0.0).w);
float4 Output_N5_1=float4(0.0);
Output_N5_1=float4(RGB_N2_1.x,RGB_N2_1.y,RGB_N2_1.z,1.0);
float4 Export_N24_1=float4(0.0);
Export_N24_1=Output_N5_1;
float Output_N13=0.0;
float param_12=(*sc_set0.UserUniforms).Port_Value_N013;
float param_13=param_12+0.001;
param_13-=0.001;
Output_N13=param_13;
float4 Output_N9=float4(0.0);
Output_N9=Export_N24_1*float4(Output_N13);
FinalColor1=Output_N9;
if ((*sc_set0.UserUniforms).sc_RayTracingCasterConfiguration.x!=0u)
{
...
float4 l9_40=fast::max(param_14,float4(0.0));
float4 param_15=l9_40;
if (sc_ShaderCacheConstant_tmp!=0)
{
