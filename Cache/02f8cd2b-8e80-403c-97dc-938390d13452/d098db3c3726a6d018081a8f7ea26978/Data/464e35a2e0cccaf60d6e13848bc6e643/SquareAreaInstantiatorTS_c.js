...
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Square Configuration</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Define the center point and prefab to instantiate within the square area</span>"}
...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Configure the number of objects and square size</span>"}
// @input float numberOfPrefabs = 10 {"hint":"Number of prefabs to instantiate"}
// @input float size = 5 {"hint":"Size of the square (half-width/half-height)"}
// @ui {"widget":"separator"}
...
var Module = require("../../../../../../Modules/Src/Packages/Instantiation.lspkg/Scripts/TS/SquareAreaInstantiatorTS");
Object.setPrototypeOf(script, Module.SquareAreaInstantiatorTS.prototype);
script.__initialize();
